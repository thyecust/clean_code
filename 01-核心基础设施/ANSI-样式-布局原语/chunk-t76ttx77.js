...
var N = new Set([27, 155]),
  ...
  b = new Set(),
  x = new Map();
for (let [e, t] of oN.codes)
  (b.add(oN.color.ansi(t)), x.set(oN.color.ansi(e), oN.color.ansi(t)));
var E = "\x1B]8;;",
...
function y(e) {
  ...
  if (((e = e.slice(2)), e.startsWith("38"))) return oN.color.close;
  else if (e.startsWith("48")) return oN.bgColor.close;
  let t = oN.codes.get(parseInt(e, 10));
  if (t) return oN.color.ansi(t);
  else return oN.reset.open;
}
function NI(e) {
...
function h(e, t) {
  let o = [...e];
  for (let n of t)
    if (n.code === oN.reset.open) o = [];
    else if (b.has(n.code)) o = o.filter((i) => i.endCode !== n.code);
    else if (n.code === oN.bold.open || n.code === oN.dim.open) {
...
function pNe(e, t) {
  ...
  return [
    ...Ape(e.filter((i) => !o.has(i.endCode))),
...
function oYn(e, { ambiguousAsWide: t = !1 } = {}) {
...
function fNe(e, t = Number.POSITIVE_INFINITY) {
  let o = [],
    n = 0,
    i = 0;
  while (n < e.length) {
...
function k(e) {
  ...
  for (let f of o) {
    ...
    let C = f.value;
    if (C.charCodeAt(1) === rB.CSI && C.endsWith("m")) {
      for (let d of fNe(C)) if (d.type === "ansi") c(d);
    } else if (C.startsWith("\x1B]8;") && (C.endsWith($w) || C.endsWith(B))) {
      let d = C.slice(4, C.endsWith(B) ? -2 : -1),
        A = d.slice(d.indexOf(";") + 1);
      c({ type: "ansi", code: `\x1B]8;;${A}${$w}`, endCode: ie });
    }
  }
  return (a(), s(), n);
}
...
function sYn(e) {
  ...
  for (let n of [...t.feed(e), ...t.flush()]) {
    ...
    let i = n.value;
    if (le.test(i)) o += i;
    else if (i.startsWith("\x1B]8;") && (i.endsWith($w) || i.endsWith(B))) {
      let r = i.slice(4, i.endsWith(B) ? -2 : -1);
      o += `\x1B]8;;${r.slice(r.indexOf(";") + 1)}${$w}`;
    }
  }
  return o;
}
function TSt(e) {
  let t = 0;
  for (let o of k(e)) if (o.type !== "ansi") t += te(o.value);
  return t;
}
function p(e) {
...
function P(e, t, o, n) {
  let i = k(e),
    ...
    s = !1;
  for (let c of i) {
    let f = c.type === "ansi" ? 0 : te(c.value);
    if (o !== void 0 && u >= o) {
...
function iYn(e, t) {
  let o = k(e),
    ...
    c = !1;
  for (let d of o) {
    let A = d.type === "ansi" ? 0 : te(d.value);
    if (!l)
      if (n >= t && (d.type === "ansi" || A > 0 || !u)) l = !0;
      else if (d.type === "ansi") {
        if ((i.push(d), u)) r += d.code;
      } else {
        if (!u) ((u = !0), (i = p(nK(i))), (r = NI(i)));
        r += T(d.value);
      }
    if (d.type === "ansi") {
      ...
      if (!c && n >= t) {
        if (!(t > 0 && A === 0)) ((c = !0), (s = p(nK(s))), (a = NI(s)));
      }
      if (c) a += T(d.value);
    }
    if (d.type !== "ansi") n += A;
