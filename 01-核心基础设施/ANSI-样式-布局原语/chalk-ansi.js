...
function U() {
  ...
  return (
    ...
    Object.defineProperties(l, {
      ...
      hexToAnsi256: {
        value: (r) => l.rgbToAnsi256(...l.hexToRgb(r)),
        enumerable: !1,
      },
      ansi256ToAnsi: {
        value(r) {
          ...
          if (i === 0) return 30;
          let c =
            30 + ((Math.round(n) << 2) | (Math.round(o) << 1) | Math.round(t));
          if (i === 2) c += 60;
          return c;
        },
        enumerable: !1,
      ...
      rgbToAnsi: {
        value: (r, t, o) => l.ansi256ToAnsi(l.rgbToAnsi256(r, t, o)),
        enumerable: !1,
      },
      hexToAnsi: {
        value: (r) => l.ansi256ToAnsi(l.hexToAnsi256(r)),
        enumerable: !1,
      },
    }),
    l
...
var { env: s } = v,
  O;
if (f("no-color") || f("no-colors") || f("color=false") || f("color=never"))
  O = 0;
else if (f("color") || f("colors") || f("color=true") || f("color=always"))
  O = 1;
function K() {
  if ("FORCE_COLOR" in s) {
    if (s.FORCE_COLOR === "true") return 1;
    if (s.FORCE_COLOR === "false") return 0;
    return s.FORCE_COLOR.length === 0
      ? 1
...
function X(e, { streamIsTTY: r, sniffFlags: t = !0 } = {}) {
  ...
  if (v.platform === "win32") {
    ...
    if (Number(c[0]) >= 10 && Number(c[2]) >= 10586)
      return Number(c[2]) >= 14931 ? 3 : 2;
    return 1;
  }
  if ("CI" in s) {
    if (["GITHUB_ACTIONS", "GITEA_ACTIONS", "CIRCLECI"].some((c) => c in s))
      return 3;
    if (
...
var z = {
    stdout: F({ isTTY: N.isatty(1) }),
    stderr: F({ isTTY: N.isatty(2) }),
  },
  M = z;
function S(e, r, t) {
  let o = e.indexOf(r);
...
var q = Object.defineProperties(() => {}, {
  ...
  Q = (e, r) => {
    ...
    if (r.includes("\x1B"))
      while (t !== void 0) ((r = S(r, t.close, t.open)), (t = t.parent));
    let i = r.indexOf(`
`);
    if (i !== -1) r = L(r, n, o, i);
    return o + r + n;
...
function G(e) {
  ...
  return (r === -1 ? process.argv : process.argv.slice(0, r)).some((o) =>
    e.has(o),
  );
}
var te = () => G(ee),
  oe = () => G(re);
function ne() {
  if (a.NO_COLOR && a.FORCE_COLOR === void 0 && !oe() && u.level > 0)
    return ((u.level = 0), !0);
  return !1;
}
function le() {
...
function ae() {
  if (!process.stdout.isTTY || a.NO_COLOR || a.FORCE_COLOR !== void 0 || te())
    return !1;
  let e = a.TERM;
...
function clampColorLevelTo256(e) {
  if ((p.ensureInit(), e && u.level > 2)) return ((u.level = 2), !0);
  return !1;
}
function invertText(e) {
...
function getColorLevelGeneration() {
  return p.levelGeneration;
}
function clampColorLevelForAttacher(e) {
  p.clampForAttacher(e);
}
export { ChalkInstance, clampColorLevelTo256, invertText, chalk, getColorLevelGeneration, clampColorLevelForAttacher };
