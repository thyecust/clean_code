...
function getCcrSessionConfig() {
  let s = r();
  return s.ok ? s.config : null;
}
function getCcrSessionConfigFailureReason() {
  let s = r();
  return s.ok ? null : s.cause;
}
function getCcrSessionProfile() {
  return a.CCR_SESSION_PROFILE;
}
export { getCcrSessionConfig, getCcrSessionConfigFailureReason, getCcrSessionProfile };
