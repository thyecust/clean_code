...
function d(n, r) {
  ...
  for (let u = 0; u < 10; u++) {
    ...
    let t = n[a];
    if (((e += (t & 127) * i), (t & 128) === 0))
      return { value: e, next: a + 1 };
    i *= 128;
  }
  return;
}
function decodeProtoFields(n, r) {
  let e = 0;
  while (e < n.length) {
    let i = d(n, e);
...
function readProtoFieldBytes(n, r) {
  let e;
  return decodeProtoFields(n, {
    onBytes(u, a) {
      if (u === r) e = a;
    },
  })
...
function readProtoStringField(n, r) {
  let e = readProtoFieldBytes(n, r);
  return e === void 0 ? void 0 : l.decode(e);
}
export { decodeProtoFields, readProtoFieldBytes, readProtoStringField };
