...
// Version: 2.1.263
function buildLocalDisplayOnlyDenialResult(e, s) {
  return {
    behavior: "deny",
...
function isLocalDisplayOnlyDenialReason(e) {
  return e.startsWith("localDisplayOnly ask not forwarded:");
}
export { buildLocalDisplayOnlyDenialResult, isLocalDisplayOnlyDenialReason };
