...
function P(e) {
  ...
  if (n === void 0) return;
  if (n.family === "fable" && Qa(n.fallbackId)?.family === "opus")
...
async function P_(e, t, n, o, r = {}) {
  ...
  if (getActiveModelForState(t()) !== s) {
    ...
    let S = await P_(e, t, n, o, { ...r, revalidating: !0 });
...
function Jle(e) {
  return [
    `Model switch blocked by a PreModelSwitch hook${e.reason !== void 0 ? `: ${Rl(e.reason)}` : e.decision === "ask" ? ": confirmation required, and this session cannot ask" : ""}`,
    ...e.messages.map(Rl),
  ].join(`
`);
}
function Rl(e) {
  return Oo(_i(tCn(e.trimEnd())));
}
function rI(e, t, n) {
  return [
    `Model switch to ${Zg(e)} was blocked by a PreModelSwitch hook${t ? `: ${Rl(t)}` : ""}`,
    ...n.map(Rl),
  ].join(`
`);
}
function I3e(e, t, n, o, r, i, s, u) {
  let d = n().fastMode;
  if (
    (Cz(),
...
function Qle(e, t) {
  ...
  return ib(t2(e))
    ...
    : { level: mve(t2(e)), fromUltracode: !0, ultracode: !1 };
}
export {
  p7,
  C2n,
