...
function u(e, o) {
  let r = mp();
  if (r.some((m) => zn(y(m)) === o)) return !1;
  return (Hz([...r, o]), nR(e), ET(e, "directory_added"), M3e(), !0);
}
async function qlt(e, o, r) {
  let s = {
    type: "addDirectories",
    directories: [o],
  ...
  (e.setToolPermissionContext((t) => Oc(t, s)),
    u(e.session, o),
    st.refreshConfig(),
    e.storageV5 ? t9t(o, e.storageV5) : t9t(o),
    _yn("--add-dir", o, e.storageV5));
  let d;
  if (r)
    try {
  ...
  return (
    VMe(e.session, o, "slash_command", {
      ...
      .then(async ({ results: t, systemMessages: l }) => {
        ...
        let a = G(t, (i) => !i.succeeded),
          c = [
            ...(await Promise.all(
              l.map((i, f) =>
                fpe(i, `add-dir-${g}-${f}`, "systemMessage", {
                  storageV5: e.storageV5,
...
function L3e(e, o) {
  ...
  if (
    !Bh(o.absolutePath, { ...r, additionalWorkingDirectories: new Map() }) ||
    !Ap(s, g, { caseFold: !1, skipPrivateAlias: !0, uncShapeParity: !0 })
  ) {
    let i = an(s);
  ...
  if (
    Xr("skills", { explicitlyRequested: !0 }) ||
    !Nr("projectSettings") ||
    Uu("skills")
  )
