...
import { resetSyncCache, rememberEligibility, getEligibilityMemo, getRemoteSettingsPathOverride, setEvalPolicySnapshotOnly } from "./设置-配置.aqbb35ee.js";
...
function resetRemoteSettingsSyncCache() {
  resetSyncCache();
}
function isRemoteSettingsEligible() {
...
function u() {
  return hasTeamOrEnterpriseSubscription() || (hasStoredOAuthToken() && getStoredOAuthSubscriptionType() === null);
}
function hasTeamOrEnterpriseSubscription() {
...
function f() {
  ...
  if (i)
    return matchesOAuthBaseUrlHost()
      ? { eligible: !0 }
...
export { matchesOAuthBaseUrlHost, resetRemoteSettingsSyncCache, isRemoteSettingsEligible, hasTeamOrEnterpriseSubscription };
