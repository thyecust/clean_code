...
export {
  xEe as CHROME_EXTENSION_RECONNECT_URL,
  kMe as getClaudeInChromeMcpServerConfig,
  FWt as hasBaseChromeOfferEligibility,
  $Wt as hasChromeExtensionEvidence,
  bH as isChromeExtensionInstalled,
  rD as isClaudeInChromeAllowed,
  F5e as isClaudeInChromeWiredThisSession,
  RMe as markClaudeInChromeUnwired,
  Qde as markClaudeInChromeUnwiredIfChrome,
  Zde as setupClaudeInChrome,
  Kgn as shouldAutoEnableClaudeInChrome,
  N5e as shouldEnableClaudeInChrome,
  Xgn as shouldSuppressChromeOffer,
};
