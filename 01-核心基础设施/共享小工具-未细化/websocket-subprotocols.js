...
var MAX_SUBPROTOCOLS = 4,
  e = 48;
function formatSubprotocolList(n) {
  let o = n.slice(0, MAX_SUBPROTOCOLS).map((r) => (r.length > e ? `${truncateToCodeUnits(r, e)}\u2026` : r)),
    t = n.length - o.length;
