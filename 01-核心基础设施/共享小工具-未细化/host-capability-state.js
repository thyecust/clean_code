...
var BACKGROUND_TASKS_DISABLED_MESSAGE = "Background tasks are disabled in this session.";
export { getHostCapabilityState, areBackgroundTasksDisabled, BACKGROUND_TASKS_DISABLED_MESSAGE };
