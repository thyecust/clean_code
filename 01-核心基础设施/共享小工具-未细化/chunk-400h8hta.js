...
// Version: 2.1.263
import { ln } from "../核心工具-字符串与文本/chunk-1wezmyx2.js";
var o = new Set([
    "localhost",
...
function Z$n(t) {
  let a = t.toLowerCase().replace(/\.+$/, "");
  return (
    ale(a) || [...o, ...l, "home.arpa", ...n].some((e) => e.endsWith("." + a))
  );
}
function eUn(t, a = "address") {
  let e = s(t.trim().toLowerCase()).replace(/\.+$/, "");
  if (a === "address" ? ale(e) : GZt(e)) return !0;
  return (
