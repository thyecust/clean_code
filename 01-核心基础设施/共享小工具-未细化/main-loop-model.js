...
function useMainLoopModel() {
  let o = U((e) => e.mainLoopModel),
    ...
    s = useSettings();
  return V(
    () => resolveMainLoopModel({ mainLoopModel: o, mainLoopModelForSession: n }),
    [n, o, i, s],
  );
}
export { resolveMainLoopModelSetting, resolveMainLoopModel, useMainLoopModelOverride, useMainLoopModelSetting, useMainLoopModel };
