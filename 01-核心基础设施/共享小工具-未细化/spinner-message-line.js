...
function SpinnerMessageLine(S) {
  let a = _(10),
    ...
    s = C === void 0 ? !1 : C,
    R;
  if (a[0] === MEMO_CACHE_SENTINEL) ((R = e(yo, {})), (a[0] = R));
  else R = a[0];
  let l;
  if (a[1] !== m || a[2] !== s || a[3] !== f)
    ((l = r(o, {
      flexDirection: "row",
      children: [R, r(t, { bold: m, dimColor: s, children: [" ", f] })],
    })),
      (a[1] = m),
      (a[2] = s),
      (a[3] = f),
  ...
  let n;
  if (a[5] !== i)
    ((n = i && e(t, { dimColor: !0, children: i })), (a[5] = i), (a[6] = n));
  else n = a[6];
  let y;
  if (a[7] !== l || a[8] !== n)
    ((y = r(o, { flexDirection: "column", children: [l, n] })),
      (a[7] = l),
      (a[8] = n),
      (a[9] = y));
  else y = a[9];
