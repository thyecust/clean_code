...
function isOptInRequired(e) {
  return !Array.isArray(e) && e.opt_in_required === !0;
}
class ConnectorRegistryUnavailableError extends Error {
  constructor(e) {
    super(e);
...
async function searchConnectors(e, r, a) {
  let t = await d(C, { keywords: e, include_custom: !0 }, r, a);
  if (!isOptInRequired(t)) logFeatureOk("connector_suggest_search");
  return t;
}
async function lookupConnectors(e, r, a) {
  let t = await d(_, { uuids: e }, r, a);
  if (!isOptInRequired(t)) logFeatureOk("connector_suggest_lookup");
  return t;
}
function markConnectorsEnabledInChat(e, r) {
  let a = new Set();
  for (let t of r) {
...
async function listConnectors(e, r) {
  let a = await d(S, {}, e, r);
  if (!isOptInRequired(a)) logFeatureOk("connector_suggest_list");
  return a;
}
...
export { getConnectorSchema, isOptInRequired, ConnectorRegistryUnavailableError, searchConnectors, lookupConnectors, markConnectorsEnabledInChat, listConnectors, logConnectorSuggestFailure };
