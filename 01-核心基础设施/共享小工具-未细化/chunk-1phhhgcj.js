...
import { _s } from "./chunk-1371sqbk.js";
import { Ur } from "./chunk-qhcr4b0p.js";
...
function Dye() {
  let i = _(10),
    R;
  if (i[0] === p) ((R = EU.getInstance().getStatus()), (i[0] = R));
  else R = i[0];
  let [n, G] = d(R),
    C,
    I;
  ...
  let l;
  if (i[5] !== n.error)
    ((l = n.error && e(Ur, { error: n.error })), (i[5] = n.error), (i[6] = l));
  else l = i[6];
  let B;
  if (i[7] !== a || i[8] !== l)
    ((B = e(o, {
