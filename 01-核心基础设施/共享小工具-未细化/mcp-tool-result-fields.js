...
// Version: 2.1.263
function collectResourceLinks(i) {
  ...
  for (let r of i) {
    ...
    if (((o += JSON.stringify(t).length + (e.length > 0 ? 1 : 0)), o > 65536))
      break;
    e.push(t);
  }
  return e.length > 0 ? e : void 0;
}
function stripReservedMetaKeys(i) {
  if (i === void 0) return;
  let e;
  for (let r of Object.keys(i))
    if (r.startsWith("com.anthropic/")) ((e ??= { ...i }), delete e[r]);
  let o = e ?? i;
  return Object.keys(o).length > 0 ? o : void 0;
}
export { collectResourceLinks, stripReservedMetaKeys };
