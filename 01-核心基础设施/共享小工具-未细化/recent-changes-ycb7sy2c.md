...
Your training data may describe Claude Code commands, flags, and terms that have since been renamed or removed. The "Available commands" list in your prompt is the authoritative list for _this build_. Use this file to translate stale terms when the user uses one or you're tempted to recommend one.
