...
import { Ls, Mc, ry, WQe, vn, zD, dx } from "../../02-功能模块/认证-OAuth登录/认证-OAuth登录.419zdfz3.js";
...
function MAe() {
  ...
  if (u) {
    ...
    if (d && p("OTEL_METRICS_INCLUDE_ACCOUNT_UUID")) {
      ...
      let l = a.CLAUDE_CODE_ACCOUNT_TAGGED_ID || Svt("user", d);
...
function U() {
  ...
  t.token = e;
  let r = AP(e.replace(/^sk-ant-[a-z0-9]+-/, ""));
...
function hJn(e) {
  ...
  try {
    ...
    bo("internal_error", { error_name: hv(t) ?? "Error", error_code: Jr(e) });
  } finally {
    _ = !1;
  }
}
function aR(e) {
  bo("at_mention", { mention_type: e.mentionType, success: String(e.success) });
}
function zY(e) {
