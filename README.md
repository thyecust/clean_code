...
- **1433 个 js 文件**（另有 255 个随行资源），**165 个目录**，约 48 MB
...
当前全绿：1433 个文件 / 43.0 MB / 17,321 条相对依赖边（其中懒加载 301 条）0 失败；
...
- `03-入口与运行时/核心应用-Agent循环/核心应用-Agent循环.wmzgeczq.js` （7.54 MB，现归入「核心应用 / Agent 循环」）
