...
import { Lke } from "../../01-核心基础设施/共享小工具-未细化/chunk-jjr7hzzf.js";
...
${s}`;
  ...
  if (e.print && !e.hasPool && !e.isCloudAttach) {
    if (e.loneWordValue !== void 0)
      return `Error: --cloud ${Hit(e.loneWordValue)} is not a cloud session ID or URL.
...
function Hit(e) {
  let n = oe(e, a);
  return Lke(b(n.length < e.length ? `${n}\u2026` : n));
}
export { Y$n, J$n, BZt, jZt, vye, Hit };
