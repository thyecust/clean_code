...
function B(t, e) {
  try {
    ...
    return (n(`describeToolUseForPush failed: ${r}`, { level: "error" }), "");
  }
}
function ye(t, e) {
...
`,
  ...
  permissionPromptHost(t) {
    return {
      request: (e, r, o) => this.sendRequest(e, B_e(), r, { requestId: o }),
