...
function resolveConfigPaths(n, i) {
  let r = (t, g) =>
    t === "" || (g && t.trimStart().startsWith("{")) ? t : i(t);
  return {
...
function getDaemonCommandArgs(n) {
  let i = 0;
  while (
...
function getHandleUriInjectionError(n) {
...
export { parseDispatchArgs, resolveConfigPaths, buildDispatchArgs, getDaemonCommandArgs, getHandleUriInjectionError };
