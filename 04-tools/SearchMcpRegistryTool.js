...
import { getConnectorSchema, isOptInRequired, ConnectorRegistryUnavailableError, searchConnectors, markConnectorsEnabledInChat, logConnectorSuggestFailure } from "../02-功能模块/MCP连接器-Connector/connector-registry-api.js";
import { buildTool } from "../02-功能模块/权限系统/chunk-qdy0h5k2.js";
import { SEARCH_MCP_REGISTRY_TOOL_NAME, DESCRIPTION, PROMPT } from "../02-功能模块/MCP连接器-Connector/chunk-p2wzfbaj.js";
import { isFirstPartyRemoteSession } from "../02-功能模块/云会话-Teleport/first-party-remote-session.js";
  ...
  SearchMcpRegistryTool = buildTool({
    ...
    mapToolResultToToolResultBlockParam(e, r) {
      return {
        tool_use_id: r,
        type: "tool_result",
        content: jsonStringify(e.opt_in_required ? e : e.results),
      };
    },
