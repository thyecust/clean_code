...
var Rt = w(function (Un) {
  ...
  Un.getPenaltyN2 = function (e) {
    ...
    for (let i = 0; i < r - 1; i++)
      for (let o = 0; o < r - 1; o++) {
        let s =
          e.get(i, o) + e.get(i, o + 1) + e.get(i + 1, o) + e.get(i + 1, o + 1);
        if (s === 4 || s === 0) n++;
      }
    return n * U.N2;
  };
  Un.getPenaltyN3 = function (e) {
    ...
    for (let s = 0; s < r; s++) {
      ...
      for (let l = 0; l < r; l++) {
        if (
          ((i = ((i << 1) & 2047) | e.get(s, l)),
          l >= 10 && (i === 1488 || i === 93))
        )
          n++;
        if (
          ((o = ((o << 1) & 2047) | e.get(l, s)),
          l >= 10 && (o === 1488 || o === 93))
        )
          n++;
      }
...
var St = w(function (Gn) {
  ...
  (function () {
    let e = 1;
    for (let r = 0; r < 255; r++)
      if (((J[r] = e), (ue[e] = r), (e <<= 1), e & 256)) e ^= 285;
...
var Ht = w(function (bi) {
  ...
  function Ci(t, e) {
    for (let r = 1; r <= 40; r++)
      if (Ti(t, r) <= bi.getCapacity(r, e, O.MIXED)) return r;
    return;
  }
...
var Vt = w(function (Ml, vt) {
  ...
  Y.prototype.write = function (e) {
    ...
    if (o > 0)
      ((n = this.data.substr(r)), (i = parseInt(n, 10)), e.put(i, o * 3 + 1));
  };
  vt.exports = Y;
});
...
var sr = w(function (Fi) {
  ...
  function or(t) {
    let e = ee(X.NUMERIC, m.NUMERIC, t),
      ...
      n,
      i;
    if (ae.isKanjiModeEnabled())
      ((n = ee(X.BYTE, m.BYTE, t)), (i = ee(X.KANJI, m.KANJI, t)));
      ...
      for (let u = 0; u < s.length; u++) {
        ...
        for (let h = 0; h < i.length; h++) {
          ...
          if (r[c] && r[c].node.mode === f.mode)
            ((n[c][a] =
              Oe(r[c].lastCount + f.length, f.mode) -
              Oe(r[c].lastCount, f.mode)),
              (r[c].lastCount += f.length));
          else {
            if (r[c]) r[c].lastCount = f.length;
            n[c][a] =
              Oe(f.length, f.mode) + 4 + m.getCharCountIndicator(f.mode, e);
          }
        }
      }
      i = l;
...
var He = w(function (ro) {
  ...
  function Xi(t, e, r) {
    ...
    r.forEach(function (u) {
      (n.put(u.mode.bit, 4),
        n.put(u.getLength(), Wi.getCharCountIndicator(u.mode, t)),
        u.write(n));
    });
  ...
  function eo(t, e, r) {
    ...
    let W = new Uint8Array(n),
      ...
      S;
    for (B = 0; B < y; B++)
      for (S = 0; S < s; S++) if (B < _[S].length) W[b++] = _[S][B];
    for (B = 0; B < c; B++) for (S = 0; S < s; S++) W[b++] = g[S][B];
    return W;
  }
  function to(t, e, r, n) {
    let i;
...
var ze = w(function (Yl, ur) {
    ...
    (this._reads.push({ length: Math.abs(t), allowLess: t < 0, func: e }),
      process.nextTick(
        function () {
          if (
            (this._process(),
            this._paused && this._reads && this._reads.length > 0)
          )
  ...
  A.prototype._processReadAllowingLess = function (t) {
    this._reads.shift();
  ...
  A.prototype._processRead = function (t) {
    ...
    while (e < t.length) {
      ...
      if ((i.copy(n, e, 0, o), (e += o), o !== i.length))
        this._buffers[--r] = i.slice(o);
    }
  ...
  var v = (hr.exports = function (t, e) {
    ...
    if (
      ...
      for (let u = 0; u < l.length; u++)
        this._images.push({
          byteWidth: ar(l[u].width, o, s),
          height: l[u].height,
          lineIndex: 0,
        });
    } else
      this._images.push({ byteWidth: ar(r, o, s), height: n, lineIndex: 0 });
...
var je = w(function (Kl, _r) {
  ...
  We.prototype.write = function (t) {
    for (let e = 0; e < t.length; e++)
      this._crc = Ke[(this._crc ^ t[e]) & 255] ^ (this._crc >>> 8);
    return !0;
  };
...
var Je = w(function (Wl, mr) {
  var E = V(),
    ...
    T = (mr.exports = function (t, e) {
      ((this._options = t),
        ...
        (this._colorType = 0),
        (this._chunks = {}),
        (this._chunks[E.TYPE_IHDR] = this._handleIHDR.bind(this)),
        (this._chunks[E.TYPE_IEND] = this._handleIEND.bind(this)),
        (this._chunks[E.TYPE_IDAT] = this._handleIDAT.bind(this)),
        (this._chunks[E.TYPE_PLTE] = this._handlePLTE.bind(this)),
        (this._chunks[E.TYPE_tRNS] = this._handleTRNS.bind(this)),
        (this._chunks[E.TYPE_gAMA] = this._handleGAMA.bind(this)),
        (this.read = e.read),
        (this.error = e.error),
  ...
  T.prototype._parseSignature = function (t) {
    let e = E.PNG_SIGNATURE;
  ...
  T.prototype._parseChunkBegin = function (t) {
    let e = t.readUInt32BE(0),
      r = t.readUInt32BE(4),
      n = "";
    for (let o = 4; o < 8; o++) n += String.fromCharCode(t[o]);
    let i = Boolean(t[4] & 32);
    if (!this._hasIHDR && r !== E.TYPE_IHDR) {
      this.error(Error("Expected IHDR on beggining"));
      return;
    }
    if (
      ((this._crc = new po()), this._crc.write(Buffer.from(n)), this._chunks[r])
    )
  ...
  T.prototype._skipChunk = function () {
    this.read(8, this._parseChunkBegin.bind(this));
  };
  T.prototype._handleChunkEnd = function () {
    this.read(4, this._parseChunkEnd.bind(this));
  };
  T.prototype._parseChunkEnd = function (t) {
  ...
  T.prototype._handleIHDR = function (t) {
    this.read(t, this._parseIHDR.bind(this));
  };
  T.prototype._parseIHDR = function (t) {
    this._crc.write(t);
    let e = t.readUInt32BE(0),
      r = t.readUInt32BE(4),
      n = t[8],
    ...
    if (!(i in E.COLORTYPE_TO_BPP_MAP)) {
    ...
    this._colorType = i;
    let u = E.COLORTYPE_TO_BPP_MAP[this._colorType];
    ((this._hasIHDR = !0),
      this.metadata({
        width: e,
        height: r,
        depth: n,
        interlace: Boolean(l),
        palette: Boolean(i & E.COLORTYPE_PALETTE),
        color: Boolean(i & E.COLORTYPE_COLOR),
        alpha: Boolean(i & E.COLORTYPE_ALPHA),
        bpp: u,
        colorType: i,
      }),
      this._handleChunkEnd());
  };
  T.prototype._handlePLTE = function (t) {
    this.read(t, this._parsePLTE.bind(this));
  };
  T.prototype._parsePLTE = function (t) {
    this._crc.write(t);
  ...
  T.prototype._handleTRNS = function (t) {
    (this.simpleTransparency(), this.read(t, this._parseTRNS.bind(this)));
  };
  T.prototype._parseTRNS = function (t) {
    ...
    if (this._colorType === E.COLORTYPE_GRAYSCALE)
      this.transColor([t.readUInt16BE(0)]);
    if (this._colorType === E.COLORTYPE_COLOR)
      this.transColor([
        t.readUInt16BE(0),
        t.readUInt16BE(2),
        t.readUInt16BE(4),
  ...
  T.prototype._handleGAMA = function (t) {
    this.read(t, this._parseGAMA.bind(this));
  };
  T.prototype._parseGAMA = function (t) {
    (this._crc.write(t),
      this.gamma(t.readUInt32BE(0) / E.GAMMA_DIVISION),
      this._handleChunkEnd());
  };
  T.prototype._handleIDAT = function (t) {
    if (!this._emittedHeadersFinished)
      ((this._emittedHeadersFinished = !0), this.headersFinished());
    this.read(-t, this._parseIDAT.bind(this, t));
  };
  T.prototype._parseIDAT = function (t, e) {
    if (
      (this._crc.write(e),
      this._colorType === E.COLORTYPE_PALETTE_COLOR &&
  ...
  T.prototype._handleIEND = function (t) {
    this.read(t, this._parseIEND.bind(this));
  };
  T.prototype._parseIEND = function (t) {
    if (
      (this._crc.write(t),
      (this._hasIEND = !0),
      this._handleChunkEnd(),
...
var Ze = w(function (Jl, wr) {
  ...
  function bo(t, e, r, n, i) {
    ...
    for (let s = 0; s < n; s++)
      for (let l = 0; l < r; l++) {
        ...
        if (i.length === 1) {
          if (i[0] === t[o]) u = !0;
        } else if (i[0] === t[o] && i[1] === t[o + 1] && i[2] === t[o + 2])
          u = !0;
  ...
  function xo(t, e, r, n, i) {
    ...
    for (let u = 0; u < n; u++)
      for (let f = 0; f < r; f++) {
        for (let a = 0; a < 4; a++)
          e[l + a] = Math.floor((t[l + a] * o) / s + 0.5);
        l += 4;
      }
  }
...
var xr = w(function (Zl, br) {
  ...
  br.exports = function (t, e, r, n) {
    let i =
      [I.COLORTYPE_COLOR_ALPHA, I.COLORTYPE_ALPHA].indexOf(n.colorType) !== -1;
    ...
    let o = n.bitDepth !== 16 ? t : new Uint16Array(t.buffer),
      s = 255,
      l = I.COLORTYPE_TO_BPP_MAP[n.inputColorType];
    if (l === 4 && !n.inputHasAlpha) l = 3;
    let u = I.COLORTYPE_TO_BPP_MAP[n.colorType];
      ...
      if (n.inputHasAlpha) {
        if (!i)
          ((y /= s),
            ...
            (_ = Math.min(
              Math.max(Math.round((1 - y) * c.green + y * _), 0),
              s,
            )),
            (g = Math.min(
              Math.max(Math.round((1 - y) * c.blue + y * g), 0),
              s,
            )));
      }
      ...
      for (let _ = 0; _ < e; _++) {
        ...
        switch (n.colorType) {
          ...
          case I.COLORTYPE_COLOR:
            if (n.bitDepth === 8) {
              if (
                ((f[h] = g.red), (f[h + 1] = g.green), (f[h + 2] = g.blue), i)
              )
                f[h + 3] = g.alpha;
            } else if (
          ...
          case I.COLORTYPE_GRAYSCALE: {
            ...
            } else if ((f.writeUInt16BE(y, h), i))
              f.writeUInt16BE(g.alpha, h + 2);
            break;
          }
          default:
...
var Xe = w(function (Xl, Lr) {
      ...
      if (
        ...
        (t.colorType =
          typeof t.colorType === "number"
            ? t.colorType
            : C.COLORTYPE_COLOR_ALPHA),
        (t.inputColorType =
          typeof t.inputColorType === "number"
            ? t.inputColorType
            : C.COLORTYPE_COLOR_ALPHA),
        [
          C.COLORTYPE_GRAYSCALE,
          C.COLORTYPE_COLOR,
          C.COLORTYPE_COLOR_ALPHA,
          C.COLORTYPE_ALPHA,
  ...
  q.prototype.filterData = function (t, e, r) {
    let n = Go(t, e, r, this._options),
      i = C.COLORTYPE_TO_BPP_MAP[this._options.colorType];
  ...
  q.prototype._packChunk = function (t, e) {
    ...
    return (
      n.writeInt32BE(zo.crc32(n.slice(4, n.length - 4)), n.length - 4),
      n
    );
  };
  q.prototype.packGAMA = function (t) {
    ...
    return (
      e.writeUInt32BE(Math.floor(t * C.GAMMA_DIVISION), 0),
      this._packChunk(C.TYPE_gAMA, e)
    );
  };
  q.prototype.packIHDR = function (t, e) {
    ...
    return (
      ...
      (r[11] = 0),
      (r[12] = 0),
      this._packChunk(C.TYPE_IHDR, r)
    );
  };
  q.prototype.packIDAT = function (t) {
    return this._packChunk(C.TYPE_IDAT, t);
  };
...
var Fr = w(function (te, Ur) {
  ...
  F.prototype._processChunk = function (t, e, r) {
    if (typeof r === "function")
      return K.Inflate._processChunk.call(this, t, e, r);
    let n = this,
      i = t && t.length,
    ...
    function h(p, _) {
      ...
      if (_ === 0 || n._offset >= n._chunkSize)
        ((o = n._chunkSize),
          (n._offset = 0),
          (n._buffer = Buffer.allocUnsafe(n._chunkSize)));
...
var Vr = w(function (nu, vr) {
  ...
  vr.exports = function (t, e) {
    ...
    if (i.interlace) g = Gr.inflateSync(_);
      ...
      let B = (((i.width * i.bpp * i.depth + 7) >> 3) + 1) * i.height;
      g = rs(_, { chunkSize: B, maxLength: B });
    }
...
var Jr = w(function (iu, jr) {
  ...
  jr.exports = function (t, e) {
    ...
    let n = new fs(e || {}),
      i = [];
    if (
      (i.push(Buffer.from(us.PNG_SIGNATURE)),
      i.push(n.packIHDR(t.width, t.height)),
      t.gamma)
    )
...
var $r = w(function (ws) {
  ...
  x.prototype.bitblt = function (t, e, r, n, i, o, s) {
    return (x.bitblt(this, t, e, r, n, i, o, s), this);
  };
  x.adjustGamma = function (t) {
    if (t.gamma) {
...
var re = w(function (Es) {
  ...
  Es.getOptions = function (e) {
    ...
    return {
      ...
      margin: r,
      color: {
        dark: Xr(e.color.dark || "#000000ff"),
        light: Xr(e.color.light || "#ffffffff"),
      },
      type: e.type,
...
var rn = w(function (Ns) {
  ...
  Ns.render = function (t, e, r) {
    let n = Ps.getOptions(e),
      i = ks;
    if (n.color.dark.hex === "#ffffff" || n.color.light.hex === "#000000")
      i = Ms;
...
`;
    for (let a = 0; a < n; ++a) {
      l += "\x1B[47m  \x1B[0m";
      for (let h = 0; h < n; h++)
        l += i[a * n + h] ? "\x1B[40m  \x1B[0m" : "\x1B[47m  \x1B[0m";
      l +=
        f +
        `
`;
...
var Ydr = ft.create,
  ...
  epr = function (e, r, n, i) {
    if (
      typeof e !== "string" ||
      !(typeof r === "string" || typeof r === "object")
    )
      throw Error("Invalid argument");
    if (arguments.length < 3 && !_n())
...
export { Ydr, Jdr, eI, Qdr, Zdr, epr, tpr };
