...
var d = commonJS(function (Re) {
  ...
  })((ds = Re.InstrumentType || (Re.InstrumentType = {})));
  var ms;
  (function (e) {
...
var _ = commonJS(function (Ne) {
  ...
  Ne.hashAttributes = ps;
  function fs(e) {
    return `${e.name}:${e.version ?? ""}:${e.schemaUrl ?? ""}`;
  }
  Ne.instrumentationScopeId = fs;
...
var Fe = commonJS(function (Ve) {
  ...
  class L {
    ...
    record(e) {
      ...
      let t = (0, Rs.binarySearchUB)(this._boundaries, e);
  ...
  class qe {
    kind = Ps.AggregatorKind.HISTOGRAM;
    _boundaries;
    _recordMinMax;
    constructor(e, t) {
  ...
  class ue {
    ...
    reverse(e, t) {
      ...
      for (let i = 0; i < r; i++) {
        ...
        ((this._counts[e + i] = this._counts[t - i - 1]),
          (this._counts[t - i - 1] = s));
      }
    }
    emptyBucket(e) {
...
var it = commonJS(function (tt) {
  ...
  class et {
    ...
    lowerBoundary(e) {
      ...
      if (e < t)
        throw new Qe.MappingError(
          `underflow: ${e} is < minimum lower boundary: ${t}`,
        );
      let r = this._maxNormalLowerBoundaryIndex();
      if (e > r)
        throw new Qe.MappingError(
          `overflow: ${e} is > maximum lower boundary: ${r}`,
        );
...
var ut = commonJS(function (at) {
  ...
  class ot {
    ...
    mapToIndex(e) {
      ...
      if (E.getSignificand(e) === 0)
        return (E.getNormalBase2(e) << this._scale) - 1;
    ...
    lowerBoundary(e) {
      ...
      if (e >= t) {
        ...
        throw new nt.MappingError(
          `overflow: ${e} is > maximum lower boundary: ${t}`,
        );
      }
      ...
      if (e <= r) {
        ...
        throw new nt.MappingError(
          `overflow: ${e} is < minimum lower boundary: ${r}`,
        );
      }
...
var dt = commonJS(function (_t) {
  ...
  function Zs(e) {
    if (e > ht || e < lt)
      throw new Ks.MappingError(
        `expected scale >= ${lt} && <= ${ht}, got: ${e}`,
      );
    return Js[e + 10];
  }
  _t.getMapping = Zs;
  ...
  class X {
    ...
    _minScale(e) {
      ...
      return Math.min(
        ...
        t - this._changeScale(i.high, i.low),
      );
    }
    ...
    _mergeBuckets(e, t, r, i) {
      ...
      for (let n = 0; n < r.length; n++)
        this._incrementIndexBy(e, (s + n) >> o, r.at(n));
    }
...
var Tt = commonJS(function (xt) {
  ...
  class B {
    ...
    record(e) {
      ((this._current = e),
        (this.sampleTime = (0, U.millisToHrTime)(Date.now())));
    }
    setStartTime(e) {
      this.startTime = e;
    }
  ...
  class yt {
    ...
    merge(e, t) {
      let r =
        (0, U.hrTimeToMicroseconds)(t.sampleTime) >=
        (0, U.hrTimeToMicroseconds)(e.sampleTime)
          ? t
          : e;
...
var It = commonJS(function (wt) {
  ...
  class Et {
    ...
    diff(e, t) {
      let r = e.toPointValue(),
        i = t.toPointValue();
      if (this.monotonic && r > i)
        return new m(t.startTime, this.monotonic, i, !0);
...
var Vt = commonJS(function (Lt) {
  ...
  class de {
    ...
    createAggregator(e) {
      return new p.ExponentialHistogramAggregator(
        this._maxSize,
        this._recordMinMax,
      );
    }
      ...
      switch (e.type) {
        ...
        case g.InstrumentType.HISTOGRAM: {
          if (e.advice.explicitBucketBoundaries)
            return new ge(e.advice.explicitBucketBoundaries);
          return Lt.HISTOGRAM_AGGREGATION;
        }
      }
      return (
        dn.diag.warn(`Unable to recognize instrument type: ${e.type}`),
        Lt.DROP_AGGREGATION
      );
    }
    createAggregator(e) {
  ...
  function bn(e) {
    switch (e.type) {
      ...
      case M.EXPONENTIAL_HISTOGRAM: {
        let t = e;
        return new f.ExponentialHistogramAggregation(
          t.options?.maxSize,
  ...
  class Yt {
    ...
    constructor(e) {
      ((this._aggregationSelector =
        e?.aggregationSelector ?? Xt.DEFAULT_AGGREGATION_SELECTOR),
        (this._aggregationTemporalitySelector =
          e?.aggregationTemporalitySelector ??
          Xt.DEFAULT_AGGREGATION_TEMPORALITY_SELECTOR),
    ...
    async collect(e) {
      ...
      let [t, ...r] = await Promise.all([
          ...
          ...this._metricProducers.map((n) =>
            n.collect({ timeoutMillis: e?.timeoutMillis }),
          ),
        ]),
        i = t.errors.concat(r.flatMap((n) => n.errors)),
        s = t.resourceMetrics.resource,
        o = t.resourceMetrics.scopeMetrics.concat(
          r.flatMap((n) => n.resourceMetrics.scopeMetrics),
        );
  ...
  class Qt extends On.MetricReader {
      ...
      if (r < o)
        if ("exportIntervalMillis" in e && "exportTimeoutMillis" in e)
          ...
          (Z.diag.info(
            ...
            (o = r));
      ((this._exportInterval = r),
        (this._exportTimeout = o),
        (this._exporter = t));
    }
    async _runOnce() {
      try {
    ...
    async _doRun() {
      ...
      if (r.code !== Q.ExportResultCode.SUCCESS)
        throw Error(
          `PeriodicExportingMetricReader: metrics export failed (error ${r.error})`,
        );
    }
    onInitialized() {
      if (
  ...
  class sr {
    ...
    export(e, t) {
      ...
      (this._metrics.push(e),
        setTimeout(() => t({ code: ir.ExportResultCode.SUCCESS }), 0));
    }
    getMetrics() {
  ...
  class _r {
    ...
    findViews(e, t) {
      return this._registeredViews.filter(
        (i) =>
          this._matchInstrument(i.instrumentSelector, e) &&
          this._matchMeter(i.meterSelector, t),
      );
    }
...
var ee = commonJS(function (vr) {
  ...
  class O {
    ...
    _record(e, t = {}, r = I.context.active()) {
      if (typeof e !== "number") {
        I.diag.warn(
          `non-number value provided to metric ${this._descriptor.name}: ${e}`,
        );
        return;
      }
      if (
        this._descriptor.valueType === I.ValueType.INT &&
        !Number.isInteger(e)
      ) {
        if (
          (I.diag.warn(
...
var Nr = commonJS(function (Pr) {
  ...
  class Or {
    ...
    createHistogram(e, t) {
      let r = (0, S.createInstrumentDescriptor)(
          e,
          x.InstrumentType.HISTOGRAM,
          t,
        ),
        i = this._meterSharedState.registerMetricStorage(r);
    ...
    createUpDownCounter(e, t) {
      let r = (0, S.createInstrumentDescriptor)(
          e,
          x.InstrumentType.UP_DOWN_COUNTER,
          t,
        ),
        i = this._meterSharedState.registerMetricStorage(r);
    ...
    createObservableGauge(e, t) {
      let r = (0, S.createInstrumentDescriptor)(
          e,
          x.InstrumentType.OBSERVABLE_GAUGE,
          t,
        ),
        i = this._meterSharedState.registerAsyncMetricStorage(r);
      return new y.ObservableGaugeInstrument(
        r,
        i,
    ...
    createObservableCounter(e, t) {
      let r = (0, S.createInstrumentDescriptor)(
          e,
          x.InstrumentType.OBSERVABLE_COUNTER,
          t,
        ),
        i = this._meterSharedState.registerAsyncMetricStorage(r);
      return new y.ObservableCounterInstrument(
        r,
        i,
        this._meterSharedState.observableRegistry,
      );
    ...
    createObservableUpDownCounter(e, t) {
      let r = (0, S.createInstrumentDescriptor)(
          e,
          x.InstrumentType.OBSERVABLE_UP_DOWN_COUNTER,
          t,
        ),
        i = this._meterSharedState.registerAsyncMetricStorage(r);
  ...
  class qr {
    ...
    constructor(e, t) {
      ((this._aggregator = e),
        ...
        (this._overflowHashCode = (0, Qn.hashAttributes)(
        ...
        if (this._activeCollectionStorage.size >= this._cardinalityLimit) {
          this._activeCollectionStorage
            .getOrDefault(this._overflowAttributes, () =>
              this._aggregator.createAccumulation(i),
            )
            ?.record(e);
          return;
        }
        ((s = this._aggregator.createAccumulation(i)),
          this._activeCollectionStorage.set(t, s));
      }
      s?.record(e);
    }
    batchCumulate(e, t) {
      for (let [r, i, s] of e.entries()) {
        ...
        (this._cumulativeMemoStorage.set(o, a, n),
          this._activeCollectionStorage.set(o, c, n));
      }
    }
    collect() {
    ...
    buildMetrics(e, t, r, i) {
      ...
      if (this._reportHistory.has(e)) {
        let c = this._reportHistory.get(e),
          u = c.collectionTime;
        if (
          ((n = c.aggregationTemporality),
          n === eo.AggregationTemporality.CUMULATIVE)
        )
  ...
  class jr extends io.MetricStorage {
    ...
    record(e, t) {
      ...
      for (let [i, s] of e.entries())
        r.set(this._attributesProcessor.process(i), s);
      ...
      for (let i of t) {
        ...
        if ((0, mo.isDescriptorCompatibleWith)(s, e)) {
          if (s.description !== e.description) {
            if (e.description.length > s.description.length)
              i.updateDescription(e.description);
            ti.diag.warn(
...
var di = commonJS(function (_i) {
  ...
  class li {
    ...
    observe(e, t = {}) {
      if (typeof e !== "number") {
        R.diag.warn(
          `non-number value provided to metric ${this._instrumentName}: ${e}`,
        );
        return;
      }
  ...
  class hi {
    ...
    observe(e, t, r = {}) {
      ...
      if (typeof t !== "number") {
        R.diag.warn(
          `non-number value provided to metric ${e._descriptor.name}: ${t}`,
        );
        return;
      }
  ...
  class fi {
    ...
    _observeCallbacks(e, t) {
      return this._callbacks.map(async ({ callback: r, instrument: i }) => {
        let s = new pi.ObservableResultImpl(
            i._descriptor.name,
            i._descriptor.valueType,
          ),
    ...
    _observeBatchCallbacks(e, t) {
      return this._batchCallbacks.map(
        async ({ callback: r, instruments: i }) => {
  ...
  class yi extends Ao.MetricStorage {
    ...
    record(e, t, r, i) {
      ((t = this._attributesProcessor.process(t, r)),
        this._deltaMetricStorage.record(e, t, r, i));
    }
    collect(e, t) {
      let r = this._deltaMetricStorage.collect();
      return this._temporalMetricStorage.buildMetrics(
    ...
    process(e, t) {
      ...
      for (let i in e)
        if (
          ...
          this._allowedAttributeNames.has(i)
        )
          r[i] = e[i];
      return r;
    }
  ...
  class Ii {
    ...
    process(e, t) {
      ...
      for (let i in e)
        if (
          Object.prototype.hasOwnProperty.call(e, i) &&
          !this._deniedAttributeNames.has(i)
        )
          r[i] = e[i];
      return r;
    }
...
var Li = commonJS(function (Ni) {
  ...
  class Ri {
    ...
    _registerMetricStorage(e, t) {
      ...
      if (i.length === 0) {
        let o = this._meterProviderSharedState
          .selectAggregations(e.type)
          .map(([n, a]) => {
            let c =
...
var Di = commonJS(function (Ui) {
  ...
  class Gi {
    ...
    getMeterSharedState(e) {
      ...
      if (r == null)
        ((r = new Vo.MeterSharedState(this, e)),
  ...
  class qi {
    ...
    async collect(e) {
      let t = (0, Fo.millisToHrTime)(Date.now()),
        r = [],
        i = [],
        s = Array.from(this._sharedState.meterSharedStates.values()).map(
          async (o) => {
  ...
  class we {
    ...
    constructor(e) {
      if (e === "*") ((this._matchAll = !0), (this._regexp = /.*/));
        ...
        ((this._matchAll = !1),
          (this._regexp = new RegExp(we.escapePattern(e))));
    }
    match(e) {
...
var Ki = commonJS(function (Xi) {
  ...
  class Wi {
    ...
    _unitFilter;
    constructor(e) {
      ((this._nameFilter = new zi.PatternPredicate(e?.name ?? "*")),
        (this._type = e?.type),
        (this._unitFilter = new zi.ExactPredicate(e?.unit)));
    }
    getType() {
      return this._type;
    }
...
var os = commonJS(function (ss) {
  ...
  function Yo(e) {
    ...
    if (
      e.name != null &&
      (e?.instrumentName == null ||
        $o.PatternPredicate.hasWildcard(e.instrumentName))
    )
      throw Error(
  ...
  class is {
    ...
    constructor(e) {
      if ((Yo(e), e.attributesProcessors != null))
        this.attributesProcessor = (0, ts.createMultiAttributesProcessor)(
          e.attributesProcessors,
        );
      else this.attributesProcessor = (0, ts.createNoopAttributesProcessor)();
      ((this.name = e.name),
        (this.description = e.description),
        (this.aggregation = (0, rs.toAggregation)(
          e.aggregation ?? { type: rs.AggregationType.DEFAULT },
        )),
    ...
    constructor(e) {
      if (
        ...
        for (let t of e.views)
          this._sharedState.viewRegistry.addView(new Qo.View(t));
...
var bee = commonJS(function (l) {
  ...
  Object.defineProperty(l, "DataPointType", {
    enumerable: !0,
    get: function () {
      return hs.DataPointType;
    },
  });
  Object.defineProperty(l, "InstrumentType", {
    enumerable: !0,
    get: function () {
      return hs.InstrumentType;
    },
  });
  var ta = fe();
  ...
  Object.defineProperty(l, "createAllowListAttributesProcessor", {
    enumerable: !0,
    get: function () {
      return _s.createAllowListAttributesProcessor;
    },
  });
  Object.defineProperty(l, "createDenyListAttributesProcessor", {
    enumerable: !0,
    get: function () {
      return _s.createDenyListAttributesProcessor;
    },
  });
  var aa = _();
