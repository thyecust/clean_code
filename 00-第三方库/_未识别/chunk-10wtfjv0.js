...
${A}`),
          ...
          S(t, e, d)
            ? (l =
                t.slice(t.charCodeAt(e + 6) === v ? e + 7 : e + 6, r) || void 0)
            : y(t, e, r);
        ((e = r + 1),
          (r = t.indexOf(
            `
...
`,
      ...
      (y(t, e, n),
        (e = n + 1),
        t.charCodeAt(e - 1) === U && t.charCodeAt(e) === L && e++);
    }
    return t.slice(e);
  }
  function y(t, e, r) {
      ...
      default:
        C(
          new E(
            ...
            { type: "unknown-field", field: t, value: e, line: r },
          ),
        );
        break;
    }
...
class RGe extends TransformStream {
