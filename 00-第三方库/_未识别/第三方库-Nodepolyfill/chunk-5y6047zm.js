...
// Version: 2.1.263
import { mNt } from "../第三方库-其他/chunk-10wtfjv0.js";
class O extends Event {
  constructor(t, e) {
    ...
    (super(t),
      ...
      (this.message =
        (h = e == null ? void 0 : e.message) != null ? h : void 0));
  }
...
class hce extends EventTarget {
  constructor(t, e) {
    ...
    (super(),
      ...
      a(this, U, () => {
        (n(this, _, void 0),
          s(this, r) === this.CONNECTING && c(this, l, L).call(this));
      }));
    try {
    ...
    (n(this, f, mNt({ onEvent: s(this, S), onRetry: s(this, x) })),
      n(this, r, this.CONNECTING),
      n(this, y, 3000),
      n(
        this,
        W,
        (i = e == null ? void 0 : e.fetch) != null ? i : globalThis.fetch,
      ),
  ...
  close() {
    (s(this, _) && clearTimeout(s(this, _)),
      s(this, r) !== this.CLOSED &&
        (s(this, d) && s(this, d).abort(),
        n(this, r, this.CLOSED),
        n(this, d, void 0)));
  }
}
((r = new WeakMap()),
