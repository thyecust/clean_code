...
class de {
  ...
  getError(e, t) {
    let { line: a, col: n, offset: d } = this,
      h = n + t,
      l = d + t;
    return {
      code: e,
  ...
  _processSurrogate(e) {
    if (this.pos !== this.html.length - 1) {
      ...
      if (pe(t)) return (this.pos++, this._addGap(), Se(e, t));
  ...
  advance() {
    ...
    if (((this.skipNextNewLine = !1), K(e))) e = this._processSurrogate(e);
    if (!(
  ...
  _checkForProblematicCharacters(e) {
    if (V(e)) this._err(o.controlCharacterInInputStream);
    else if (z(e)) this._err(o.noncharacterInInputStream);
  }
  retreat(e) {
    this.pos -= e;
...
var Ee,
  ...
  Re =
    (Ee = String.fromCodePoint) !== null && Ee !== void 0
      ? Ee
      : function (e) {
          let t = "";
          if (e > 65535)
...
function De(e) {
  ...
  return (t = pt.get(e)) !== null && t !== void 0 ? t : e;
}
var N;
(function (e) {
  ((e[(e.NUM = 35)] = "NUM"),
...
function Lt(e) {
  return (
    (e >= N.UPPER_A && e <= N.UPPER_F) || (e >= N.LOWER_A && e <= N.LOWER_F)
  );
}
function Rt(e) {
  return (
...
class Z {
  ...
  stateNumericStart(e, t) {
    ...
    if ((e.charCodeAt(t) | St) === N.LOWER_X)
      return (
        (this.state = A.NumericHex),
        (this.consumed += 1),
        this.stateNumericHex(e, t + 1)
      );
    return ((this.state = A.NumericDecimal), this.stateNumericDecimal(e, t));
  }
  addToNumericResult(e, t, a, n) {
    if (t !== a) {
      let d = a - t;
      ((this.result =
        this.result * Math.pow(n, d) + parseInt(e.substr(t, d), n)),
        (this.consumed += d));
    }
  }
  stateNumericHex(e, t) {
  ...
  emitNumericEntity(e, t) {
    ...
    if ((this.emitCodePoint(De(this.result), this.consumed), this.errors)) {
      if (e !== N.SEMI) this.errors.missingSemicolonAfterCharacterReference();
  ...
  stateNamedEntity(e, t) {
    let { decodeTree: a } = this,
      n = a[this.treeIndex],
      d = (n & P.VALUE_LENGTH) >> 14;
    for (; t < e.length; t++, this.excess++) {
      let h = e.charCodeAt(t);
      if (
        ((this.treeIndex = gt(a, n, this.treeIndex + Math.max(1, d), h)),
        this.treeIndex < 0)
      )
        return this.result === 0 ||
          (this.decodeMode === D.Attribute && (d === 0 || Dt(h)))
          ? 0
          : this.emitNotTerminatedNamedEntity();
      if (
        ((n = a[this.treeIndex]), (d = (n & P.VALUE_LENGTH) >> 14), d !== 0)
      ) {
        if (h === N.SEMI)
  ...
  emitNamedEntityData(e, t, a) {
    ...
    if (
      (this.emitCodePoint(t === 1 ? n[e] & ~P.VALUE_LENGTH : n[e + 1], a),
      t === 3)
    )
...
function ge(e) {
  ...
  return function (d, h) {
    let l = 0,
      _ = 0;
    while ((_ = d.indexOf("&", _)) >= 0) {
      ((t += d.slice(l, _)), a.startEntity(h));
      let p = a.write(d, _ + 1);
      if (p < 0) {
        l = _ + a.end();
        break;
...
function gt(e, t, a, n) {
  let d = (t & P.BRANCH_LENGTH) >> 7,
    h = t & P.JUMP_TABLE;
  if (d === 0) return h !== 0 && n === h ? a : -1;
  if (h) {
    let b = n - h;
    return b < 0 || b >= d ? -1 : e[a + b] - 1;
  }
  let l = a,
    _ = l + d - 1;
  while (l <= _) {
...
function x(e) {
  var t;
  return (t = Pt.get(e)) !== null && t !== void 0 ? t : u.UNKNOWN;
}
var T = u,
  Pe = {
    [E.HTML]: new Set([
    ...
    [E.MATHML]: new Set([T.MI, T.MO, T.MN, T.MS, T.MTEXT, T.ANNOTATION_XML]),
    [E.SVG]: new Set([T.TITLE, T.FOREIGN_OBJECT, T.DESC]),
    [E.XLINK]: new Set(),
    [E.XML]: new Set(),
    [E.XMLNS]: new Set(),
  },
  H = new Set([T.H1, T.H2, T.H3, T.H4, T.H5, T.H6]),
  Mt = new Set([
    c.STYLE,
    c.SCRIPT,
    c.XMP,
...
function Me(e, t) {
  return Mt.has(e) || (t && e === c.NOSCRIPT);
}
var r;
(function (e) {
  ((e[(e.DATA = 0)] = "DATA"),
...
function Ht(e) {
  if (e === s.NULL) return o.nullCharacterReference;
  else if (e > 1114111) return o.characterReferenceOutsideUnicodeRange;
  else if (K(e)) return o.surrogateCharacterReference;
  else if (z(e)) return o.noncharacterCharacterReference;
  else if (V(e) || e === s.CARRIAGE_RETURN) return o.controlCharacterReference;
  return null;
}
class sse {
  constructor(e, t) {
    ((this.options = e),
      ...
      (this.preprocessor = new de(t)),
      (this.currentLocation = this.getCurrentLocation(-1)),
      (this.entityDecoder = new Z(
        J,
        (a, n) => {
  ...
  _consumeSequenceIfMatch(e, t) {
    if (this.preprocessor.startsWith(e, t))
      return (this._advanceBy(e.length - 1), !0);
    return !1;
  }
  ...
  _leaveAttrName() {
    ...
    if (j(a, this.currentAttr.name) === null) {
      if (
        (a.attrs.push(this.currentAttr), a.location && this.currentLocation)
      ) {
        let n =
  ...
  emitCurrentTagToken() {
    ...
    if (
      (this.prepareToken(e), (e.tagID = x(e.tagName)), e.type === f.START_TAG)
    )
      ((this.lastStartTagName = e.tagName), this.handler.onStartTag(e));
    else {
      if (e.attrs.length > 0) this._err(o.endTagWithAttributes);
      if (e.selfClosing) this._err(o.endTagWithTrailingSolidus);
  ...
  _stateRcdata(e) {
    switch (e) {
      ...
      case s.NULL: {
        (this._err(o.unexpectedNullCharacter), this._emitChars(m));
        break;
      }
      case s.EOF: {
        this._emitEOFToken();
    ...
    if (M(e))
      ...
      switch (e) {
        case s.GREATER_THAN_SIGN: {
          (this._err(o.missingEndTagName), (this.state = r.DATA));
          break;
        }
        case s.EOF: {
          (this._err(o.eofBeforeTagName),
  ...
  _stateTagName(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        (this._err(o.unexpectedNullCharacter), (t.tagName += m));
        break;
      }
      case s.EOF: {
      ...
      default:
        t.tagName += String.fromCodePoint(U(e) ? ee(e) : e);
    }
  }
  ...
  _stateRcdataEndTagOpen(e) {
    if (M(e))
      ((this.state = r.RCDATA_END_TAG_NAME), this._stateRcdataEndTagName(e));
    else (this._emitChars("</"), (this.state = r.RCDATA), this._stateRcdata(e));
  }
  ...
  _stateRawtextEndTagOpen(e) {
    if (M(e))
      ((this.state = r.RAWTEXT_END_TAG_NAME), this._stateRawtextEndTagName(e));
    else
      (this._emitChars("</"), (this.state = r.RAWTEXT), this._stateRawtext(e));
  }
  ...
  _stateScriptDataLessThanSign(e) {
    switch (e) {
      ...
      default:
        (this._emitChars("<"),
          (this.state = r.SCRIPT_DATA),
          this._stateScriptData(e));
    }
  }
  _stateScriptDataEndTagOpen(e) {
    if (M(e))
      ((this.state = r.SCRIPT_DATA_END_TAG_NAME),
        this._stateScriptDataEndTagName(e));
    else
      (this._emitChars("</"),
        (this.state = r.SCRIPT_DATA),
  ...
  _stateScriptDataDoubleEscapeStart(e) {
    if (
      this.preprocessor.startsWith(C.SCRIPT, !1) &&
      Be(this.preprocessor.peek(C.SCRIPT.length))
    ) {
      this._emitCodePoint(e);
  ...
  _stateScriptDataDoubleEscaped(e) {
    switch (e) {
      case s.HYPHEN_MINUS: {
        ((this.state = r.SCRIPT_DATA_DOUBLE_ESCAPED_DASH),
          this._emitChars("-"));
        break;
      }
      case s.LESS_THAN_SIGN: {
        ((this.state = r.SCRIPT_DATA_DOUBLE_ESCAPED_LESS_THAN_SIGN),
          this._emitChars("<"));
        break;
      }
      case s.NULL: {
  ...
  _stateScriptDataDoubleEscapedDash(e) {
    switch (e) {
      case s.HYPHEN_MINUS: {
        ((this.state = r.SCRIPT_DATA_DOUBLE_ESCAPED_DASH_DASH),
          this._emitChars("-"));
        break;
      }
      case s.LESS_THAN_SIGN: {
  ...
  _stateScriptDataDoubleEscapedLessThanSign(e) {
    if (e === s.SOLIDUS)
      ((this.state = r.SCRIPT_DATA_DOUBLE_ESCAPE_END), this._emitChars("/"));
    else
      ((this.state = r.SCRIPT_DATA_DOUBLE_ESCAPED),
        this._stateScriptDataDoubleEscaped(e));
  }
  ...
  _stateAttributeName(e) {
    switch (e) {
      ...
      case s.NULL: {
        (this._err(o.unexpectedNullCharacter), (this.currentAttr.name += m));
        break;
      }
      default:
        this.currentAttr.name += String.fromCodePoint(U(e) ? ee(e) : e);
    }
  }
  ...
  _stateBeforeAttributeValue(e) {
    switch (e) {
      ...
      default:
        ((this.state = r.ATTRIBUTE_VALUE_UNQUOTED),
          this._stateAttributeValueUnquoted(e));
    }
  }
  _stateAttributeValueDoubleQuoted(e) {
    switch (e) {
      ...
      case s.NULL: {
        (this._err(o.unexpectedNullCharacter), (this.currentAttr.value += m));
        break;
      }
      case s.EOF: {
        (this._err(o.eofInTag), this._emitEOFToken());
  ...
  _stateBogusComment(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        (this._err(o.unexpectedNullCharacter), (t.data += m));
        break;
      }
      default:
  ...
  _stateMarkupDeclarationOpen(e) {
    if (this._consumeSequenceIfMatch(C.DASH_DASH, !0))
      (this._createCommentToken(C.DASH_DASH.length + 1),
        (this.state = r.COMMENT_START));
  ...
  _stateCommentStart(e) {
    switch (e) {
      ...
      case s.GREATER_THAN_SIGN: {
        (this._err(o.abruptClosingOfEmptyComment), (this.state = r.DATA));
        let t = this.currentToken;
  ...
  _stateCommentLessThanSignBangDash(e) {
    if (e === s.HYPHEN_MINUS)
      this.state = r.COMMENT_LESS_THAN_SIGN_BANG_DASH_DASH;
    else ((this.state = r.COMMENT_END_DASH), this._stateCommentEndDash(e));
  }
  _stateCommentLessThanSignBangDashDash(e) {
    if (e !== s.GREATER_THAN_SIGN && e !== s.EOF) this._err(o.nestedComment);
  ...
  _stateBeforeDoctypeName(e) {
    if (U(e))
      (this._createDoctypeToken(String.fromCharCode(ee(e))),
  ...
  _stateDoctypeName(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        (this._err(o.unexpectedNullCharacter), (t.name += m));
        break;
      }
      case s.EOF: {
      ...
      default:
        t.name += String.fromCodePoint(U(e) ? ee(e) : e);
    }
  }
  _stateAfterDoctypeName(e) {
    ...
    switch (e) {
      ...
      default:
        if (this._consumeSequenceIfMatch(C.PUBLIC, !1))
          this.state = r.AFTER_DOCTYPE_PUBLIC_KEYWORD;
  ...
  _stateDoctypePublicIdentifierDoubleQuoted(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        (this._err(o.unexpectedNullCharacter), (t.publicId += m));
        break;
      }
      case s.GREATER_THAN_SIGN: {
  ...
  _stateDoctypeSystemIdentifierDoubleQuoted(e) {
    ...
    switch (e) {
      ...
      case s.NULL: {
        (this._err(o.unexpectedNullCharacter), (t.systemId += m));
        break;
      }
      case s.GREATER_THAN_SIGN: {
  ...
  _stateAmbiguousAmpersand(e) {
    if (xe(e)) this._flushCodePointConsumedAsCharacterReference(e);
      ...
      if (e === s.SEMICOLON) this._err(o.unknownNamedCharacterReference);
...
var ye = new Set([
  ...
  Ut = new Set([...te, u.OL, u.UL]),
  Ft = new Set([...te, u.BUTTON]),
  Ue = new Set([u.ANNOTATION_XML, u.MI, u.MN, u.MO, u.MS, u.MTEXT]),
  Fe = new Set([u.DESC, u.FOREIGN_OBJECT, u.TITLE]),
  yt = new Set([u.TR, u.TEMPLATE, u.HTML]),
  wt = new Set([u.TBODY, u.TFOOT, u.THEAD, u.TEMPLATE, u.HTML]),
  Yt = new Set([u.TABLE, u.TEMPLATE, u.HTML]),
  vt = new Set([u.TD, u.TH]);
class he {
  ...
  popUntilTagNamePopped(e) {
    ...
    while (t > 0 && this.treeAdapter.getNamespaceURI(this.items[t]) !== E.HTML);
  ...
  popUntilNumberedHeaderPopped() {
    this.popUntilPopped(H, E.HTML);
  }
  popUntilTableCellPopped() {
    this.popUntilPopped(vt, E.HTML);
  }
  ...
  clearBackToTableContext() {
    this.clearBackTo(Yt, E.HTML);
  }
  clearBackToTableBodyContext() {
    this.clearBackTo(wt, E.HTML);
  }
  ...
  hasInButtonScope(e) {
    return this.hasInDynamicScope(e, Ft);
  }
  ...
  hasInTableScope(e) {
    for (let t = this.stackTop; t >= 0; t--) {
      if (this.treeAdapter.getNamespaceURI(this.items[t]) !== E.HTML) continue;
  ...
  hasTableBodyContextInTableScope() {
    for (let e = this.stackTop; e >= 0; e--) {
      if (this.treeAdapter.getNamespaceURI(this.items[e]) !== E.HTML) continue;
...
class le {
  ...
  _getNoahArkConditionCandidates(e, t) {
    let a = [],
      n = t.length,
      d = this.treeAdapter.getTagName(e),
      h = this.treeAdapter.getNamespaceURI(e);
    for (let l = 0; l < this.entries.length; l++) {
      let _ = this.entries[l];
      if (_.type === L.Marker) break;
      let { element: b } = _;
      if (
        this.treeAdapter.getTagName(b) === d &&
        this.treeAdapter.getNamespaceURI(b) === h
      ) {
        let p = this.treeAdapter.getAttrList(b);
        if (p.length === n) a.push({ idx: l, attrs: p });
      }
    }
    return a;
  }
  _ensureNoahArkCondition(e) {
    ...
    let n = new Map(t.map((h) => [h.name, h.value])),
      d = 0;
    for (let h = 0; h < a.length; h++) {
      let l = a[h];
      if (l.attrs.every((_) => n.get(_.name) === _.value)) {
        if (((d += 1), d >= 3)) this.entries.splice(l.idx, 1);
      }
    }
  }
  insertMarker() {
  ...
  pushElement(e, t) {
    (this._ensureNoahArkCondition(e),
      this.entries.unshift({ type: L.Element, element: e, token: t }));
  }
  insertElementAfterBookmark(e, t) {
    let a = this.entries.indexOf(this.bookmark);
    this.entries.splice(a, 0, { type: L.Element, element: e, token: t });
  }
  removeEntry(e) {
  ...
  getElementEntryInScopeWithTagName(e) {
    let t = this.entries.find(
      (a) =>
        a.type === L.Marker || this.treeAdapter.getTagName(a.element) === e,
    );
...
var S = {
  ...
  setDocumentType(e, t, a, n) {
    let d = e.childNodes.find((h) => h.nodeName === "#documentType");
    if (d) ((d.name = t), (d.publicId = a), (d.systemId = n));
    else {
      let h = {
  ...
  insertText(e, t) {
    ...
    S.appendChild(e, S.createTextNode(t));
  },
  insertTextBefore(e, t, a) {
    let n = e.childNodes[e.childNodes.indexOf(a) - 1];
    if (n && S.isTextNode(n)) n.value += t;
    else S.insertBefore(e, S.createTextNode(t), a);
  },
  adoptAttributes(e, t) {
    let a = new Set(e.attrs.map((n) => n.name));
    for (let n = 0; n < t.length; n++)
      if (!a.has(t[n].name)) e.attrs.push(t[n]);
  },
  getFirstChild(e) {
...
var ve = "html",
  Qt = "about:legacy-compat",
  Gt = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd",
  Qe = [
...
function We(e) {
  return (
    e.name === ve &&
    e.publicId === null &&
    (e.systemId === null || e.systemId === Qt)
  );
}
function qe(e) {
  if (e.name !== ve) return O.QUIRKS;
  let { systemId: t } = e;
  if (t && t.toLowerCase() === Gt) return O.QUIRKS;
  let { publicId: a } = e;
  if (a !== null) {
    if (((a = a.toLowerCase()), qt.has(a))) return O.QUIRKS;
    let n = t === null ? Wt : Qe;
    if (Ye(a, n)) return O.QUIRKS;
    if (((n = t === null ? Ge : Xt), Ye(a, n))) return O.LIMITED_QUIRKS;
  }
  return O.NO_QUIRKS;
}
...
function Ke(e) {
  ...
  return (
    (t === u.FONT &&
      e.attrs.some(
        ({ name: n }) => n === g.COLOR || n === g.SIZE || n === g.FACE,
      )) ||
    Zt.has(t)
  );
}
...
function Ve(e) {
  let t = $t.get(e.tagName);
  if (t != null) ((e.tagName = t), (e.tagID = x(e.tagName)));
}
function eu(e, t) {
  return (
    t === E.MATHML &&
...
function tu(e, t, a) {
  if (t === E.MATHML && e === u.ANNOTATION_XML) {
    for (let n = 0; n < a.length; n++)
      if (a[n].name === g.ENCODING) {
        let d = a[n].value.toLowerCase();
        return d === Xe.TEXT_HTML || d === Xe.APPLICATION_XML;
      }
  }
  return (
...
class q {
  constructor(e, t, a = null, n = null) {
    ...
    ((this.document =
      t !== null && t !== void 0 ? t : this.treeAdapter.createDocument()),
      (this.tokenizer = new sse(this.options, this)),
      (this.activeFormattingElements = new le(this.treeAdapter)),
      (this.fragmentContextID = a
        ? x(this.treeAdapter.getTagName(a))
        : u.UNKNOWN),
      this._setContextModes(
        a !== null && a !== void 0 ? a : this.document,
        this.fragmentContextID,
      ),
      (this.openElements = new he(this.document, this.treeAdapter, this)));
  }
  static parse(e, t) {
    let a = new this(t);
  ...
  static getFragmentParser(e, t) {
    let a = { ...Je, ...t };
    (e !== null && e !== void 0) ||
      (e = a.treeAdapter.createElement(c.TEMPLATE, E.HTML, []));
    let n = a.treeAdapter.createElement("documentmock", E.HTML, []),
      d = new this(a, n, e);
    if (d.fragmentContextID === u.TEMPLATE)
      d.tmplInsertionModeStack.unshift(i.IN_TEMPLATE);
    return (
  ...
  _err(e, t, a) {
    ...
    let d = (n = e.location) !== null && n !== void 0 ? n : ru,
      h = {
        code: t,
        startLine: d.startLine,
        startCol: d.startCol,
        startOffset: d.startOffset,
        endLine: a ? d.startLine : d.endLine,
        endCol: a ? d.startCol : d.endCol,
        endOffset: a ? d.startOffset : d.endOffset,
      };
    this.onParseError(h);
  }
  onItemPush(e, t, a) {
    var n, d;
    if (
      ((d = (n = this.treeAdapter).onItemPush) === null ||
        d === void 0 ||
        d.call(n, e),
  ...
  onItemPop(e, t) {
    ...
    if (
      ...
      if (this.openElements.stackTop === 0 && this.fragmentContext)
        ((d = this.fragmentContext), (h = this.fragmentContextID));
      else ({ current: d, currentTagId: h } = this.openElements);
      this._setContextModes(d, h);
    }
  }
  _setContextModes(e, t) {
    let a =
      e === this.document || this.treeAdapter.getNamespaceURI(e) === E.HTML;
  ...
  switchToPlaintextParsing() {
    ((this.insertionMode = i.TEXT),
      ...
      (this.tokenizer.state = ty.PLAINTEXT));
  }
  ...
  _initTokenizerForFragmentParsing() {
    ...
    switch (this.fragmentContextID) {
      case u.TITLE:
      case u.TEXTAREA: {
        this.tokenizer.state = ty.RCDATA;
        break;
      }
      case u.STYLE:
      case u.XMP:
      ...
      case u.NOFRAMES:
      case u.NOSCRIPT: {
        this.tokenizer.state = ty.RAWTEXT;
        break;
      }
      case u.SCRIPT: {
        this.tokenizer.state = ty.SCRIPT_DATA;
        break;
      }
      case u.PLAINTEXT: {
        this.tokenizer.state = ty.PLAINTEXT;
  ...
  _setDocumentType(e) {
    ...
    if (
      ...
      if (h) this.treeAdapter.setNodeSourceCodeLocation(h, e.location);
    }
  }
  ...
  _insertFakeElement(e, t) {
    let a = this.treeAdapter.createElement(e, E.HTML, []);
  ...
  _insertFakeRootElement() {
    let e = this.treeAdapter.createElement(c.HTML, E.HTML, []);
    if (this.options.sourceCodeLocationInfo)
  ...
  _appendCommentNode(e, t) {
    ...
    if (
      (this.treeAdapter.appendChild(t, a), this.options.sourceCodeLocationInfo)
    )
  ...
  _insertCharacters(e) {
    ...
    let n = this.treeAdapter.getChildNodes(t),
      d = a ? n.lastIndexOf(a) : n.length,
      h = n[d - 1];
    if (this.treeAdapter.getNodeSourceCodeLocation(h)) {
      let { endLine: _, endCol: b, endOffset: p } = e.location;
  ...
  _setEndLocation(e, t) {
    if (this.treeAdapter.getNodeSourceCodeLocation(e) && t.location) {
      ...
      this.treeAdapter.updateNodeSourceCodeLocation(e, d);
    }
  }
  shouldProcessStartTagTokenInForeignContent(e) {
    ...
    if (
      ...
      this.treeAdapter.getNamespaceURI(t) === E.MATHML
    )
      return !1;
    return (
      this.tokenizer.inForeignNode ||
      ((e.tagID === u.MGLYPH || e.tagID === u.MALIGNMARK) &&
        !this._isIntegrationPoint(a, t, E.HTML))
    );
  }
  _processToken(e) {
    switch (e.type) {
  ...
  _reconstructActiveFormattingElements() {
    ...
    if (e) {
      let t = this.activeFormattingElements.entries.findIndex(
          (n) => n.type === L.Marker || this.openElements.contains(n.element),
        ),
        a = t < 0 ? e - 1 : t - 1;
      for (let n = a; n >= 0; n--) {
        let d = this.activeFormattingElements.entries[n];
        (this._insertElement(
          d.token,
  ...
  _findFosterParentingLocation() {
    for (let e = this.openElements.stackTop; e >= 0; e--) {
      ...
      switch (this.openElements.tagIDs[e]) {
        case u.TEMPLATE: {
          if (this.treeAdapter.getNamespaceURI(t) === E.HTML)
            return {
  ...
  _processStartTag(e) {
    if (this.shouldProcessStartTagTokenInForeignContent(e)) Ua(this, e);
  ...
  onWhitespaceCharacter(e) {
    if (this.skipNextNewLine) {
      if (
        ((this.skipNextNewLine = !1), e.chars.charCodeAt(0) === s.LINE_FEED)
      ) {
...
function nu(e, t) {
  ...
  for (; n >= 0; n--) {
    let d = e.openElements.items[n];
    if (d === t.element) break;
    if (e._isSpecialElement(d, e.openElements.tagIDs[n])) a = d;
  }
  if (!a)
...
function cu(e, t, a) {
  let n = t,
    d = e.openElements.getCommonAncestor(t);
  for (let h = 0, l = d; l !== a; h++, l = d) {
    d = e.openElements.getCommonAncestor(l);
    let _ = e.activeFormattingElements.getElementEntry(l),
      b = _ && h >= su;
    if (!_ || b) {
      if (b) e.activeFormattingElements.removeEntry(_);
      e.openElements.remove(l);
    } else {
      if (((l = ou(e, _)), n === t)) e.activeFormattingElements.bookmark = _;
      (e.treeAdapter.detachNode(n), e.treeAdapter.appendChild(l, n), (n = l));
    }
  }
  return n;
}
...
function du(e, t, a) {
  let n = e.treeAdapter.getTagName(t),
    d = x(n);
  if (e._isElementCausesFosterParenting(d)) e._fosterParentElement(a);
  else {
    let h = e.treeAdapter.getNamespaceURI(t);
    if (d === u.TEMPLATE && h === E.HTML)
...
function Eu(e, t, a) {
  let n = e.treeAdapter.getNamespaceURI(a.element),
    { token: d } = a,
    h = e.treeAdapter.createElement(d.tagName, n, d.attrs);
  (e._adoptNodes(t, h),
    e.treeAdapter.appendChild(t, h),
    e.activeFormattingElements.insertElementAfterBookmark(h, d),
    e.activeFormattingElements.removeEntry(a),
    e.openElements.remove(a.element),
    e.openElements.insertAfter(t, h, d.tagID));
}
function Ne(e, t) {
  for (let a = 0; a < au; a++) {
    let n = iu(e, t);
    ...
    let h = cu(e, d, n.element),
      l = e.openElements.getCommonAncestor(n.element);
    if ((e.treeAdapter.detachNode(h), l)) du(e, l, h);
    Eu(e, d, n);
  }
}
function be(e, t) {
  ...
  if (((e.stopped = !0), t.location)) {
    ...
    if (!e.fragmentContext && e.openElements.stackTop >= 0) {
      let n = e.openElements.items[0],
        d = e.treeAdapter.getNodeSourceCodeLocation(n);
      if (d && !d.endTag) {
        if ((e._setEndLocation(n, t), e.openElements.stackTop >= 1)) {
          let h = e.openElements.items[1],
            l = e.treeAdapter.getNodeSourceCodeLocation(h);
          if (l && !l.endTag) e._setEndLocation(h, t);
        }
      }
    }
  }
...
function lu(e, t) {
  ...
  let a = t.forceQuirks ? O.QUIRKS : qe(t);
  if (!We(t)) e._err(t, o.nonConformingDoctype);
...
function fu(e, t) {
  if (t.tagID === u.HTML)
    (e._insertElement(t, E.HTML), (e.insertionMode = i.BEFORE_HEAD));
  else w(e, t);
}
function mu(e, t) {
  let a = t.tagID;
...
function bu(e, t) {
  ...
  else e._err(t, o.endTagWithoutMatchingOpenElement);
}
function Y(e, t) {
...
function R(e, t) {
  switch (t.tagID) {
    ...
    case u.TITLE: {
      e._switchToTextParsing(t, ty.RCDATA);
      break;
    }
    case u.NOSCRIPT: {
      if (e.options.scriptingEnabled) e._switchToTextParsing(t, ty.RAWTEXT);
      else
        (e._insertElement(t, E.HTML), (e.insertionMode = i.IN_HEAD_NO_SCRIPT));
      break;
    }
    case u.NOFRAMES:
    case u.STYLE: {
      e._switchToTextParsing(t, ty.RAWTEXT);
      break;
    }
    case u.SCRIPT: {
      e._switchToTextParsing(t, ty.SCRIPT_DATA);
      break;
    }
    case u.TEMPLATE: {
      (e._insertTemplate(t),
...
function Cu(e, t) {
  switch (t.tagID) {
    ...
    case u.FRAMESET: {
      (e._insertElement(t, E.HTML), (e.insertionMode = i.IN_FRAMESET));
      break;
    }
    case u.BASE:
    case u.BASEFONT:
...
function Du(e, t) {
  if (e.openElements.hasInButtonScope(u.P)) e._closePElement();
  if (H.has(e.openElements.currentTagId)) e.openElements.pop();
  e._insertElement(t, E.HTML);
}
function gu(e, t) {
  if (e.openElements.hasInButtonScope(u.P)) e._closePElement();
  (e._insertElement(t, E.HTML), (e.skipNextNewLine = !0), (e.framesetOk = !1));
}
function Pu(e, t) {
  let a = e.openElements.tmplCount > 0;
  if (!e.formElement || a) {
    if (e.openElements.hasInButtonScope(u.P)) e._closePElement();
    if ((e._insertElement(t, E.HTML), !a))
...
function Mu(e, t) {
  ...
  for (let n = e.openElements.stackTop; n >= 0; n--) {
    let d = e.openElements.tagIDs[n];
    if (
      (a === u.LI && d === u.LI) ||
      ((a === u.DD || a === u.DT) && (d === u.DD || d === u.DT))
    ) {
      (e.openElements.generateImpliedEndTagsWithExclusion(d),
        e.openElements.popUntilTagNamePopped(d));
      break;
    }
    if (
      d !== u.ADDRESS &&
      d !== u.DIV &&
      d !== u.P &&
      e._isSpecialElement(e.openElements.items[n], d)
    )
      break;
  }
  if (e.openElements.hasInButtonScope(u.P)) e._closePElement();
...
function xu(e, t) {
  if (e.openElements.hasInButtonScope(u.P)) e._closePElement();
  (e._insertElement(t, E.HTML), (e.tokenizer.state = ty.PLAINTEXT));
}
function Bu(e, t) {
...
function Uu(e, t) {
  if (
    ...
    (Ne(e, t), e._reconstructActiveFormattingElements());
  (e._insertElement(t, E.HTML),
    e.activeFormattingElements.pushElement(e.openElements.current, t));
}
function Fu(e, t) {
...
function yu(e, t) {
  if (
    e.treeAdapter.getDocumentMode(e.document) !== O.QUIRKS &&
...
function st(e) {
  let t = j(e, g.TYPE);
  return t != null && t.toLowerCase() === uu;
}
function wu(e, t) {
  if (
    (e._reconstructActiveFormattingElements(),
...
function vu(e, t) {
  if (e.openElements.hasInButtonScope(u.P)) e._closePElement();
  (e._appendElement(t, E.HTML), (e.framesetOk = !1), (t.ackSelfClosing = !0));
}
function Qu(e, t) {
  ((t.tagName = c.IMG), (t.tagID = u.IMG), at(e, t));
}
function Gu(e, t) {
  (e._insertElement(t, E.HTML),
    (e.skipNextNewLine = !0),
    (e.tokenizer.state = ty.RCDATA),
...
function qu(e, t) {
  ((e.framesetOk = !1), e._switchToTextParsing(t, ty.RAWTEXT));
}
function $e(e, t) {
  e._switchToTextParsing(t, ty.RAWTEXT);
}
...
function Vu(e, t) {
  if (e.openElements.hasInScope(u.RUBY))
    e.openElements.generateImpliedEndTags();
  e._insertElement(t, E.HTML);
}
function zu(e, t) {
...
function ju(e, t) {
  if ((e._reconstructActiveFormattingElements(), fe(t), ue(t), t.selfClosing))
    e._appendElement(t, E.MATHML);
  else e._insertElement(t, E.MATHML);
  t.ackSelfClosing = !0;
}
function Ju(e, t) {
  if ((e._reconstructActiveFormattingElements(), me(t), ue(t), t.selfClosing))
    e._appendElement(t, E.SVG);
  else e._insertElement(t, E.SVG);
  t.ackSelfClosing = !0;
}
function Ze(e, t) {
  (e._reconstructActiveFormattingElements(), e._insertElement(t, E.HTML));
...
function I(e, t) {
  switch (t.tagID) {
    ...
    case u.NOSCRIPT: {
      if (e.options.scriptingEnabled) $e(e, t);
      else Ze(e, t);
      break;
    }
    case u.PLAINTEXT: {
...
function Zu(e, t) {
  if (e.openElements.hasInScope(u.BODY))
    ((e.insertionMode = i.AFTER_BODY), lt(e, t));
}
function ea(e, t) {
  let a = t.tagID;
...
function ta(e) {
  ...
  if ((a || t) && e.openElements.hasInScope(u.FORM)) {
    if ((e.openElements.generateImpliedEndTags(), t))
...
function rt(e, t) {
  ...
  for (let d = e.openElements.stackTop; d > 0; d--) {
    let h = e.openElements.items[d],
      l = e.openElements.tagIDs[d];
    if (n === l && (n !== u.UNKNOWN || e.treeAdapter.getTagName(h) === a)) {
      if (
        (e.openElements.generateImpliedEndTagsWithExclusion(n),
        e.openElements.stackTop >= d)
      )
        e.openElements.shortenToLength(d);
      break;
    }
    if (e._isSpecialElement(h, l)) break;
  }
}
function ne(e, t) {
  switch (t.tagID) {
...
function it(e, t) {
  if (e.tmplInsertionModeStack.length > 0) ht(e, t);
  else Ie(e, t);
}
function ca(e, t) {
  var a;
...
function _e(e, t) {
  if (et.has(e.openElements.currentTagId))
    switch (
...
function ma(e, t) {
  if (st(t)) e._appendElement(t, E.HTML);
  else X(e, t);
  t.ackSelfClosing = !0;
}
function _a(e, t) {
...
function y(e, t) {
  ...
  if (e.hasNonWhitespacePendingCharacterToken)
    for (; a < e.pendingCharacterTokens.length; a++)
      X(e, e.pendingCharacterTokens[a]);
  else
    for (; a < e.pendingCharacterTokens.length; a++)
...
function Ca(e, t) {
  ...
  switch (a) {
    ...
    case u.THEAD:
    case u.TR: {
      if (e.openElements.hasInTableScope(a)) (e._closeTableCell(), dt(e, t));
      break;
    }
    case u.BODY:
    case u.CAPTION:
...
function Sa(e, t) {
  switch (t.tagID) {
    ...
    case u.TFOOT:
    case u.THEAD: {
      ((e.tmplInsertionModeStack[0] = i.IN_TABLE),
        (e.insertionMode = i.IN_TABLE),
        k(e, t));
      break;
    }
    ...
    case u.TD:
    case u.TH: {
      ((e.tmplInsertionModeStack[0] = i.IN_ROW),
        (e.insertionMode = i.IN_ROW),
        oe(e, t));
      break;
    }
    default:
      ((e.tmplInsertionModeStack[0] = i.IN_BODY),
        (e.insertionMode = i.IN_BODY),
        I(e, t));
  }
}
function La(e, t) {
  if (t.tagID === u.TEMPLATE) B(e, t);
}
function ht(e, t) {
  if (e.openElements.tmplCount > 0)
    (e.openElements.popUntilTagNamePopped(u.TEMPLATE),
...
function lt(e, t) {
  ...
  if (t.tagID === u.HTML) {
    ...
    if (
      ...
      if (
        n &&
        !((a = e.treeAdapter.getNodeSourceCodeLocation(n)) === null ||
        a === void 0
          ? void 0
          : a.endTag)
      )
...
function re(e, t) {
  ((e.insertionMode = i.IN_BODY), ie(e, t));
}
function Da(e, t) {
  switch (t.tagID) {
    case u.HTML: {
...
function ga(e, t) {
  if (t.tagID === u.FRAMESET && !e.openElements.isRootHtmlElementCurrent()) {
    if (
      (e.openElements.pop(),
      !e.fragmentContext && e.openElements.currentTagId !== u.FRAMESET)
    )
...
function Ua(e, t) {
  if (Ke(t)) (ft(e), e._startTagOutsideForeignContent(t));
  else {
    let a = e._getAdjustedCurrentElement(),
      n = e.treeAdapter.getNamespaceURI(a);
    if (n === E.MATHML) fe(t);
    else if (n === E.SVG) (Ve(t), me(t));
    if ((ue(t), t.selfClosing)) e._appendElement(t, n);
...
function Fa(e, t) {
  if (t.tagID === u.P || t.tagID === u.BR) {
    (ft(e), e._endTagOutsideForeignContent(t));
    return;
  }
  for (let a = e.openElements.stackTop; a > 0; a--) {
    ...
    let d = e.treeAdapter.getTagName(n);
    if (d.toLowerCase() === t.tagName) {
      ((t.tagName = d), e.openElements.shortenToLength(a));
      break;
    }
  }
}
...
function Oe(e, t) {
  return function (n) {
    let d,
      ...
      l = "";
    while ((d = e.exec(n))) {
      if (h !== d.index) l += n.substring(h, d.index);
      ((l += t.get(d[0].charCodeAt(0))), (h = d.index + 1));
    }
    return l + n.substring(h);
  };
}
var Ps = Oe(/[&<>'"]/g, ya),
  mt = Oe(
...
function bt(e, t) {
  return (
    ...
    wa.has(t.treeAdapter.getTagName(e))
  );
}
var Ya = { treeAdapter: S, scriptingEnabled: !0 };
function S4t(e, t) {
  let a = { ...Ya, ...t };
  if (bt(e, a)) return "";
  return At(e, a);
  ...
  let a = "",
    n =
      ...
      t.treeAdapter.getNamespaceURI(e) === E.HTML
        ...
        : e,
    d = t.treeAdapter.getChildNodes(n);
  if (d) for (let h of d) a += va(h, t);
  return a;
}
function va(e, t) {
  if (t.treeAdapter.isElementNode(e)) return Qa(e, t);
  if (t.treeAdapter.isTextNode(e)) return Wa(e, t);
  if (t.treeAdapter.isCommentNode(e)) return qa(e, t);
  if (t.treeAdapter.isDocumentTypeNode(e)) return Xa(e, t);
  return "";
}
function Qa(e, t) {
  let a = t.treeAdapter.getTagName(e);
  return `<${a}${Ga(e, t)}>${bt(e, t) ? "" : `${At(e, t)}</${a}>`}`;
}
function Ga(e, { treeAdapter: t }) {
  let a = "";
...
function Wa(e, t) {
  let { treeAdapter: a } = t,
    ...
    d = a.getParentNode(e),
    h = d && a.isElementNode(d) && a.getTagName(d);
  return h && a.getNamespaceURI(d) === E.HTML && Me(h, t.scriptingEnabled)
    ? n
    : _t(n);
}
function qa(e, { treeAdapter: t }) {
  return `<!--${t.getCommentNodeContent(e)}-->`;
}
function Xa(e, { treeAdapter: t }) {
...
function _yr(e, t, a) {
  ...
  let n = q.getFragmentParser(e, a);
  return (n.tokenizer.write(t, !0), n.getFragment());
}
export { ty, sse, S4t, rAt, _yr };
