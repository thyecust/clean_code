...
` +
  ...
  Nu.expose = function (e, t) {
    for (var r in e)
      Object.defineProperty(t.prototype, r, { value: e[r], writable: yu });
  };
  ...
  Fi.prototype = {
    ...
    _dispatchEvent: function (t, r) {
      ...
      function a(_, v) {
        ...
        if (
          ((v.currentTarget = _),
          se !== vt.CAPTURING_PHASE && _._handlers && _._handlers[ne])
        ) {
      ...
      for (var f = s.length - 1; f >= 0; f--)
        if ((a(s[f], t), t._propagationStopped)) break;
      ...
      if (t.bubbles && !t._propagationStopped) {
        ...
        for (var m = 0, p = s.length; m < p; m++)
          if ((a(s[m], t), t._propagationStopped)) break;
      }
      if (
        ((t._dispatching = !1),
...
`;
      ...
      case 4:
        ...
        if (Ui[v] || (v === "NOSCRIPT" && t.ownerDocument._scripting_enabled))
          r += e.data;
        else r += il(e.data);
        break;
      case 8:
...
var xe = w(function (ud, es) {
  ...
  X.prototype = Object.create(Ji.prototype, {
    ...
    parentElement: {
      get: function () {
        return this.parentNode && this.parentNode.nodeType === _e
          ? this.parentNode
          : null;
      },
    },
    ...
    isConnected: {
      get: function () {
        ...
        while (e != null) {
          ...
          if (
            ((e = e.parentNode),
            e != null && e.nodeType === X.DOCUMENT_FRAGMENT_NODE)
          )
            e = e.host;
        }
        return !1;
    ...
    replaceChild: {
      value: function (t, r) {
        var a = this;
        if ((a._ensureInsertValid(t, r, !1), t.doc !== a.doc))
          a.doc.adoptNode(t);
    ...
    _insertOrReplace: {
      value: function (t, r, a) {
        ...
        if (t._childNodes) {
          if (
            ((c = r === null ? t._childNodes.length : r.index),
            s.parentNode === t)
          ) {
            var m = s.index;
            if (m < c) c--;
        ...
        if (s.nodeType === ut) {
          ...
          if (((s.parentNode = t), a)) {
            if ((Kr.replace(p, s), t._childNodes))
              ((s._index = c), (t._childNodes[c] = s));
      ...
      value: function () {
        if (this.doc.modclock) {
          ...
          for (var t = this; t; t = t.parentElement)
            if (t._lastModTime) t._lastModTime = e;
        }
      },
    },
    doc: {
    ...
    normalize: {
      value: function () {
        ...
        for (var t = this.firstChild; t !== null; t = e) {
          ...
          if (r === null) continue;
          else if (r.nodeType === X.TEXT_NODE)
...
var un = w(function (Al) {
    ...
    return {
      ...
      set: function (p) {
        ...
        if (r) p = p < 0 || p > 2147483647 ? t.call(this) : p | 0;
          ...
          p = p < -2147483648 || p > 2147483647 ? t.call(this) : p | 0;
  ...
  Al.registerChangeHandler = function (e, t, r) {
    ...
    if (!Object.prototype.hasOwnProperty.call(a, "_attributeChangeHandlers"))
      a._attributeChangeHandlers = Object.create(
        a._attributeChangeHandlers || null,
      );
    a._attributeChangeHandlers[t] = r;
  };
});
var ps = w(function (md, hs) {
  hs.exports = ds;
  var kl = xe();
  function ds(e, t) {
    ((this.root = e),
...
var ta = w(function (Ot, Ns) {
    ...
    fn = function (e, t, r) {
      ...
      return function (p) {
        ...
        while (_) {
          if (t(_, p)) v++;
          if (_ === p)
            return ((v -= c), s && v ? v % s === 0 && v < 0 === s < 0 : !v);
          _ = m(_);
        }
      };
    },
  ...
  var or = function (e) {
      ...
      while (t) {
        ...
        else if ((m = C.simple.exec(t)))
          ((t = t.substring(m[0].length)),
            (f = "*"),
            s.push(Jr(f, !0)),
            s.push(Jr(m)));
        else throw SyntaxError("Invalid selector.");
        while ((m = C.simple.exec(t)))
          ((t = t.substring(m[0].length)), s.push(Jr(m)));
        if (t[0] === "!")
          ((t = t.substring(1)), (c = Bl()), (c.qname = f), s.push(c.simple));
        if ((m = C.ref.exec(t))) {
          ((t = t.substring(m[0].length)),
  ...
  xt.prototype = Object.create(Ls.prototype, {
    ...
    outerHTML: {
      ...
      set: function (e) {
        ...
        if (r.nodeType === ke.DOCUMENT_FRAGMENT_NODE)
          r = r.ownerDocument.createElement("body");
        var a = t.implementation.mozHTMLParser(t._address, r);
        (a.parse(e === null ? "" : String(e), !0),
          this.replaceWith(a._asDocumentFragment()));
      },
    },
    _insertAdjacent: {
      value: function (t, r) {
      ...
      value: function (t, r) {
        ...
        switch (t) {
          ...
          case "afterend":
            if (
              ((a = this.parentNode),
              a === null || a.nodeType === ke.DOCUMENT_NODE)
            )
        ...
        if (
          !(a instanceof xt) ||
          (a.ownerDocument.isHTML &&
            a.localName === "html" &&
            a.namespaceURI === He.HTML)
        )
          a = a.ownerDocument.createElementNS(He.HTML, "body");
        var s = this.ownerDocument.implementation.mozHTMLParser(
    ...
    isEqual: {
      value: function (t) {
        ...
        for (var r = 0, a = this._numattrs; r < a; r++) {
          ...
          if (t.getAttributeNS(s.namespaceURI, s.localName) !== s.value)
            return !1;
        }
        return !0;
      },
      ...
      value: function (t, r) {
        ...
        for (var a = 0, s = this._numattrs; a < s; a++) {
          ...
          if (
            c.prefix === "xmlns" &&
            c.value === t &&
            r.lookupNamespaceURI(c.localName) === t
          )
            return c.localName;
        }
    ...
    removeAttribute: {
      value: function (t) {
        ...
        var f = r.onchange;
        if ((r._setOwnerElement(null), f))
          f.call(r, this, r.localName, r.value, null);
    ...
    removeAttributeNS: {
      value: function (t, r) {
        ...
        var f = s.onchange;
        if ((s._setOwnerElement(null), f))
          f.call(s, this, s.localName, s.value, null);
      ...
      value: function (e) {
        ...
        if (Array.isArray(r)) {
          ...
          if ((Y.assert(a !== -1), r.length === 2)) {
            ...
            (r.splice(a, 1), this._attributes && this._attributes[t] === e)
          )
        ...
        if (this.lastModTime !== this.element.lastModTime) {
          ...
          for (var s = this.element.firstChild; s !== null; s = s.nextSibling)
            if (s.nodeType === ke.ELEMENT_NODE) {
              ((this[this.childrenByNumber.length] = s),
                this.childrenByNumber.push(s));
  ...
  ia.prototype = Object.create(Us.prototype, {
    substringData: {
      value: function (t, r) {
        ...
        if (
          ((t = t >>> 0), (r = r >>> 0), t > this.data.length || t < 0 || r < 0)
        )
          Ps.IndexSizeError();
    ...
    replaceData: {
      value: function (t, r, a) {
        var s = this.data,
          c = s.length;
        if (((t = t >>> 0), (r = r >>> 0), (a = String(a)), t > c || t < 0))
          Ps.IndexSizeError();
        if (t + r > c) r = c - t;
...
var Cn = w(function (wd, Ks) {
  Ks.exports = An;
  var ax = xe(),
    Xs = lr();
  function An(e, t) {
    (Xs.call(this),
      (this.nodeType = ax.COMMENT_NODE),
      (this.ownerDocument = e),
      (this._data = t));
  }
  var fr = {
...
var kn = w(function (Sd, $s) {
  ...
  function Dn(e) {
    (Qs.call(this),
      (this.nodeType = nx.DOCUMENT_FRAGMENT_NODE),
      (this.ownerDocument = e));
  }
...
var u0 = w(function (Ld, o0) {
  ...
  function n0(e, t) {
    ...
    while (a !== null) {
      if (((c = e._internalFilter(a)), c === fe.FILTER_ACCEPT))
        return ((e._currentNode = a), a);
      if (c === fe.FILTER_SKIP) {
        if (((r = a[qn[t]]), r !== null)) {
          a = r;
          continue;
      ...
      while (a !== null) {
        ...
        if (
          ((s = a.parentNode),
          s === null || s === e.root || s === e._currentNode)
        )
          return null;
        else a = s;
      }
  ...
  function i0(e, t) {
    ...
    while (!0) {
      ...
      while (s !== null) {
        ...
        if (((s = r[qn[t]]), a === fe.FILTER_REJECT || s === null))
          s = r[Hn[t]];
      }
    ...
    parentNode: {
      value: function () {
        ...
        while (t !== this.root) {
          ...
          if (this._internalFilter(t) === fe.FILTER_ACCEPT)
      ...
      value: function () {
        ...
        while (t !== this._root) {
          for (a = t.previousSibling; a; a = t.previousSibling) {
            if (
              ((t = a), (r = this._internalFilter(t)), r === fe.FILTER_REJECT)
            )
              continue;
            for (s = t.lastChild; s; s = t.lastChild)
              if (
                ((t = s), (r = this._internalFilter(t)), r === fe.FILTER_REJECT)
              )
                break;
          ...
          if (
            ((t = t.parentNode), this._internalFilter(t) === fe.FILTER_ACCEPT)
          )
            return ((this._currentNode = t), t);
        }
        return null;
      ...
      value: function () {
        ...
        e: while (!0) {
          for (a = t.firstChild; a; a = t.firstChild)
            if (
              ((t = a), (r = this._internalFilter(t)), r === fe.FILTER_ACCEPT)
            )
              return ((this._currentNode = t), t);
          ...
          for (
            ...
            if (
              ((t = s), (r = this._internalFilter(t)), r === fe.FILTER_ACCEPT)
            )
              return ((this._currentNode = t), t);
    ...
    _preremove: {
      value: function (t) {
        ...
        if (t.previousSibling === null) this._referenceNode = t.parentNode;
          ...
          var a;
          for (
            a = this._referenceNode.lastChild;
            a;
            a = this._referenceNode.lastChild
          )
    ...
    if (t) {
      ...
      if (t[4]) {
        ...
        if (t[4].match(de.portPattern)) {
          ...
          ((this.host = t[4].substring(0, a)),
            (this.port = t[4].substring(a + 1)));
        } else this.host = t[4];
      }
  ...
  function dx(e) {
    ...
    while (r < e.length)
      switch (e.charCodeAt(r++)) {
        ...
        case 58:
          if (!m && a === 0 && s === 0)
            ((m = v0(e.substring(f, r - 1).trim())), (c = r));
          break;
        case 59:
          if (m && c > 0 && a === 0 && s === 0) {
  ...
  function A0(e) {
    ...
    for (let a = 0; a < r.length; a += 2) {
      let s = r[a],
        c = r[a + 1];
      if (c.endsWith(S0))
        ((t.priority[s] = "important"), (c = c.slice(0, -S0.length).trim()));
      t.property[s] = c;
    }
    return t;
  }
    ...
    _serialize: {
      value: function () {
        ...
        for (var r in e.property) {
          if (t) t += " ";
          if (((t += r + ": " + e.property[r]), e.priority[r]))
            t += " !" + e.priority[r];
          t += ";";
        }
...
var Vn = w(function (Fd, k0) {
  ...
  pr.prototype = Object.create(Object.prototype, {
    ...
    port: {
      get: function () {
        var e = this._url;
        if (e.isAbsolute() && e.isAuthorityBased() && e.port !== void 0)
          return e.port;
        else return "";
      },
      set: function (e) {
    ...
    search: {
      get: function () {
        var e = this._url;
        if (e.isAbsolute() && e.isHierarchical() && e.query !== void 0)
          return "?" + e.query;
        else return "";
      },
      set: function (e) {
...
var fa = w(function (Wd, Q0) {
  ...
  br.prototype = Object.create(W0.prototype, {
    ...
    createProcessingInstruction: {
      value: function (e, t) {
        if (!xa.isValidName(e) || t.indexOf("?>") !== -1)
    ...
    createAttributeNS: {
      value: function (e, t) {
        ((e = e === null || e === void 0 || e === "" ? null : String(e)),
          (t = String(t)));
        var r = G0(e, t);
    ...
    insertBefore: {
      value: function (t, r) {
        return (
          he.prototype.insertBefore.call(this, t, r),
    ...
    replaceChild: {
      value: function (t, r) {
        return (
          he.prototype.replaceChild.call(this, t, r),
          this._updateDocTypeElement(),
          r
        );
      },
    ...
    removeChild: {
      value: function (t) {
        return (
          he.prototype.removeChild.call(this, t),
          this._updateDocTypeElement(),
          t
        );
      },
...
`,
    ...
    mutateValue: {
      value: function (e) {
        if (this.mutationHandler)
          this.mutationHandler({ type: Ut.VALUE, target: e, data: e.data });
      },
    },
    mutateAttr: {
      value: function (e, t) {
    ...
    mutateMove: {
      value: function (e) {
        if (this.mutationHandler)
          this.mutationHandler({ type: Ut.MOVE, target: e });
      },
    },
    addId: {
      value: function (t, r) {
  ...
  function z0(e, t) {
    if (e && e.isHTML) {
      for (var r = e.firstChild; r !== null; r = r.nextSibling)
        if (
          r.nodeType === he.ELEMENT_NODE &&
          r.localName === t &&
          r.namespaceURI === jt.HTML
        )
          return r;
    }
    return null;
  ...
  Ke.prototype.add = function (e) {
    if (!this.nodes[e._nid])
      ((this.nodes[e._nid] = e), this.length++, (this.firstNode = void 0));
  };
  Ke.prototype.del = function (e) {
    if (this.nodes[e._nid])
      (delete this.nodes[e._nid], this.length--, (this.firstNode = void 0));
  };
      ...
      for (e in this.nodes)
        if (
          ...
          this.firstNode.compareDocumentPosition(this.nodes[e]) &
            he.DOCUMENT_POSITION_PRECEDING
        )
...
var va = w(function (Kd, vc) {
  ...
  function me(e) {
    ...
    for (var a = 0; a < e.length; a += t)
      r += String.fromCharCode.apply(String, e.slice(a, a + t));
    return r;
  }
  function df(e) {
    var t = [];
  ...
  function G(e, t) {
    if (typeof t === "string")
      return e.namespaceURI === N.HTML && e.localName === t;
  ...
  function Zn(e) {
    for (var t = 0, r = e.length; t < r; t++)
      if (e[t][0] in ec) e[t].push(ec[e[t][0]]);
  }
  function fc(e, t) {
  ...
  q.ElementStack.prototype.popElementType = function (e) {
    for (var t = this.elements.length - 1; t > 0; t--)
      if (this.elements[t] instanceof e) break;
    ((this.elements.length = t), (this.top = this.elements[t - 1]));
  };
  q.ElementStack.prototype.popElement = function (e) {
    for (var t = this.elements.length - 1; t > 0; t--)
      if (this.elements[t] === e) break;
    ((this.elements.length = t), (this.top = this.elements[t - 1]));
  };
  ...
  q.ActiveFormattingElements.prototype.clearToMarker = function () {
    for (var e = this.list.length - 1; e >= 0; e--)
      if (this.list[e] === this.MARKER) break;
    if (e < 0) e = 0;
  ...
  function q(e, t, r) {
    ...
    if (((F._parser = Sr), (F._scripting_enabled = Nr), t)) {
      ...
      if ((F._appendChild(fi), u.push(fi), t instanceof j.HTMLTemplateElement))
        Ue.push(Va);
      $t();
...
`)
    ...
    var re = (Sr.insertToken = function (i, o, x, d) {
      ...
      if (!b || b.namespaceURI === N.HTML) h(i, o, x, d);
        ...
        (oc(b) &&
          (i === Gt || (i === pe && o !== "mglyph" && o !== "malignmark"))) ||
        (i === pe &&
          o === "svg" &&
    ...
    function pi(n) {
      for (var i = u.elements.length - 1; i >= 0; i--)
        if (u.elements[i] instanceof n) return i;
      return -1;
    }
    function Dr(n) {
      var i,
        ...
        b;
      if (
        ((x = pi(j.HTMLTableElement)),
        (d = pi(j.HTMLTemplateElement)),
        d >= 0 && (x < 0 || d > x))
      )
        i = u.elements[d];
      else if (x >= 0)
      ...
      while (i < 8) {
        ...
        if (!d) return (u.popElement(o), L.remove(o), !0);
          ...
          while (!0) {
            ...
            if (
              (L.replace(K, ot.elt, ot.attrs),
              (u.elements[we] = ot.elt),
              (K = ot.elt),
              le === d)
            )
          ...
          else if (R instanceof j.HTMLTemplateElement)
            R.content._appendChild(le);
...
`,
      ...
      switch (n) {
        ...
        case 5:
          ...
          if (
            ...
            F._quirks = !0;
          else if (Jx.test(b) || (A !== void 0 && J0.test(b)))
            F._limitedQuirks = !0;
          h = Ai;
          return;
      }
        ...
        case 2:
          switch (i) {
            ...
            case "script":
              (Cr(function (b) {
                var A = Qt(b, i, o);
                if (((A._parser_inserted = !0), (A._force_async = !1), dt))
                  A._already_started = !0;
                return (Dt(), A);
              }),
                (l = nt),
                (Pe = h),
          ...
          switch (i) {
            ...
            case "body":
              if (
                ((d = u.elements[1]),
                !d ||
                  !(d instanceof j.HTMLBodyElement) ||
                  u.contains("template"))
              )
                return;
              ((Q = !1), fc(o, d));
            ...
            case "frameset":
              if (!Q) return;
              if (
                ((d = u.elements[1]), !d || !(d instanceof j.HTMLBodyElement))
              )
                return;
            ...
            case "plaintext":
              ...
              return;
            case "button":
              if (u.inScope("button")) (S(I, "button"), h(n, i, o, x));
              else (Ee(), D(i, o), (Q = !1));
              return;
            case "a":
              var K = L.findElementByTag("a");
              if (K) (S(I, i), L.remove(K), u.removeElement(K));
            case "b":
            case "big":
            case "code":
            case "em":
            ...
            case "object":
              ...
              return;
            case "table":
              if (!F._quirks && u.inButtonScope("p")) S(I, "p");
              (D(i, o), (Q = !1), (h = Ne));
              return;
            case "area":
            case "br":
            ...
            case "optgroup":
            case "option":
              if (u.top instanceof j.HTMLOptionElement) S(I, "option");
              (Ee(), D(i, o));
              return;
            case "menuitem":
              if (G(u.top, "menuitem")) u.pop();
        ...
        case 3:
          switch (i) {
            ...
            case "form":
              ...
              return;
            case "p":
              if (!u.inButtonScope(i)) (S(pe, i, null), h(n, i, o, x));
            ...
            case "h6":
              ...
              (u.generateImpliedEndTags(),
                u.popElementType(j.HTMLHeadingElement));
              return;
            case "sarcasm":
              break;
            case "a":
    ...
    function Ne(n, i, o, x) {
      function d(A) {
        for (var R = 0, K = A.length; R < K; R++)
          if (A[R][0] === "type") return A[R][1].toLowerCase();
        return null;
      }
      switch (n) {
        case 1:
    ...
    function Xo(n, i, o, x) {
      if (n === Gt) {
        ...
        var d = wr.join("");
        if (((wr.length = 0), ma.test(d))) ((rt = !0), S(Gt, d), (rt = !1));
        else Ie(d);
        ((h = Pe), h(n, i, o, x));
      }
    }
    ...
    function bt(n, i, o, x) {
      function d() {
        if (
          !u.inTableScope("tbody") &&
          !u.inTableScope("thead") &&
          !u.inTableScope("tfoot")
        )
          return;
          ...
          switch (i) {
            case "optgroup":
              if (
                ...
                u.elements[u.elements.length - 2] instanceof
                  j.HTMLOptGroupElement
              )
                ze(I, "option");
      ...
      switch (n) {
        ...
        case 3:
          if (i === "frameset") {
            ...
            if ((u.pop(), !dt && !(u.top instanceof j.HTMLFrameSetElement)))
              h = Ko;
            return;
          }
          break;
    ...
    function Qo(n, i, o, x) {
      switch (n) {
        case 1:
          if (((i = i.replace($n, "")), i.length > 0)) S(n, i, o, x);
          return;
        case 4:
          F._appendChild(F.createComment(i));
          return;
    ...
    function ki(n, i, o, x) {
      ...
      switch (n) {
        ...
        case 2:
          ...
          if (
            ((b = u.elements.length === 1 && dt ? t : u.top),
            b.namespaceURI === N.MATHML)
          )
            xc(o);
      ...
      (Sr.testTokenizer = function (n, i, o, x) {
        ...
        if (
          ((re = function (A, R, K, le) {
            switch ((Dt(), A)) {
              case 1:
                if (d.length > 0 && d[d.length - 1][0] === "Character")
                  d[d.length - 1][1] += R;
...
ge.inlineLink = {
  filter: function (e, t) {
    return (
      t.linkStyle === "inlined" && e.nodeName === "A" && e.getAttribute("href")
    );
  },
  replacement: function (e, t) {
...
function Vf(e, t) {
  ...
  return (
    Ff({
      ...
      isBlock: li,
      isVoid: Vc,
      isPre: t.preformattedCode ? Gf : null,
    }),
    r
  );
}
