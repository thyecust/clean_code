...
var P = commonJS(function (q, pe) {
  ...
  p(
    ...
    `(?:${c[l.NONNUMERICIDENTIFIER]}|${c[l.NUMERICIDENTIFIER]})`,
  );
  p(
    "PRERELEASEIDENTIFIERLOOSE",
    `(?:${c[l.NONNUMERICIDENTIFIER]}|${c[l.NUMERICIDENTIFIERLOOSE]})`,
  );
  p(
    "PRERELEASE",
...
var L = commonJS(function (Ji, Ne) {
  ...
  class S {
    constructor(e, r) {
      ...
      if (e.length > Le)
        throw TypeError(`version is longer than ${Le} characters`);
      (X("SemVer", e, r),
        (this.options = r),
        (this.loose = !!r.loose),
        (this.includePrerelease = !!r.includePrerelease));
      let t = e.trim().match(r.loose ? V[H.LOOSE] : V[H.FULL]);
    ...
    compare(e) {
      if (
        (X("SemVer.compare", this.version, this.options, e), !(e instanceof S))
      ) {
    ...
    comparePre(e) {
      ...
      do {
        let t = this.prerelease[r],
          s = e.prerelease[r];
        if ((X("prerelease compare", r, t, s), t === void 0 && s === void 0))
          return 0;
    ...
    compareBuild(e) {
      ...
      do {
        let t = this.build[r],
          s = e.build[r];
        if ((X("build compare", r, t, s), t === void 0 && s === void 0))
          return 0;
        else if (s === void 0) return 1;
        else if (t === void 0) return -1;
        else if (t === s) continue;
    ...
    inc(e, r, t) {
      if (e.startsWith("pre")) {
        ...
        if (r) {
          let s = `-${r}`.match(
            this.options.loose ? V[H.PRERELEASELOOSE] : V[H.PRERELEASE],
          );
...
var cr = commonJS(function (An, or) {
  var as = L(),
    ...
    Es = (e, r) => {
      ...
      let t = null;
      if (!r.rtl)
        t = e.match(r.includePrerelease ? Y[W.COERCEFULL] : Y[W.COERCE]);
      else {
...
var T = commonJS(function (Tn, pr) {
  ...
  class D {
    constructor(e, r) {
      if (((r = ps(r)), e instanceof D))
        if (
          e.loose === !!r.loose &&
          e.includePrerelease === !!r.includePrerelease
        )
          return e;
        else return new D(e.raw, r);
      if (e instanceof ie)
        return (
          (this.raw = e.value),
          (this.set = [[e]]),
      ...
      if (this.set.length > 1) {
        let t = this.set[0];
        if (
          ((this.set = this.set.filter((s) => !fr(s[0]))),
          this.set.length === 0)
        )
          this.set = [t];
    ...
    parseRange(e) {
      ...
      if (i)
        o = o.filter(
          (E) => (
            m("loose invalid filter", E, this.options),
            !!E.match(O[N.COMPARATORLOOSE])
          ),
        );
      m("range list", o);
      let a = new Map(),
    ...
    intersects(e, r) {
      if (!(e instanceof D)) throw TypeError("a Range is required");
      return this.set.some(
        (t) =>
          hr(t, r) &&
          e.set.some(
            (s) =>
              hr(s, r) && t.every((i) => s.every((n) => i.intersects(n, r))),
          ),
      );
    }
    test(e) {
      ...
      for (let r = 0; r < this.set.length; r++)
        if (xs(this.set[r], e, this.options)) return !0;
      return !1;
    }
  }
  pr.exports = D;
  var hs = ur(),
    ...
    { FLAG_INCLUDE_PRERELEASE: Ls, FLAG_LOOSE: Ns } = v(),
    ...
    hr = (e, r) => {
      let t = !0,
        ...
        i = s.pop();
      while (t && s.length)
        ((t = s.every((n) => i.intersects(n, r))), (i = s.pop()));
      return t;
    },
    As = (e, r) => (
...
var G = commonJS(function (Sn, Nr) {
  ...
  class z {
    ...
    parse(e) {
      ...
      if (
        ((this.operator = t[1] !== void 0 ? t[1] : ""), this.operator === "=")
      )
        this.operator = "";
      if (!t[2]) this.semver = y;
    ...
    test(e) {
      if (
        (oe("Comparator.test", e, this.options.loose),
        this.semver === y || e === y)
      )
        return !0;
      if (typeof e === "string")
  ...
  var Br = T(),
    ...
    ai = (e, r, t) => {
      ...
      if (i && n) {
        ...
        else if (o === 0 && (i.operator !== ">=" || n.operator !== "<="))
          return null;
      }
      for (let f of s) {
        if (i && !j(f, String(i), t)) return null;
        if (n && !j(f, String(n), t)) return null;
        for (let rt of r) if (!j(f, String(rt), t)) return !1;
        return !0;
      }
      let a,
        u,
        ...
        E,
        R =
          n && !t.includePrerelease && n.semver.prerelease.length
            ? n.semver
            : !1,
        I =
      ...
      for (let f of r) {
        if (
          ...
          } else if (i.operator === ">=" && !j(i.semver, String(f), t))
            return !1;
        }
        if (n) {
          if (R) {
          ...
          } else if (n.operator === "<=" && !j(n.semver, String(f), t))
            return !1;
        }
