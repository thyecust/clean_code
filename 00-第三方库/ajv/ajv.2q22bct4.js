...
var Ne = w(function (Pr) {
  ...
  function Ai(e, t) {
    ...
    if (typeof t == "string" && t[0] === '"' && !(e instanceof fe))
      return `"${e}${t.slice(1)}`;
    return;
  }
  function Di(e, t) {
  ...
  Pr.safeStringify = Pe;
  function Ui(e) {
    return typeof e == "string" && Pr.IDENTIFIER.test(e)
      ? new K(`.${e}`)
      : Er`[${e}]`;
  }
  Pr.getProperty = Ui;
...
var Rt = w(function (kr) {
  ...
  class qr extends jt {
    constructor(e) {
      ...
      ((this._values = {}),
        (this._scope = e.scope),
        (this.opts = { ...e, _n: e.lines ? ra : M.nil }));
    }
    get() {
      return this._scope;
    }
    ...
    scopeCode(e = this._values, t, r) {
      return this._reduceValues(
        ...
        (s) => {
          if (s.value === void 0)
            throw Error(`CodeGen: name "${s}" has no value`);
          return s.value.code;
        },
        t,
        r,
...
var $c = w(function (A) {
  ...
  class Ct extends ee {
    ...
    optimizeNames(e, t) {
      if (this.lhs instanceof P.Name && !e[this.lhs.str] && !this.sideEffects)
        return;
...
`
    ...
    object(...e) {
      ...
      for (let [r, s] of e) {
        ...
        if ((t.push(r), r !== s || this.opts.es5))
          (t.push(":"), (0, P.addCodeArg)(t, s));
      }
    ...
    forIn(e, t, r, s = this.opts.es5 ? F.varKinds.var : F.varKinds.const) {
      if (this.opts.ownProperties)
        return this.forOf(e, P._`Object.keys(${t})`, r);
      let n = this._scope.toName(e);
  ...
  function he(e, t, r) {
    ...
    function n(o) {
      return (
        o instanceof P._Code &&
        o._items.some(
          (i) => i instanceof P.Name && t[i.str] === 1 && r[i.str] !== void 0,
        )
      );
    }
  }
  ...
  function Fr(e) {
    return (t, r) =>
      t === P.nil ? r : r === P.nil ? t : P._`${Tt(t)} ${e} ${Tt(r)}`;
  }
  function Tt(e) {
...
var Lp = w(function (Yr) {
  ...
  function Dt(e, t, r) {
    Object.keys(r).forEach((s) =>
      e.assign(q._`${t}${(0, q.getProperty)(s)}`, !0),
    );
  }
  Yr.setEvaluated = Dt;
  var Gr = {};
...
var qe = w(function (ns) {
  ...
  var O = $c(),
    ...
    T = K5();
  ns.keywordError = {
    message: ({ keyword: e }) => O.str`must pass "${e}" keyword validation`,
  };
  ns.keyword$DataError = {
    ...
    e.forRange("i", n, T.default.errors, (a) => {
      if (
        ...
        e.if(O._`${i}.instancePath === undefined`, () =>
          e.assign(
            O._`${i}.instancePath`,
            (0, O.strConcat)(T.default.instancePath, o.errorPath),
          ),
        ),
  ...
  function Wa({ errorPath: e }, { instancePath: t }) {
    ...
    return [
      T.default.instancePath,
      (0, O.strConcat)(T.default.instancePath, r),
    ];
  }
  function Ba(
  ...
  function Qa(e, { params: t, message: r }, s) {
    ...
    if (
      (s.push(
        [ie.keyword, n],
        [ie.params, typeof t == "function" ? t(e) : t || O._`{}`],
      ),
      c.messages)
    )
...
var ke = w(function ($s) {
  ...
  function wc(e, t) {
    let { gen: r, data: s, opts: n } = e,
      o = bc(t, n.coerceTypes),
      i =
        t.length > 0 &&
        !(
          o.length === 0 &&
          t.length === 1 &&
          (0, _c.schemaHasRulesForType)(e, t[0])
        );
    if (i) {
      let a = Ft(t, s, n.strictNumbers, me.Wrong);
      r.if(a, () => {
        if (o.length) Ec(e, t, o);
        else Lt(e);
      });
    }
    return i;
  }
  $s.coerceAndCheckDataType = wc;
  var gs = new Set(["string", "number", "integer", "boolean", "null"]);
  function bc(e, t) {
    return t
      ? e.filter((r) => gs.has(r) || (t === "array" && r === "array"))
      : [];
  }
  function Ec(e, t, r) {
    let { gen: s, data: n, opts: o } = e,
      i = s.let("dataType", E._`typeof ${n}`),
      a = s.let("coerced", E._`undefined`);
    if (o.coerceTypes === "array")
      s.if(
        E._`${i} == 'object' && Array.isArray(${n}) && ${n}.length == 1`,
        () =>
          s
            .assign(n, E._`${n}[0]`)
            .assign(i, E._`typeof ${n}`)
            .if(Ft(t, n, o.strictNumbers), () => s.assign(a, n)),
      );
    s.if(E._`${a} !== undefined`);
    for (let u of r)
      if (gs.has(u) || (u === "array" && o.coerceTypes === "array")) c(u);
    (s.else(),
      Lt(e),
      s.endIf(),
      s.if(E._`${a} !== undefined`, () => {
    ...
    function c(u) {
      switch (u) {
        case "string":
          s.elseIf(E._`${i} == "number" || ${i} == "boolean"`)
            .assign(a, E._`"" + ${n}`)
            .elseIf(E._`${n} === null`)
            .assign(a, E._`""`);
          return;
        ...
        case "integer":
          ...
          return;
        case "boolean":
          s.elseIf(E._`${n} === "false" || ${n} === 0 || ${n} === null`)
            .assign(a, !1)
            .elseIf(E._`${n} === "true" || ${n} === 1`)
            .assign(a, !0);
          return;
        case "null":
          (s.elseIf(E._`${n} === "" || ${n} === 0 || ${n} === false`),
            s.assign(a, null));
          return;
        case "array":
          s.elseIf(
            E._`${i} === "string" || ${i} === "number"
              || ${i} === "boolean" || ${n} === null`,
          ).assign(a, E._`[${n}]`);
      }
    }
  }
  function Sc({ gen: e, parentData: t, parentDataProperty: r }, s) {
    e.if(E._`${t} !== undefined`, () => e.assign(E._`${t}[${r}]`, s));
  }
  function Kt(e, t, r, s = me.Correct) {
    let n = s === me.Correct ? E.operators.EQ : E.operators.NEQ,
      o;
    switch (e) {
      case "null":
        return E._`${t} ${n} null`;
      case "array":
        o = E._`Array.isArray(${t})`;
        break;
      case "object":
        o = E._`${t} && typeof ${t} == "object" && !Array.isArray(${t})`;
        break;
      case "integer":
        o = i(E._`!(${t} % 1) && !isNaN(${t})`);
        break;
      case "number":
        ...
        break;
      default:
        return E._`typeof ${t} ${n} ${e}`;
    }
    return s === me.Correct ? o : (0, E.not)(o);
    function i(a = E.nil) {
      return (0, E.and)(
        E._`typeof ${t} == "number"`,
        a,
        r ? E._`isFinite(${t})` : E.nil,
      );
    }
  }
  $s.checkDataType = Kt;
  function Ft(e, t, r, s) {
    ...
    for (let i in o) n = (0, E.and)(n, Kt(i, t, r, s));
    return n;
  }
  $s.checkDataTypes = Ft;
  var Pc = {
    ...
    params: ({ schema: e, schemaValue: t }) =>
      typeof e == "string" ? E._`{type: ${e}}` : E._`{type: ${t}}`,
  };
  function Lt(e) {
    let t = Nc(e);
    (0, gc.reportError)(t, Pc);
  }
...
var Ss = w(function (bs) {
  ...
  function Tc(e, t) {
    ...
    if (t === "object" && r) for (let n in r) ws(e, n, r[n].default);
      ...
      s.forEach((n, o) => ws(e, o, n.default));
  }
  bs.assignDefaults = Tc;
  function ws(e, t, r) {
    let { gen: s, compositeRule: n, data: o, opts: i } = e;
    if (r === void 0) return;
    let a = ye._`${o}${(0, ye.getProperty)(t)}`;
    if (n) {
      (0, Ic.checkStrictMode)(e, `default is ignored for: ${a}`);
      return;
    }
...
var z = w(function (Os) {
  ...
  Os.checkReportMissingProp = Mc;
  function Ac({ gen: e, data: t, it: { opts: r } }, s, n) {
    return (0, j.or)(
      ...s.map((o) =>
        (0, j.and)(Jt(e, t, o, r.ownProperties), j._`${n} = ${o}`),
      ),
    );
  }
  Os.checkMissingProp = Ac;
  function Dc(e, t) {
    (e.setParams({ missingProperty: t }, !0), e.error());
  }
  Os.reportMissingProp = Dc;
  function Ps(e) {
    return e.scopeValue("func", {
  ...
  function Uc(
    ...
    if (i.opts.dynamicRef)
      d.push([re.default.dynamicAnchors, re.default.dynamicAnchors]);
    let _ = j._`${l}, ${r.object(...d)}`;
    return c !== j.nil ? j._`${a}.call(${c}, ${_})` : j._`${a}(${_})`;
  }
  Os.callValidateCode = Uc;
  var Kc = j._`new RegExp`;
  function Fc({ gen: e, it: { opts: t } }, r) {
    ...
    return e.scopeValue("pattern", {
      key: o.toString(),
      ref: o,
      code: j._`${n.code === "new RegExp" ? Kc : (0, Cc.useFunc)(e, n)}(${r}, ${s})`,
    });
  }
  Os.usePattern = Fc;
  function Lc(e) {
  ...
  function Hc(e) {
    ...
    if (r.some((c) => (0, Ht.alwaysValidSchema)(n, c)) && !n.opts.unevaluated)
      return;
    let i = t.let("valid", !1),
      a = t.name("_valid");
    (t.block(() =>
      r.forEach((c, u) => {
        let l = e.subschema(
          { keyword: s, schemaProp: u, compositeRule: !0 },
          a,
        );
        if ((t.assign(i, j._`${i} || ${a}`), !e.mergeValidEvaluated(l, a)))
          t.if((0, j.not)(i));
      }),
    ),
      e.result(
...
var Is = w(function (xs) {
  ...
  function au(e, t) {
    ...
    function f(y = t.async ? C._`await ` : C.nil) {
      let N = c.opts.passContext ? ae.default.this : ae.default.self,
        S = !(("compile" in t && !a) || t.schema === !1);
      s.assign(
        d,
        C._`${y}${(0, nu.callValidateCode)(e, l, N, S)}`,
        t.modifying,
      );
    }
    function h(y) {
  ...
  function ks(e) {
    ...
    t.if(s.parentData, () =>
      t.assign(r, C._`${s.parentData}[${s.parentDataProperty}]`),
    );
  }
  function cu(e, t) {
    let { gen: r } = e;
    r.if(
      ...
      () => {
        (r
          .assign(
            ae.default.vErrors,
            C._`${ae.default.vErrors} === null ? ${t} : ${ae.default.vErrors}.concat(${t})`,
          )
      ...
      for (var l in s) {
        ...
        if (Array.isArray(d)) {
          ...
          if (d && typeof d == "object")
            for (var m in d)
              st(e, t, r, d[m], n + "/" + l + "/" + vu(m), o, n, l, s, m);
    ...
    return (
      Eu(e, { allKeys: !0 }, (d, _, m, p) => {
        ...
        function y(S) {
          ...
          if (((S = _e(h ? k(h, S) : S)), c.has(S))) throw l(S);
          c.add(S);
          let b = this.refs[S];
          if (typeof b == "string") b = this.refs[b];
          if (typeof b == "object") u(d, b.schema, S);
          else if (S !== _e(f))
            if (S[0] === "#") (u(d, a[S], S), (a[S] = d));
            else this.refs[S] = f;
          return S;
        }
        function N(S) {
          if (typeof S == "string") {
            if (!ku.test(S)) throw Error(`invalid anchor "${S}"`);
            y.call(this, `#${S}`);
          }
        }
      }),
...
var int = w(function (an) {
  ...
  function Xs(
    ...
    if (n.code.es5)
      ...
      e.func(t, g._`${v.default.data}, ${Vu(n)}`, s.$async, () =>
        e.code(Js(r, n)).code(o),
      );
  }
  function Vu(e) {
      ...
      () => {
        if (
          (e.var(
            ...
            g._`${v.default.valCxt}.${v.default.instancePath}`,
          ),
          e.var(
            v.default.parentData,
            g._`${v.default.valCxt}.${v.default.parentData}`,
          ),
          e.var(
          ...
          e.var(
            v.default.rootData,
            g._`${v.default.valCxt}.${v.default.rootData}`,
          ),
          t.dynamicRef)
        )
          e.var(
            v.default.dynamicAnchors,
            g._`${v.default.valCxt}.${v.default.dynamicAnchors}`,
          );
      },
      () => {
        if (
  ...
  function Hu(e) {
    ...
    if (
      ...
      (0, X.schemaHasRulesButRef)(t, n.RULES)
    )
  ...
  function Ws(e, t, r, s) {
    ...
    if (
      o.$ref &&
      (c.ignoreKeywordsWithRef || !(0, X.schemaHasRulesButRef)(o, l))
    ) {
  ...
  function Yt(e, t) {
    ...
    ((t += ` at "${r}" (strictTypes)`),
      (0, X.checkStrictMode)(e, t, e.opts.strictTypes));
  }
  class Zt {
    constructor(e, t, r) {
      if (
        ...
        (this.schemaValue = (0, X.schemaRefOrVal)(
          e,
          this.schema,
          r,
          this.$data,
    ...
    fail$data(e) {
      ...
      this.fail(
        g._`${t} !== undefined && (${(0, g.or)(this.invalid$data(), e)})`,
      );
    }
    error(e, t, r) {
      if (t) {
    ...
    check$data(e = g.nil, t = g.nil) {
      ...
      if ((r.if((0, g.or)(g._`${s} === undefined`, t)), e !== g.nil))
        r.assign(e, !0);
      if (n.length || o.validateSchema) {
        if ((r.elseIf(this.invalid$data()), this.$dataError(), e !== g.nil))
          r.assign(e, !1);
      }
      r.else();
    }
    ...
    subschema(e, t) {
      ...
      ((0, Qt.extendSubschemaData)(r, this.it, e),
        (0, Qt.extendSubschemaMode)(r, e));
  ...
  class dn extends Error {
    constructor(e, t, r, s) {
      ...
      ((this.missingRef = (0, er.resolveUrl)(e, t, r)),
        (this.missingSchema = (0, er.normalizeId)(
          (0, er.getFullPath)(e, this.missingRef),
        )));
    }
  }
  fn.default = dn;
...
var Vkt = w(function (mn) {
  ...
  function rr(e) {
    ...
    if (e.$async)
      a = i.scopeValue("Error", {
        ref: ul.default,
        code: L._`require("ajv/dist/runtime/validation_error").default`,
      });
    ...
    let u = {
        ...
        topSchemaRef: i.scopeValue(
          ...
          this.opts.code.source === !0
            ? { ref: e.schema, code: (0, L.stringify)(e.schema) }
            : { ref: e.schema },
        ),
        validateName: c,
        ValidationError: a,
    ...
    try {
      ...
      let d = i.toString();
      if (
        ((l = `${i.scopeRefs(ce.default.scope)}return ${d}`),
  ...
  function ot(e, t) {
    ...
    if (typeof (i === null || i === void 0 ? void 0 : i.schema) !== "object")
      return;
  ...
  function tr(e, { baseId: t, schema: r, root: s }) {
    ...
    if (
      typeof r != "boolean" &&
      r.$ref &&
      !(0, pn.schemaHasRulesButRef)(r, this.RULES)
    ) {
...
var Tn = w(function (bm, ct) {
  ...
  function ue(e, t) {
    ...
    if (r.path !== void 0)
      if (!s.skipEscape) {
        if (((r.path = Zl(r.path)), r.scheme !== void 0))
...
var sIn = w(function (Y) {
  ...
  function vd(e) {
    ...
    return {
      strictSchema:
        (i = (o = e.strictSchema) !== null && o !== void 0 ? o : Se) !== null &&
        i !== void 0
          ? i
          : !0,
      strictNumbers:
        (c = (a = e.strictNumbers) !== null && a !== void 0 ? a : Se) !==
          null && c !== void 0
          ? c
          : !0,
      strictTypes:
        (l = (u = e.strictTypes) !== null && u !== void 0 ? u : Se) !== null &&
        l !== void 0
          ? l
          : "log",
      strictTuples:
        (_ = (d = e.strictTuples) !== null && d !== void 0 ? d : Se) !== null &&
        _ !== void 0
          ? _
          : "log",
      strictRequired:
        (p = (m = e.strictRequired) !== null && m !== void 0 ? m : Se) !==
          null && p !== void 0
          ? p
          : !1,
      code: e.code
        ? { ...e.code, optimize: wr, regExp: br }
        : { optimize: wr, regExp: br },
      ...
      inlineRefs: (S = e.inlineRefs) !== null && S !== void 0 ? S : !0,
      ...
      validateFormats:
        (B = e.validateFormats) !== null && B !== void 0 ? B : !0,
  ...
  class lt {
    ...
    compileAsync(e, t) {
      ...
      async function o(u) {
        try {
          ...
          return (
            i.call(this, l),
            await a.call(this, l.missingSchema),
            o.call(this, u)
          );
        }
      }
      function i({ missingSchema: u, missingRef: l }) {
        if (this.refs[u])
          throw Error(`AnySchema ${u} is loaded but ${l} cannot be resolved`);
      }
      async function a(u) {
    ...
    addKeyword(e, t) {
      ...
      if ((qd.call(this, r, t), !t))
        return ((0, lr.eachItem)(r, (n) => ur.call(this, n)), this);
      jd.call(this, t);
      let s = {
        ...t,
    ...
    errorsText(
      ...
      return e
        .map((s) => `${r}${s.instancePath} ${s.message}`)
        .reduce((s, n) => s + t + n);
    }
    $dataMetaSchema(e, t) {
  ...
  function ft(e, t, r, s) {
    ...
    function l() {
      ...
      (n.try(
        () => {
          if (
            (n.code(D._`await ${(0, Jn.callValidateCode)(e, t, u)}`), m(t), !i)
          )
            n.assign(p, !0);
        },
        (f) => {
          if (
            (n.if(D._`!(${f} instanceof ${o.ValidationError})`, () =>
              n.throw(f),
            ),
            _(f),
            !i)
    ...
    function _(p) {
      ...
      (n.assign(
        ve.default.vErrors,
        D._`${ve.default.vErrors} === null ? ${f} : ${ve.default.vErrors}.concat(${f})`,
      ),
    ...
    function m(p) {
      ...
      let h =
        (f = r === null || r === void 0 ? void 0 : r.validate) === null ||
        f === void 0
          ? void 0
          : f.evaluated;
      if (o.props !== !0)
        if (h && !h.dynamicProps) {
          if (h.props !== void 0)
            o.props = dt.mergeEvaluated.props(n, h.props, o.props);
        } else {
      ...
      if (o.items !== !0)
        if (h && !h.dynamicItems) {
          if (h.items !== void 0)
            o.items = dt.mergeEvaluated.items(n, h.items, o.items);
        } else {
  ...
  var pt = $c(),
    ...
    Ld = {
      message: ({ keyword: e, schemaCode: t }) =>
        pt.str`must be ${ht[e].okStr} ${t}`,
      params: ({ keyword: e, schemaCode: t }) =>
        pt._`{comparison: ${ht[e].okStr}, limit: ${t}}`,
    },
    Hd = {
    ...
    Wd = {
      ...
      code(e) {
        let { gen: t, data: r, schemaCode: s, it: n } = e,
          ...
          i = t.let("res"),
          a = o
            ? Ae._`Math.abs(Math.round(${i}) - ${i}) > 1e-${o}`
            : Ae._`${i} !== parseInt(${i})`;
  ...
  var Ve = z(),
    ...
    ff = {
      message: ({ params: { missingProperty: e } }) =>
        ze.str`must have required property '${e}'`,
      params: ({ params: { missingProperty: e } }) =>
        ze._`{missingProperty: ${e}}`,
    },
    pf = {
      keyword: "required",
      type: "object",
      ...
      code(e) {
        ...
        if (a.strictRequired) {
          ...
          for (let f of r)
            if (
              (m === null || m === void 0 ? void 0 : m[f]) === void 0 &&
              !p.has(f)
            ) {
        ...
        function l() {
          ...
          if (c || o) {
            ...
            (t.if((0, Ve.checkMissingProp)(e, r, m)),
              (0, Ve.reportMissingProp)(e, m),
              t.else());
        }
        function d() {
          t.forOf("prop", s, (m) => {
            (e.setParams({ missingProperty: m }),
              t.if((0, Ve.noPropertyInData)(t, n, m, a.ownProperties), () =>
                e.error(),
              ));
          });
        }
    ...
    bf = {
      ...
      code(e) {
        ...
        function l() {
          ...
          (e.setParams({ i: p, j: f }),
            t.assign(c, !0),
            t.if(R._`${p} > 1`, () => (d() ? _ : m)(p, f)));
        }
        function d() {
          return (
            u.length > 0 && !u.some((p) => p === "object" || p === "array")
          );
        }
        function _(p, f) {
          let h = t.name("item"),
            y = (0, dr.checkDataTypes)(
              u,
              h,
          ...
          t.for(R._`;${p}--;`, () => {
            if (
              (t.let(h, R._`${r}[${p}]`), t.if(y, R._`continue`), u.length > 1)
            )
    ...
    Rf = {
      ...
      code(e) {
        ...
        function d() {
          (t.assign(l, !1),
            t.forOf("v", o, (m) =>
              t.if(Ke._`${u()}(${r}, ${m})`, () => t.assign(l, !0).break()),
            ));
        }
        function _(m, p) {
          let f = n[p];
...
var hr = w(function (Oo) {
  ...
  var de = $c(),
    ...
    Gf = {
      message: ({ params: { len: e } }) =>
        de.str`must NOT have more than ${e} items`,
  ...
  function No(e, t) {
    ...
    if (s === !1)
      (e.setParams({ len: t.length }), e.pass(de._`${a} <= ${t.length}`));
    ...
    function c(u) {
      r.forRange("i", t.length, a, (l) => {
        if (
          (e.subschema(
            { keyword: o, dataProp: l, dataPropType: pr.Type.Num },
            u,
          ),
          !i.allErrors)
        )
...
var mr = w(function (xo) {
  ...
  function jo(e, t, r = e.schema) {
    ...
    r.forEach((d, _) => {
      ...
      (s.if(ko._`${u} > ${_}`, () =>
        e.subschema({ keyword: i, schemaProp: _, dataProp: _ }, c),
      ),
        e.ok(c));
    });
    function l(d) {
...
var Ao = w(function (Mo) {
  ...
  var Co = $c(),
    ...
    np = {
      message: ({ params: { len: e } }) =>
        Co.str`must NOT have more than ${e} items`,
  ...
  var U = $c(),
    ...
    ap = {
      ...
      params: ({ params: { min: e, max: t } }) =>
        t === void 0
          ? U._`{minContains: ${e}}`
          : U._`{minContains: ${e}, maxContains: ${t}}`,
    },
    cp = {
      keyword: "contains",
      type: "array",
      ...
      code(e) {
        ...
        function p(f) {
          if ((t.code(U._`${f}++`), a === void 0))
            t.if(U._`${f} >= ${i}`, () => t.assign(d, !0).break());
          else if (
            (t.if(U._`${f} > ${a}`, () => t.assign(d, !1).break()), i === 1)
          )
            t.assign(d, !0);
...
var S7t = w(function (Ko) {
  ...
  function zo(e, t = e.schema) {
    ...
    for (let i in t) {
      ...
      if (
        (e.setParams({ property: i, depsCount: a.length, deps: a.join(", ") }),
        n.allErrors)
      )
        r.if(c, () => {
...
var _r = w(function (Wo) {
  ...
  var gt = z(),
    ...
    vp = {
      ...
      params: ({ params: e }) =>
        G._`{additionalProperty: ${e.additionalProperty}}`,
    },
    wp = {
      ...
      code(e) {
        ...
        function _(h) {
          ...
          if (u.length > 8) {
            ...
            y = (0, G.or)(...u.map((N) => G._`${h} === ${N}`));
          else y = G.nil;
          if (l.length)
            y = (0, G.or)(
              y,
              ...l.map((N) => G._`${(0, gt.usePattern)(e, N)}.test(${h})`),
            );
          return (0, G.not)(y);
        }
        function m(h) {
        ...
        function p(h) {
          ...
          if (r === !1) {
            if ((e.setParams({ additionalProperty: h }), e.error(), !a))
              t.break();
            return;
          }
    ...
    Sp = {
      ...
      code(e) {
        ...
        if (
          ...
          Qo.default.code(
            new Ep.KeywordCxt(o, Qo.default, "additionalProperties"),
          );
        ...
        for (let d of a) {
          if (u(d)) l(d);
            ...
            if (
              (t.if((0, Bo.propertyInData)(t, n, d, o.opts.ownProperties)),
              l(d),
              !o.allErrors)
            )
              t.else().var(c, !0);
  ...
  var Zo = z(),
    ...
    Np = {
      ...
      code(e) {
        ...
        if (
          a.length === 0 ||
          (c.length === a.length && (!o.opts.unevaluated || o.props === !0))
        )
          return;
        ...
        function p(f) {
          t.forIn("key", s, (h) => {
            t.if(vt._`${(0, Zo.usePattern)(e, f)}.test(${h})`, () => {
              ...
              if (o.opts.unevaluated && d !== !0)
                t.assign(vt._`${d}[${h}]`, !0);
              else if (!y && !o.allErrors)
                t.if((0, vt.not)(l), () => t.break());
            });
          });
        }
      },
    ...
    Mp = {
      ...
      code(e) {
        ...
        function u() {
          o.forEach((l, d) => {
            let _;
            if ((0, Tp.alwaysValidSchema)(n, l)) t.var(c, !0);
            else
              _ = e.subschema(
            ...
            if (d > 0)
              t.if(wt._`${c} && ${i}`)
                ...
                .else();
            t.if(c, () => {
              if ((t.assign(i, !0), t.assign(a, d), _))
                e.mergeEvaluated(_, wt.Name);
            });
          });
        }
      },
  ...
  var Dp = Lp(),
    Vp = {
      ...
      code(e) {
        ...
        let n = t.name("valid");
        r.forEach((o, i) => {
          if ((0, Dp.alwaysValidSchema)(s, o)) return;
      ...
      code(e) {
        ...
        function u(l, d) {
          return () => {
            ...
            if ((t.assign(i, a), e.mergeValidEvaluated(_, i), d))
              t.assign(d, bt._`${l}`);
  ...
  var Hp = Lp(),
    Gp = {
      ...
      code({ keyword: e, parentSchema: t, it: r }) {
        if (t.if === void 0)
          (0, Hp.checkStrictMode)(r, `"${e}" without "if" is ignored`);
      },
    };
  yi.default = Gp;
});
      ...
      code(e, t) {
        ...
        function _() {
          ...
          (r.if(
            ...
            () =>
              r
                .assign(h, x._`${f}.type || "string"`)
                .assign(y, x._`${f}.validate`),
            () => r.assign(h, x._`"string"`).assign(y, f),
          ),
            e.fail$data((0, x.or)(N(), S())));
          function N() {
          ...
          function S() {
            let k = l.$async
                ? x._`(${f}.async ? await ${y}(${s}) : ${y}(${s}))`
                : x._`${y}(${s})`,
              b = x._`(typeof ${y} == "function" ? ${k} : ${y}.test(${s}))`;
            return x._`${y} && ${y} !== true && ${h} === ${t} && !${b}`;
          }
        }
        function m() {
          let p = d.formats[o];
            ...
            let J =
                b instanceof RegExp
                  ...
                  : c.code.formats
                    ...
                    : void 0,
              B = r.scopeValue("formats", { key: o, ref: b, code: J });
            if (typeof b == "object" && !(b instanceof RegExp))
              return [b.type || "string", b.validate, x._`${B}.validate`];
            return ["string", b, B];
          }
          function k() {
    ...
    qh = {
      ...
      code(e) {
        ...
        function l() {
          ...
          t.if(!1);
          for (let p in m)
            (t.elseIf(be._`${u} === ${p}`), t.assign(c, d(m[p])));
          (t.else(),
            e.error(!1, {
        ...
        function _() {
          ...
          for (let k = 0; k < i.length; k++) {
            let b = i[k];
            if (
              (b === null || b === void 0 ? void 0 : b.$ref) &&
              !(0, Nh.schemaHasRulesButRef)(b, o.self.RULES)
            ) {
              let B = b.$ref;
              if (
                ((b = xi.resolveRef.call(
                  o.self,
                  o.schemaEnv.root,
                  o.baseId,
                  B,
                )),
                b instanceof xi.SchemaEnv)
              )
                b = b.schema;
              if (b === void 0)
                throw new Ph.default(o.opts.uriResolver, o.baseId, B);
            }
            let J =
              (m = b === null || b === void 0 ? void 0 : b.properties) ===
                null || m === void 0
                ? void 0
                : m[a];
            if (typeof J != "object")
          ...
          function N(k, b) {
            if (k.const) S(k.const, b);
            else if (k.enum) for (let J of k.enum) S(J, b);
            else
              throw Error(
...
var Kkt = w(function (V, vr) {
  ...
  class Le extends xh.default {
    ...
    _addDefaultMetaSchema() {
      ...
      (this.addMetaSchema(e, Et, !1),
        (this.refs["http://json-schema.org/schema"] = Et));
    }
    defaultMeta() {
      return (this.opts.defaultMeta =
        super.defaultMeta() || (this.getSchema(Et) ? Et : void 0));
    }
  }
  V.Ajv = Le;
  vr.exports = V = Le;
