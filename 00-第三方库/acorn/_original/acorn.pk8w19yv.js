...
var fAe = w(function (ge, gt) {
  (function (g, Z) {
    typeof ge === "object" && typeof gt < "u"
      ? Z(ge)
    ...
    var Z = [
      ...
      yt = {
        5: ye,
        "5module": ye + " export import",
        6: ye + " const class extends export import super",
      },
      _t = /^in(stanceof)?$/,
      Ct = new RegExp("[" + Le + "]"),
      St = new RegExp("[" + Le + bt + "]");
    ...
    function L(e, t) {
      ...
      if (e < 97) return e === 95;
      if (e < 123) return !0;
      if (e <= 65535) return e >= 170 && Ct.test(String.fromCharCode(e));
      if (t === !1) return !1;
      return _e(e, Te);
    }
    function B(e, t) {
      ...
      if (e < 97) return e === 95;
      if (e < 123) return !0;
      if (e <= 65535) return e >= 170 && St.test(String.fromCharCode(e));
      if (t === !1) return !1;
      return _e(e, Te) || _e(e, Z);
    }
    var v = function (t, i) {
      if (i === void 0) i = {};
      ((this.label = t),
    ...
    function m(e, t) {
      if (t === void 0) t = {};
      return ((t.keyword = e), (ne[e] = new v(e, t)));
    }
    var a = {
        num: new v("num", I),
        regexp: new v("regexp", I),
        string: new v("string", I),
        name: new v("name", I),
        privateId: new v("privateId", I),
        eof: new v("eof"),
        ...
        _default: m("default", P),
        _do: m("do", { isLoop: !0, beforeExpr: !0 }),
        _else: m("else", P),
        _finally: m("finally"),
        _for: m("for", { isLoop: !0 }),
        _function: m("function", I),
        _if: m("if"),
        _return: m("return", P),
        _switch: m("switch"),
        _throw: m("throw", P),
    ...
    var Ce = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
      C = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g,
      Be = Object.prototype,
      { hasOwnProperty: kt, toString: wt } = Be,
      H =
        Object.hasOwn ||
        function (e, t) {
          return kt.call(e, t);
    ...
    function U(e) {
      return (
        Fe[e] || (Fe[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"))
      );
    }
    function D(e) {
    ...
    var J = function (t, i, s) {
      if (((this.start = i), (this.end = s), t.sourceFile !== null))
        this.source = t.sourceFile;
    };
    function Se(e, t) {
      for (var i = 1, s = 0; ;) {
        var r = Oe(e, s, t);
        if (r < 0) return new W(i, t - s);
        (++i, (s = r));
      }
    }
    var ue = {
    ...
    function It(e) {
      var t = {};
      for (var i in ue) t[i] = e && H(e, i) ? e[i] : ue[i];
      if (t.ecmaVersion === "latest") t.ecmaVersion = 1e8;
      else if (t.ecmaVersion == null) {
        if (!Me && typeof console === "object" && console.warn)
          ((Me = !0),
...
Defaulting to 2020, but this will stop working in the future.`));
      ...
      if (De(t.onComment)) t.onComment = Et(t, t.onComment);
      return t;
    }
    function Et(e, t) {
      return function (i, s, r, n, u, o) {
        var h = { type: i ? "Block" : "Line", value: s, start: r, end: n };
        if (e.locations) h.loc = new J(this, u, o);
        if (e.ranges) h.range = [r, n];
        t.push(h);
      };
    }
    var ee = 1,
    ...
    var ce = 0,
      ...
      _ = function (t, i, s) {
        ...
        if (t.allowReserved !== !0) {
          if (
            ((r = be[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3]),
            t.sourceType === "module")
          )
            r += " await";
        }
        ...
        if (
          ...
          (this.reservedWordsStrictBind = U(n + " " + be.strictBind)),
          (this.input = String(i)),
          (this.containsEsc = !1),
          s)
        )
...
`,
    ...
    ((_.prototype.parse = function () {
      ...
      (R.allowSuper.get = function () {
        var e = this.currentThisScope(),
          t = e.flags;
        return (t & oe) > 0 || this.options.allowSuperOutsideMethod;
      }),
      ...
      Object.defineProperties(_.prototype, R));
    var A = _.prototype,
      Pt = /^(?:'((?:\\[^]|[^'\\])*?)'|"((?:\\[^]|[^"\\])*?)")/;
    ...
    ((p.isLet = function (e) {
      ...
      if (L(s, !0)) {
        var r = i + 1;
        while (B((s = this.input.charCodeAt(r)), !0)) ++r;
        if (s === 92 || (s > 55295 && s < 56320)) return !0;
        var n = this.input.slice(i, r);
        if (!_t.test(n)) return !0;
      }
      return !1;
    }),
      ...
      (p.isUsingKeyword = function (e, t) {
        ...
        if (k.test(this.input.slice(this.pos, s))) return !1;
        if (e) {
          var r = s + 5,
            n;
          if (
            ...
            r === this.input.length ||
            B((n = this.input.charCodeAt(r))) ||
            (n > 55295 && n < 56320)
          )
            return !1;
          C.lastIndex = r;
          var u = C.exec(this.input);
          if (u && k.test(this.input.slice(r, r + u[0].length))) return !1;
        }
        if (t) {
          var o = s + 2,
            h;
          if (this.input.slice(s, o) === "of") {
            if (
              o === this.input.length ||
              (!B((h = this.input.charCodeAt(o))) && !(h > 55295 && h < 56320))
            )
              return !1;
          }
        }
      ...
      (p.parseStatement = function (e, t, i) {
        ...
        switch (s) {
          ...
          default:
            ...
            if (s === a.name && y.type === "Identifier" && this.eat(a.colon))
              return this.parseLabeledStatement(r, d, y, e);
            else return this.parseExpressionStatement(r, y);
        }
      }),
      (p.parseBreakContinueStatement = function (e, t) {
        var i = t === "break";
        if ((this.next(), this.eat(a.semi) || this.insertSemicolon()))
          e.label = null;
      ...
      (p.parseForStatement = function (e) {
        ...
        if (o) {
          ...
          if ((this.next(), o === "await using")) this.next();
          return (
            this.parseVar(h, !0, o),
        ...
        var l = this.containsEsc,
          ...
          S =
            t > -1
              ? this.parseExprSubscripts(d, "await")
              : this.parseExpression(!0, d);
        if (
          this.type === a._in ||
          ...
          if (t > -1) {
            ...
            e.await = !0;
          } else if (u && this.options.ecmaVersion >= 8) {
            if (
              S.start === y &&
              !l &&
              S.type === "Identifier" &&
      ...
      (p.parseFunctionStatement = function (e, t, i) {
        return (this.next(), this.parseFunction(e, ie | (i ? 0 : Pe), !1, t));
      }),
      ...
      (p.parseThrowStatement = function (e) {
        if (
          (this.next(), k.test(this.input.slice(this.lastTokEnd, this.start)))
        )
    ...
    ((p.parseCatchClauseParam = function () {
      var e = this.parseBindingAtom(),
        t = e.type === "Identifier";
      return (
        this.enterScope(t ? qe : 0),
        this.checkLValPattern(e, t ? He : F),
      ...
      (p.parseVar = function (e, t, i, s) {
        ...
        for (;;) {
          ...
          if ((this.parseVarId(r, i), this.eat(a.eq)))
      ...
      (p.parseVarId = function (e, t) {
        ((e.id =
          ...
          this.checkLValPattern(e.id, t === "var" ? Ie : F, !1));
      }));
    var ie = 1,
      Pe = 2,
      ze = 4;
    ((p.parseFunction = function (e, t, i, s, r) {
      if (
        ...
        if (this.type === a.star && t & Pe) this.unexpected();
        e.generator = this.eat(a.star);
      }
      if (this.options.ecmaVersion >= 8) e.async = !!s;
      if (t & ie) {
        if (
          ((e.id = t & ze && this.type !== a.name ? null : this.parseIdent()),
          e.id && !(t & Pe))
        )
      ...
      if (
        ...
        this.enterScope(Ae(e.async, e.generator)),
        !(t & ie))
      )
        ...
        while (this.type !== a.braceR) {
          ...
          if (u) {
            if (
              ...
              n = !0;
            } else if (u.key && u.key.type === "PrivateIdentifier" && Tt(s, u))
              this.raiseRecoverable(
                u.key.start,
      ...
      (p.parseClassElement = function (e) {
        ...
        if (this.eatContextual("static")) {
          ...
          if (this.isClassElementNameStart() || this.type === a.star) o = !0;
          else s = "static";
        }
        if (((i.static = o), !s && t >= 8 && this.eatContextual("async")))
          if (
        ...
        if (!s && !n && !r) {
          ...
          if (this.eatContextual("get") || this.eatContextual("set"))
            if (this.isClassElementNameStart()) u = h;
            else s = h;
        }
        if (s)
          ((i.computed = !1),
        ...
        if (t < 13 || this.type === a.parenL || u !== "method" || r || n) {
          var l = !i.static && le(i, "constructor"),
            d = l && e;
          if (l && u !== "method")
            this.raise(i.key.start, "Constructor can't have get/set modifier");
          ((i.kind = l ? "constructor" : u), this.parseClassMethod(i, r, n, d));
      ...
      (p.parseClassMethod = function (e, t, i, s) {
        ...
        } else if (e.static && le(e, "prototype"))
          this.raise(
            r.start,
      ...
      (p.parseClassStaticBlock = function (e) {
        e.body = [];
        var t = this.labels;
        ((this.labels = []), this.enterScope(G | oe));
        while (this.type !== a.braceR) {
      ...
      (p.parseClassId = function (e, t) {
        if (this.type === a.name) {
          if (((e.id = this.parseIdent()), t))
            this.checkLValSimple(e.id, F, !1);
        } else {
    ...
    ((p.parseExportAllDeclaration = function (e, t) {
      ...
      if ((this.expectContextual("from"), this.type !== a.string))
        this.unexpected();
      ...
      (p.parseExport = function (e, t) {
        ...
        if (this.shouldParseExportStatement()) {
          ...
          if (
            ...
            if (((e.source = null), this.options.ecmaVersion >= 16))
              e.attributes = [];
          }
          this.semicolon();
        }
      ...
      (p.parseExportDefaultDeclaration = function () {
        ...
        if (this.type === a._function || (e = this.isAsyncFunction())) {
          ...
          return this.parseFunction(t, ie | ze, !1, e);
      ...
      (p.checkExport = function (e, t, i) {
        ...
        if (H(e, t)) this.raiseRecoverable(i, "Duplicate export '" + t + "'");
        e[t] = !0;
      }),
      (p.checkPatternExport = function (e, t) {
        ...
        if (i === "Identifier") this.checkExport(e, t, t.start);
          ...
          for (var u = 0, o = t.elements; u < o.length; u += 1) {
            var h = o[u];
            if (h) this.checkPatternExport(e, h);
          }
      ...
      (p.parseExportSpecifiers = function (e) {
        ...
        while (!this.eat(a.braceR)) {
          if (!i) {
            if ((this.expect(a.comma), this.afterTrailingComma(a.braceR)))
              break;
          } else i = !1;
      ...
      (p.parseImport = function (e) {
        if ((this.next(), this.type === a.string))
          ((e.specifiers = Vt), (e.source = this.parseExprAtom()));
        else
      ...
      (p.parseImportSpecifiers = function () {
        var e = [],
          t = !0;
        if (this.type === a.name) {
          if ((e.push(this.parseImportDefaultSpecifier()), !this.eat(a.comma)))
            return e;
        }
        if (this.type === a.star)
    ...
    ((N.toAssignable = function (e, t, i) {
      ...
      (N.parseRestBinding = function () {
        var e = this.startNode();
        if (
          (this.next(), this.options.ecmaVersion === 6 && this.type !== a.name)
        )
          this.unexpected();
        return (
      ...
      (N.parseBindingList = function (e, t, i, s) {
        ...
        while (!this.eat(e)) {
          ...
          if (t && this.type === a.comma) r.push(null);
            ...
            if (
              (this.parseBindingListItem(u), r.push(u), this.type === a.comma)
            )
              this.raiseRecoverable(
                this.start,
                "Comma is not permitted after the rest element",
        ...
        switch (e.type) {
          case "Identifier":
            ...
            if (s) {
              ...
              if (t !== We) this.declareName(e.name, t, e.start);
            }
            break;
          case "ChainExpression":
            this.raiseRecoverable(
        ...
        switch (e.type) {
          ...
          case "ArrayPattern":
            for (var u = 0, o = e.elements; u < o.length; u += 1) {
              var h = o[u];
              if (h) this.checkLValInnerPattern(h, t, i);
            }
            break;
          default:
    ...
    ((K.initialContext = function () {
      ...
      (K.braceIsBlock = function (e) {
        ...
        if (t === b.f_expr || t === b.f_stat) return !0;
        if (e === a.colon && (t === b.b_stat || t === b.b_expr))
          return !t.isExpr;
        if (e === a._return || (e === a.name && this.exprAllowed))
          return k.test(this.input.slice(this.lastTokEnd, this.start));
        if (
          e === a._else ||
          e === a.semi ||
          e === a.eof ||
          ...
          return !0;
        if (e === a.braceL) return t === b.b_stat;
      ...
      (a.parenR.updateContext = a.braceR.updateContext =
        function () {
          ...
          if (e === b.b_stat && this.curContext().token === "function")
            e = this.context.pop();
      ...
      (a._function.updateContext = a._class.updateContext =
        function (e) {
          if (
            ...
            !(
              (e === a.colon || e === a.braceL) &&
              this.curContext() === b.b_stat
            )
          )
            this.context.push(b.f_expr);
          else this.context.push(b.f_stat);
          this.exprAllowed = !1;
        }),
      ...
      (a.backQuote.updateContext = function () {
        if (this.curContext() === b.q_tmpl) this.context.pop();
        else this.context.push(b.q_tmpl);
        this.exprAllowed = !1;
      }),
      (a.star.updateContext = function (e) {
        if (e === a._function) {
          var t = this.context.length - 1;
          if (this.context[t] === b.f_expr) this.context[t] = b.f_expr_gen;
          else this.context[t] = b.f_gen;
        }
        this.exprAllowed = !0;
      }),
    ...
    ((f.checkPropClash = function (e, t, i) {
      ...
      if (u) {
        var o;
        if (n === "init") o = (this.strict && u.init) || u.get || u.set;
        else o = u.init || u[n];
        if (o) this.raiseRecoverable(s.start, "Redefinition of property");
      ...
      (f.parseMaybeAssign = function (e, t, i) {
        ...
        if (this.type.isAssign) {
          ...
          if (((d.operator = this.value), this.type === a.eq))
            l = this.toAssignable(l, !1, t);
          if (!s) t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1;
          if (t.shorthandAssign >= l.start) t.shorthandAssign = -1;
          if (this.type === a.eq) this.checkLValPattern(l);
          else this.checkLValSimple(l);
          if (
            ((d.left = l),
            this.next(),
        ...
        if (n != null && (!r || this.type !== a._in)) {
          if (n > s) {
            ...
            var l = this.start,
              ...
              S = this.buildBinary(t, i, e, y, h, u || o);
            if (
            ...
            return this.parseExprOp(S, t, i, s, r);
          }
        }
        return e;
      }),
      ...
      (f.parseMaybeUnary = function (e, t, i, s) {
        ...
        if (this.isContextual("await") && this.canAwait)
          ...
          else if (this.strict && o.operator === "delete" && Ke(o.argument))
            this.raiseRecoverable(
              o.start,
              "Deleting local variable in strict mode",
            );
          else if (o.operator === "delete" && Ne(o.argument))
          ...
          if (
            ...
            this.unexpected();
          if (((u = this.parsePrivateIdent()), this.type !== a._in))
            this.unexpected();
        } else {
          if (
    ...
    function Ke(e) {
      return (
        e.type === "Identifier" ||
        (e.type === "ParenthesizedExpression" && Ke(e.expression))
      );
    }
    function Ne(e) {
      return (
        ...
        (e.type === "ChainExpression" && Ne(e.expression)) ||
        (e.type === "ParenthesizedExpression" && Ne(e.expression))
      );
    }
    ((f.parseExprSubscripts = function (e, t) {
        ...
        if (
          ...
          if (r && !h && this.shouldParseAsyncArrow()) {
            ...
            return (
              (this.yieldPos = S),
              (this.awaitPos = re),
              (this.awaitIdentPos = Q),
              this.parseSubscriptAsyncArrow(t, i, ve, u)
            );
          }
          (this.checkExpressionErrors(y, !0),
            (this.yieldPos = S || this.yieldPos),
            (this.awaitPos = re || this.awaitPos),
            (this.awaitIdentPos = Q || this.awaitIdentPos));
          var Y = this.startNodeAt(t, i);
          if (((Y.callee = e), (Y.arguments = ve), o)) Y.optional = h;
      ...
      (f.parseExprAtom = function (e, t, i) {
        ...
        switch (this.type) {
          ...
          case a.parenL:
            ...
            if (e) {
              if (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(y))
                e.parenthesizedAssign = d;
              if (e.parenthesizedBind < 0) e.parenthesizedBind = d;
            }
            return y;
          case a.bracketL:
            return (
      ...
      (f.parseExprImport = function (e) {
        ...
        if ((this.next(), this.type === a.parenL && !e))
        ...
        if (
          ...
          if (!this.eat(a.parenR))
            if ((this.expect(a.comma), !this.afterTrailingComma(a.parenR))) {
              if (
                ((e.options = this.parseMaybeAssign()), !this.eat(a.parenR))
              ) {
                if ((this.expect(a.comma), !this.afterTrailingComma(a.parenR)))
                  this.unexpected();
              }
      ...
      (f.parseParenAndDistinguishExpression = function (e, t) {
        ...
        if (this.options.ecmaVersion >= 6) {
          ...
          if (!h.length || d) this.unexpected(this.lastTokStart);
          if (Q) this.unexpected(Q);
          if (
            (this.checkExpressionErrors(y, !0),
            (this.yieldPos = S || this.yieldPos),
            (this.awaitPos = re || this.awaitPos),
            ...
            ((r = this.startNodeAt(u, o)),
              (r.expressions = h),
              this.finishNodeAt(r, "SequenceExpression", ve, Y));
          else r = h[0];
...
`,
      ...
      (f.parsePropertyValue = function (e, t, i, s, r, n, u, o) {
        ...
        if (this.eat(a.colon))
          ...
          if (
            ...
            e.key.name === "await" && !this.awaitIdentPos)
          )
            this.awaitIdentPos = r;
          if (t) e.value = this.parseMaybeDefault(r, n, this.copyNode(e.key));
          else if (this.type === a.eq && u) {
            if (u.shorthandAssign < 0) u.shorthandAssign = this.start;
      ...
      (f.initFunction = function (e) {
        if (((e.id = null), this.options.ecmaVersion >= 6))
      ...
      (f.parseMethod = function (e, t, i) {
        ...
        if ((this.initFunction(s), this.options.ecmaVersion >= 6))
          s.generator = e;
        ...
        return (
          ...
          (this.awaitPos = 0),
          (this.awaitIdentPos = 0),
          this.enterScope(Ae(t, s.generator) | oe | (i ? je : 0)),
          this.expect(a.parenL),
      ...
      (f.parseFunctionBody = function (e, t, i, s) {
        ...
        if (r)
          ...
          if (!n || o) {
            if (((u = this.strictDirective(this.end)), u && o))
              this.raiseRecoverable(
                e.start,
          ...
          var h = this.labels;
          if (((this.labels = []), u)) this.strict = !0;
          if (
            (this.checkParams(
              e,
      ...
      (f.checkParams = function (e, t) {
        ...
        for (var s = 0, r = e.params; s < r.length; s += 1) {
          var n = r[s];
          this.checkLValInnerPattern(n, Ie, t ? null : i);
        }
      }),
      (f.parseExprList = function (e, t, i, s) {
        ...
        while (!this.eat(e)) {
          ...
          var u = void 0;
          if (i && this.type === a.comma) u = null;
          else if (this.type === a.ellipsis) {
            if (
              ((u = this.parseSpread(s)),
              s && this.type === a.comma && s.trailingComma < 0)
            )
              s.trailingComma = this.start;
          } else u = this.parseMaybeAssign(!1, s);
          r.push(u);
        }
        return r;
      }),
      (f.checkUnreserved = function (e) {
        ...
        if (!(this.currentThisScope().flags & he) && s === "arguments")
          this.raiseRecoverable(
            t,
      ...
      (f.parseIdent = function (e) {
        ...
        if ((this.next(!!e), this.finishNode(t, "Identifier"), !e)) {
          if (
            (this.checkUnreserved(t), t.name === "await" && !this.awaitIdentPos)
          )
    ...
    ((q.enterScope = function (e) {
      ...
      (q.treatFunctionsAsVarInScope = function (e) {
        return e.flags & z || (!this.inModule && e.flags & ee);
      }),
      (q.declareName = function (e, t, i) {
        ...
        if (t === F) {
          ...
          if (this.treatFunctionsAsVar) s = u.lexical.indexOf(e) > -1;
          else s = u.lexical.indexOf(e) > -1 || u.var.indexOf(e) > -1;
          u.functions.push(e);
        } else
          for (var o = this.scopeStack.length - 1; o >= 0; --o) {
            ...
            if ((h.var.push(e), this.inModule && h.flags & ee))
              delete this.undefinedExports[e];
            if (h.flags & he) break;
          }
        if (s)
      ...
      (q.currentVarScope = function () {
        for (var e = this.scopeStack.length - 1; ; e--) {
          var t = this.scopeStack[e];
          if (t.flags & (he | te | G)) return t;
        }
      }),
      (q.currentThisScope = function () {
        for (var e = this.scopeStack.length - 1; ; e--) {
          var t = this.scopeStack[e];
          if (t.flags & (he | te | G) && !(t.flags & we)) return t;
        }
      }));
    ...
    var Ot =
      ...
      Xe = Ye + " Extended_Pictographic",
      Ze = Xe,
      Je = Ze + " EBase EComp EMod EPres ExtPict",
      $e = Je,
      Bt = $e,
      Dt = { 9: Ye, 10: Xe, 11: Ze, 12: Je, 13: $e, 14: Bt },
      Ft =
      ...
      Ut = rt + " " + Ot,
      qt = { 9: tt, 10: it, 11: st, 12: at, 13: rt, 14: Ut },
      nt = {};
    function jt(e) {
      var t = (nt[e] = {
        binary: U(Dt[e] + " " + et),
        binaryOfStrings: U(Mt[e]),
        nonBinary: { General_Category: U(et), Script: U(qt[e]) },
      });
    ...
    for (var Ve = 0, ut = [9, 10, 11, 12, 13, 14]; Ve < ut.length; Ve += 1) {
      var Gt = ut[Ve];
      jt(Gt);
    }
    var c = _.prototype,
    ...
    ((de.prototype.separatedFrom = function (t) {
      for (var i = this; i; i = i.parent)
        for (var s = t; s; s = s.parent)
          if (i.base === s.base && i !== s) return !0;
      return !1;
    }),
      (de.prototype.sibling = function () {
        return new de(this.parent, this.base);
      }));
    var O = function (t) {
      ((this.parser = t),
        (this.validFlags =
        ...
        (this.unicodeProperties =
          nt[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
        (this.source = ""),
        (this.flags = ""),
        (this.start = 0),
        (this.switchU = !1),
    ...
    ((O.prototype.reset = function (t, i, s) {
      var r = s.indexOf("v") !== -1,
        n = s.indexOf("u") !== -1;
      if (
        ((this.start = t | 0),
      ...
      (O.prototype.raise = function (t) {
        this.parser.raiseRecoverable(
          this.start,
          "Invalid regular expression: /" + this.source + "/: " + t,
        );
      }),
      (O.prototype.at = function (t, i) {
        if (i === void 0) i = !1;
        var s = this.source,
          r = s.length;
        if (t >= r) return -1;
      ...
      (O.prototype.nextIndex = function (t, i) {
        if (i === void 0) i = !1;
        var s = this.source,
          r = s.length;
        if (t >= r) return r;
      ...
      (O.prototype.lookahead = function (t) {
        if (t === void 0) t = !1;
      ...
      (O.prototype.eat = function (t, i) {
        if (i === void 0) i = !1;
        if (this.current(i) === t) return (this.advance(i), !0);
        return !1;
      }),
      (O.prototype.eatChars = function (t, i) {
        if (i === void 0) i = !1;
        var s = this.pos;
    ...
    ((c.validateRegExpPattern = function (e) {
      if (
        ...
        !e.switchN && this.options.ecmaVersion >= 9 && Ht(e.groupNames))
      )
      ...
      (c.regexp_disjunction = function (e) {
        ...
        if (t) e.branchID = new de(e.branchID, null);
              ...
              if (i || s) {
                ...
                if (s) {
                  ...
                  for (var o = 0; o < u.length; o++) {
                    var h = u.charAt(o);
                    if (u.indexOf(h, o + 1) > -1 || i.indexOf(h) > -1)
                      e.raise("Duplicate regular expression modifiers");
                  }
                }
              }
      ...
      (c.regexp_eatModifiers = function (e) {
        var t = "",
          i = 0;
        while ((i = e.current()) !== -1 && Wt(i)) ((t += D(i)), e.advance());
        return t;
      }));
    function Wt(e) {
    ...
    ((c.regexp_eatExtendedAtom = function (e) {
      ...
      (c.regexp_eatSyntaxCharacter = function (e) {
        var t = e.current();
        if (ot(t)) return ((e.lastIntValue = t), e.advance(), !0);
        return !1;
      }));
    function ot(e) {
      return (
    ...
    ((c.regexp_eatPatternCharacters = function (e) {
      var t = e.pos,
        i = 0;
      while ((i = e.current()) !== -1 && !ot(i)) e.advance();
      return e.pos !== t;
    }),
      ...
      (c.regexp_eatRegExpIdentifierName = function (e) {
        if (
          ...
          e.lastStringValue += D(e.lastIntValue);
      ...
      (c.regexp_eatRegExpIdentifierStart = function (e) {
        ...
        if (
          (e.advance(i),
          s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, i))
        )
          s = e.lastIntValue;
        if (zt(s)) return ((e.lastIntValue = s), !0);
        return ((e.pos = t), !1);
      }));
    function zt(e) {
    ...
    c.regexp_eatRegExpIdentifierPart = function (e) {
      ...
      if (
        ...
        s = e.lastIntValue;
      if (Kt(s)) return ((e.lastIntValue = s), !0);
      return ((e.pos = t), !1);
    };
    function Kt(e) {
    ...
    ((c.regexp_eatAtomEscape = function (e) {
      ...
      (c.regexp_eatControlLetter = function (e) {
        var t = e.current();
        if (ht(t)) return ((e.lastIntValue = t % 32), e.advance(), !0);
        return !1;
      }));
    function ht(e) {
    ...
    ((c.regexp_eatIdentityEscape = function (e) {
      ...
      if (t !== 99 && (!e.switchN || t !== 107))
        return ((e.lastIntValue = t), e.advance(), !0);
      return !1;
    }),
    ...
    c.regexp_eatCharacterClassEscape = function (e) {
      var t = e.current();
      if (Yt(t)) return ((e.lastIntValue = -1), e.advance(), M);
      var i = !1;
      if (
        e.switchU &&
        this.options.ecmaVersion >= 9 &&
        ...
        if (
          ...
          if (i && s === T) e.raise("Invalid property name");
          return s;
        }
    ...
    ((c.regexp_eatUnicodePropertyValueExpression = function (e) {
      ...
      if (this.regexp_eatUnicodePropertyName(e) && e.eat(61)) {
        ...
        if (this.regexp_eatUnicodePropertyValue(e)) {
          ...
          return (this.regexp_validateUnicodePropertyNameAndValue(e, i, s), M);
        }
      }
      ...
      (c.regexp_validateUnicodePropertyNameAndValue = function (e, t, i) {
        if (!H(e.unicodeProperties.nonBinary, t))
          e.raise("Invalid property name");
      ...
      (c.regexp_validateUnicodePropertyNameOrValue = function (e, t) {
        if (e.unicodeProperties.binary.test(t)) return M;
        if (e.switchV && e.unicodeProperties.binaryOfStrings.test(t)) return T;
        e.raise("Invalid property name");
      }),
      (c.regexp_eatUnicodePropertyName = function (e) {
        var t = 0;
        e.lastStringValue = "";
        while (pt((t = e.current())))
          ((e.lastStringValue += D(t)), e.advance());
    ...
    c.regexp_eatUnicodePropertyValue = function (e) {
      var t = 0;
      e.lastStringValue = "";
      while (Xt((t = e.current()))) ((e.lastStringValue += D(t)), e.advance());
      return e.lastStringValue !== "";
    };
    function Xt(e) {
      return pt(e) || xe(e);
    ...
    ((c.regexp_eatLoneUnicodePropertyNameOrValue = function (e) {
      ...
      (c.regexp_classContents = function (e) {
        if (e.current() === 93) return M;
        if (e.switchV) return this.regexp_classSetExpression(e);
        return (this.regexp_nonEmptyClassRanges(e), M);
      }),
      ...
      (c.regexp_eatClassAtom = function (e) {
        ...
        if (e.eat(92)) {
          ...
          if (e.switchU) {
            var i = e.current();
            if (i === 99 || dt(i)) e.raise("Invalid class escape");
            e.raise("Invalid escape");
          }
          e.pos = t;
        }
      ...
      (c.regexp_eatClassSetOperand = function (e) {
        if (this.regexp_eatClassSetCharacter(e)) return M;
        return (
      ...
      (c.regexp_classStringDisjunctionContents = function (e) {
        ...
        while (e.eat(124)) if (this.regexp_classString(e) === T) t = T;
        return t;
      }),
      ...
      (c.regexp_eatClassSetCharacter = function (e) {
        ...
        var i = e.current();
        if (i < 0 || (i === e.lookahead() && Zt(i))) return !1;
        if (Jt(i)) return !1;
    ...
    c.regexp_eatClassSetReservedPunctuator = function (e) {
      var t = e.current();
      if ($t(t)) return ((e.lastIntValue = t), e.advance(), !0);
      return !1;
    };
    function $t(e) {
      return (
    ...
    ((c.regexp_eatClassControlLetter = function (e) {
      var t = e.current();
      if (xe(t) || t === 95)
        return ((e.lastIntValue = t % 32), e.advance(), !0);
      return !1;
    }),
    ...
    ((c.regexp_eatLegacyOctalEscapeSequence = function (e) {
      ...
      (c.regexp_eatOctalDigit = function (e) {
        var t = e.current();
        if (dt(t)) return ((e.lastIntValue = t - 48), e.advance(), !0);
    ...
    if (
      ((x.next = function (e) {
        ...
        if (this.options.onToken) this.options.onToken(new me(this));
    ...
    ((x.nextToken = function () {
      ...
      (x.readToken = function (e) {
        if (L(e, this.options.ecmaVersion >= 6) || e === 92)
      ...
      (x.skipBlockComment = function () {
        ...
        if (((this.pos = i + 2), this.options.locations))
          for (var s = void 0, r = t; (s = Oe(this.input, r, this.pos)) > -1;)
      ...
      (x.skipLineComment = function (e) {
        ...
        while (this.pos < this.input.length && !j(s))
        ...
        e: while (this.pos < this.input.length) {
          ...
          switch (e) {
            ...
            default:
              if (
                (e > 8 && e < 14) ||
                (e >= 5760 && Ce.test(String.fromCharCode(e)))
              )
                ++this.pos;
              else break e;
          }
      ...
      (x.readToken_dot = function () {
        ...
        if (this.options.ecmaVersion >= 6 && e === 46 && t === 46)
          return ((this.pos += 3), this.finishToken(a.ellipsis));
      ...
      (x.readToken_eq_excl = function (e) {
        ...
        if (e === 61 && t === 62 && this.options.ecmaVersion >= 6)
          return ((this.pos += 2), this.finishToken(a.arrow));
      ...
      (x.readToken_numberSign = function () {
        ...
        if (e >= 13) {
          if (
            (++this.pos, (t = this.fullCharCodeAtPos()), L(t, !0) || t === 92)
          )
      ...
      (x.readRegexp = function () {
        ...
        for (;;) {
          ...
          if (k.test(s)) this.raise(i, "Unterminated regular expression");
          if (!e) {
            if (s === "[") t = !0;
            else if (s === "]" && t) t = !1;
            else if (s === "/" && !t) break;
      ...
      (x.readInt = function (e, t, i) {
        var s = this.options.ecmaVersion >= 12 && t === void 0,
          ...
          u = 0,
          o = 0;
        for (var h = 0, l = t == null ? 1 / 0 : t; h < l; ++h, ++this.pos) {
          ...
          if (d >= 97) y = d - 97 + 10;
          else if (d >= 65) y = d - 65 + 10;
          else if (d >= 48 && d <= 57) y = d - 48;
          else y = 1 / 0;
          if (y >= e) break;
          ((o = d), (u = u * e + y));
        }
    ...
    ((x.readRadixNumber = function (e) {
      ...
      else if (L(this.fullCharCodeAtPos()))
        this.raise(this.pos, "Identifier directly after number");
      return this.finishToken(a.num, i);
    }),
      (x.readNumber = function (e) {
        var t = this.pos;
        if (!e && this.readInt(10, void 0, !0) === null)
        ...
        if (!i && !e && this.options.ecmaVersion >= 11 && s === 110) {
          ...
          if ((++this.pos, L(this.fullCharCodeAtPos())))
            this.raise(this.pos, "Identifier directly after number");
        ...
        if ((s === 69 || s === 101) && !i) {
          if (((s = this.input.charCodeAt(++this.pos)), s === 43 || s === 45))
            ++this.pos;
          if (this.readInt(10) === null) this.raise(t, "Invalid number");
        }
        if (L(this.fullCharCodeAtPos()))
          this.raise(this.pos, "Identifier directly after number");
      ...
      (x.readString = function (e) {
        ...
        for (;;) {
          ...
          if (s === 92)
            ...
            if (j(s)) this.raise(this.start, "Unterminated string constant");
            ++this.pos;
          }
        }
        return (
    ...
    ((x.tryReadTemplateToken = function () {
      ...
      try {
        ...
        if (e === mt) this.readInvalidTemplateToken();
        else throw e;
      }
      this.inTemplateElement = !1;
    }),
      (x.invalidStringToken = function (e, t) {
        if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw mt;
        else this.raise(e, t);
      }),
        ...
        for (;;) {
          ...
          if (
            ...
            if (
              ...
              if (i === 36)
                return ((this.pos += 2), this.finishToken(a.dollarBraceL));
...
`;
      ...
      (x.readWord = function () {
        var e = this.readWord1(),
          t = a.name;
        if (this.keywords.test(e)) t = ne[e];
    ...
    ((g.Node = se),
      ...
      (g.defaultOptions = ue),
      (g.getLineInfo = Se),
      (g.isIdentifierChar = B),
      (g.isIdentifierStart = L),
      (g.isNewLine = j),
      (g.keywordTypes = ne),
      (g.lineBreak = k),
      (g.lineBreakG = Re),
      (g.nonASCIIwhitespace = Ce),
      (g.parse = ti),
      (g.parseExpressionAt = ii),
      (g.tokContexts = b),
      (g.tokTypes = a),
      (g.tokenizer = si),
      (g.version = vt));
