...
var Rb = commonJS(function (wr) {
  var cr = nu(),
    ...
    ur = (e) => (t, r) => async (s) => {
      let { response: n } = await t(s),
        ...
        [, a, o, c, u, h] = i ?? [];
      try {
        let f = await e.protocol.deserializeResponse(
          he(a, o, c, u, h),
          { ...e, ...r },
          n,
        );
  ...
  var dr = (e, t, r, s) =>
    S.assign(new Z(), { name: t, namespace: e, traits: r, valueSchema: s });
  class K extends S {
  ...
  class M {
    ...
    constructor(e, t) {
      ...
      while (ue(s))
        (r.push(s[1]), (s = s[0]), (n = Y(s)), (this._isMemberSchema = !0));
      if (r.length > 0) {
        this.memberTraits = {};
    ...
    static of(e) {
      ...
      if (ue(t)) {
        let [r, s] = t;
        if (r instanceof M)
          return (Object.assign(r.getMergedTraits(), U(s)), r);
        throw Error(
    ...
    getMemberSchema(e) {
      ...
      if (this.isStructSchema() && t[4].includes(e)) {
        let r = t[4].indexOf(e),
          s = t[5][r];
        return j(ue(s) ? s : [s, 0], e);
      }
      if (this.isDocumentSchema()) return j([15, 0], e);
      throw Error(
        `@smithy/core/schema - ${this.getName(!0)} has no no member=${e}.`,
      );
    }
    getMemberSchemas() {
      let e = {};
  ...
  var br = (e, t, r, s) =>
      S.assign(new k(), { name: t, namespace: e, traits: s, schemaRef: r }),
    gr = (e, t, r, s) =>
      S.assign(new k(), { name: t, namespace: e, traits: r, schemaRef: s }),
    Sr = {
      BLOB: 21,
      STREAMING_BLOB: 42,
      BOOLEAN: 2,
...
var Ge = commonJS(function (Qe) {
  ...
  function ns(e) {
    if (
      typeof ReadableStream === "function" &&
      (0, ts.isReadableStream)(e.source)
    )
...
var at = commonJS(function (ot) {
  ...
  var ds = importMetaRequire("stream"),
    ...
    ms = B();
  function ls(e, t, r) {
    if ((0, ms.isReadableStream)(e))
      return (0, C.createBufferedReadableStream)(e, t, r);
  ...
  class mt extends ws.Writable {
    ...
    _write(e, t, r) {
      if (
        ...
        ((this.buffers[this.buffers.length - 1] = n.subarray(
          0,
          n.byteLength - s,
        )),
          this.emit("finish"));
...
If you are using React Native, this API is not yet supported, see: https://react-native.canny.io/feature-requests/p/fetch-streaming-body`);
      ...
      return Object.assign(e, {
        ...
        transformToString: async (n) => {
          ...
          else if (n === void 0 || n === "utf8" || n === "utf-8")
            return (0, Os.toUtf8)(i);
...
var Pt = commonJS(function (It) {
  ...
  var Rt = importMetaRequire("stream"),
    ...
    Bt = B();
  async function Ds(e) {
    if ((0, Bt.isReadableStream)(e) || (0, Bt.isBlob)(e))
      return (0, As.splitStream)(e);
...
var w2e = commonJS(function (rr) {
  var Hs = z0n(),
    ...
    Ws = (e) => {
      ...
      if (typeof e === "number") {
        if (e === 0 || e === 1)
          W.warn(se(`Expected boolean, got ${typeof e}: ${e}`));
        if (e === 0) return !1;
        if (e === 1) return !0;
      }
      if (typeof e === "string") {
      ...
      if (typeof e === "string") {
        ...
        if (!Number.isNaN(t)) {
          if (String(t) !== String(e))
            W.warn(se(`Expected number but observed string: ${e}`));
          return t;
        }
      }
    ...
    Zs = (e) => {
      ...
      if (["boolean", "number", "bigint"].includes(typeof e))
        return (
          W.warn(se(`Expected string, got ${typeof e}: ${e}`)),
          String(e)
        );
    ...
    nn = Kt,
    on = (e) => {
      if (typeof e === "string") return pe(D(e));
      return pe(e);
    },
    z = (e) => {
...
`),
  ...
  var un = new RegExp(
    ...
    yn = (e) => {
      ...
      if (t) {
        let [r, s, n, i, a, o, c, u] = t;
        return H(z(A(i)), le(n), E(s, "day", 1, 31), {
          hours: a,
          minutes: o,
          seconds: c,
          fractionalMilliseconds: u,
      ...
      if (((t = pn.exec(e)), t)) {
        let [r, s, n, i, a, o, c, u] = t;
        return H(z(A(u)), le(s), E(n.trimLeft(), "day", 1, 31), {
          hours: i,
          minutes: a,
          seconds: o,
    ...
    E = (e, t, r, s) => {
      let n = Xt(A(e));
      if (n < r || n > s)
        throw TypeError(`${t} must be between ${r} and ${s}, inclusive`);
      return n;
    },
    _n = (e) => {
  ...
  I.from = (e) => {
    if (
      e &&
      typeof e === "object" &&
      (e instanceof I || "deserializeJSON" in e)
    )
      return e;
    else if (
      typeof e === "string" ||
  ...
  var Te = "(?:Mon|Tue|Wed|Thu|Fri|Sat|Sun)(?:[ne|u?r]?s?day)?",
    ...
    Nn = (e) => {
      ...
      if ((h.setUTCFullYear(Number(r)), u.toUpperCase() != "Z")) {
        ...
        h.setTime(
          h.getTime() +
            m * (Number(d) * 60 * 60 * 1000 + Number(l) * 60 * 1000),
        );
      }
      return h;
    },
  ...
  class ne {
    ...
    static [Symbol.hasInstance](e) {
      ...
      let t = e;
      return (
        ne.prototype.isPrototypeOf(e) ||
        (t.type === "bigDecimal" && Qt.test(t.string))
      );
    }
  }
  function qn(e) {
...
var Oke = commonJS(function (Ci) {
  ...
  class ae extends q {
    ...
    setHostPrefix(e, t, r) {
      ...
      if (n.endpoint) {
        let i = n.endpoint?.[0];
        if (typeof i === "string") {
          let a = [...s.structIterator()].filter(
            ([, o]) => o.getMergedTraits().hostLabel,
          );
          for (let [o] of a) {
            let c = r[o];
            if (typeof c !== "string")
              throw Error(
                `@smithy/core/schema - ${o} in input must be a string as hostLabel.`,
              );
            i = i.replace(`{${o}}`, c);
          }
      ...
      for (let [l, m] of c.structIterator()) {
        ...
        if (p.httpPayload) {
          ...
          if (d.path.includes(`{${l}+}`))
            d.path = d.path.replace(`{${l}+}`, R.split("/").map(Q).join("/"));
          else if (d.path.includes(`{${l}}`))
            d.path = d.path.replace(`{${l}}`, Q(R));
          delete s[l];
        } else if (p.httpHeader)
          (n.write(m, g),
            (a[p.httpHeader.toLowerCase()] = String(n.flush())),
            delete s[l]);
        else if (typeof p.httpPrefixHeaders === "string") {
          for (let [R, G] of Object.entries(g)) {
            let Be = p.httpPrefixHeaders + R;
            (n.write([m.getValueSchema(), { httpHeader: Be }], G),
              (a[Be.toLowerCase()] = n.flush()));
          }
          delete s[l];
        } else if (p.httpQuery || p.httpQueryParams)
          (this.serializeQuery(m, g, i), delete s[l]);
        else h = !0;
      }
      ...
      for (let [h, f] of c.structIterator()) {
        ...
        if (d.httpPayload) {
          if (((a = !1), f.isStreaming()))
            if (f.isStructSchema())
              i[h] = await this.deserializeEventStream({
                response: r,
                responseSchema: c,
              });
          ...
          if (m != null)
            if (f.isListSchema()) {
              ...
              let g;
              if (p.isTimestampSchema() && p.getSchema() === 4)
                g = x.splitEvery(m, ",", 2);
          ...
          for (let [l, m] of Object.entries(r.headers))
            if (l.startsWith(d.httpPrefixHeaders)) {
              let p = f.getValueSchema();
              ((p.getMergedTraits().httpHeader = l),
                (i[h][l.slice(d.httpPrefixHeaders.length)] = await o.read(
                  p,
                  m,
                )));
            }
  ...
  var ir = (e, t, r, s, n, i) => {
    if (t != null && t[r] !== void 0) {
      let a = s();
      if (a.length <= 0)
        throw Error("Empty value provided for input HTTP label: " + r + ".");
      e = e.replace(
        n,
        i
          ? a
  ...
  class $e extends q {
    ...
    read(e, t) {
      ...
      if (r.isListSchema())
        return x.splitHeader(t).map((s) => this.read(r.getValueSchema(), s));
      if (r.isBlobSchema())
        return (this.serdeContext?.base64Decoder ?? oe.fromBase64)(t);
  ...
  class or extends q {
    ...
    read(e, t) {
      ...
      if (s.httpHeader || s.httpResponseCode)
        return this.stringDeserializer.read(r, n(t));
      if (s.httpPayload) {
        if (r.isBlobSchema()) {
      ...
      switch (typeof t) {
        case "object":
          ...
          if (r.isBlobSchema() && "byteLength" in t) {
            this.stringBuffer = (
              this.serdeContext?.base64Encoder ?? oe.toBase64
            )(t);
            return;
          }
          if (r.isListSchema() && Array.isArray(t)) {
            ...
            for (let a of t) {
              ...
              let o = this.flush(),
                c = r.getValueSchema().isTimestampSchema()
                  ? o
                  : x.quoteHeader(o);
              if (i !== "") i += ", ";
              i += c;
        ...
        case "string":
          ...
          break;
        default:
          if (r.isIdempotencyToken())
            this.stringBuffer = x.generateIdempotencyToken();
