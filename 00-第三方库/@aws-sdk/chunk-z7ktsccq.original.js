...
var L = commonJS(function (H) {
  ...
  H.fileIntercept = {};
  var te = (e, t) => {
    if (H.fileIntercept[e] !== void 0) return H.fileIntercept[e];
    if (!H.filePromises[e] || t?.ignoreCache)
      H.filePromises[e] = (0, ee.readFile)(e, "utf8");
    return H.filePromises[e];
  };
  H.readFile = te;
});
  ...
  var f = m(),
      ...
      Object.entries(e)
        ...
        .reduce(
          (t, [r, o]) => {
            let n = r.indexOf(c),
              i =
                r.substring(0, n) === g.IniSectionType.PROFILE
                  ? r.substring(n + 1)
                  : r;
            return ((t[i] = o), t);
          },
    ...
    le = (e) =>
      Object.entries(e)
        ...
        .reduce(
          (t, [r, o]) => ({ ...t, [r.substring(r.indexOf(c) + 1)]: o }),
          {},
        ),
    ue = () => ({}),
    pe = async (e = {}) =>
