...
var Mie = commonJS(function (ae, D) {
  ...
  (function (s) {
    ...
    else if (typeof D === "object" && typeof ae === "object") s(v(g, v(ae)));
    else s(v(g));
    function v(b, P) {
      if (b !== g)
    ...
    ((R = function (e, t) {
      ...
      (C = function (e, t, r, n, a, o) {
        ...
        for (var f = r.length - 1; f >= 0; f--) {
          ...
          var h = (0, r[f])(
            u === "accessor" ? { get: _.get, set: _.set } : _[y],
            p,
          );
          if (u === "accessor") {
      ...
      (T = function (e, t) {
        ...
        var n = r.call(e),
          ...
          i;
        try {
          while ((t === void 0 || t-- > 0) && !(a = n.next()).done)
            o.push(a.value);
        } catch (u) {
          i = { error: u };
        } finally {
      ...
      (Q = function (e, t, r) {
        ...
        function c(f) {
          f.value instanceof j
            ? Promise.resolve(f.value.v).then(_, l)
            : O(o[0][2], f);
        }
        function _(f) {
          y("next", f);
        ...
        return (
          (b =
            ...
            function (t) {
              var r = [];
              for (var n in t)
                if (Object.prototype.hasOwnProperty.call(t, n)) r[r.length] = n;
              return r;
            }),
          b(e)
        );
    ...
    ((Y = function (e) {
      ...
      var t = {};
      if (e != null) {
        for (var r = b(e), n = 0; n < r.length; n++)
          if (r[n] !== "default") E(t, e, r[n]);
      }
      return (v(t, e), t);
    }),
      (Z = function (e) {
    ...
    ((re = function (e) {
      function t(o) {
        ((e.error = e.hasError
          ? new P(o, e.error, "An error was suppressed during disposal.")
          : o),
          (e.hasError = !0));
      }
      var r,
