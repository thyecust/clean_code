...
function renderOAuthCallbackPage(t) {
...
var f =
    getCurrentPlatform() === "windows" ? { min: 39152, max: 49151 } : { min: 49152, max: 65535 },
  p = 3118;
function buildOAuthCallbackUrl(t = p) {
...
async function pickOAuthCallbackPort(t) {
  let e = b();
  if (e) return e;
...
export { renderOAuthCallbackPage, getFirstParamValue, buildOAuthCallbackUrl, pickOAuthCallbackPort };
