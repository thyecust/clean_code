...
// Version: 2.1.263
var SUGGEST_CONNECTORS_TOOL_NAME = "SuggestConnectors",
  DESCRIPTION =
    "Resolve full connector payloads for directoryUuid values returned by SearchMcpRegistry.",
  PROMPT = `Resolve full connector payloads for a set of directoryUuid values returned by SearchMcpRegistry. Do NOT call this unless you already have directoryUuid values from a SearchMcpRegistry result \u2014 do not guess UUIDs or pass connector names.
...
export { SUGGEST_CONNECTORS_TOOL_NAME, DESCRIPTION, PROMPT };
