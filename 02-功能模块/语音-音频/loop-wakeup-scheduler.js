...
function F(e) {
  ...
  if (d > 0 && t * 1000 <= FIVE_MINUTES_MS) {
    let f = FIVE_MINUTES_MS - d;
...
function hasPendingLoopWakeup() {
  return kg().some((e) => e.kind === "loop");
}
function cancelAllLoopWakeups() {
...
export { getPendingLoopWakeup, isLoopKeepaliveEnabled, scheduleDynamicWakeup, armLoopKeepalive, markLoopStarted, stopLoopWakeups, hasPendingLoopWakeup, cancelAllLoopWakeups };
