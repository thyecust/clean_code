...
var U = ".git";
function createNestedRepositoryCheck(e) {
  let t = new Map(),
    n = (r) => {
      let o = t.get(r);
      if (o === void 0) {
...
var ae = ".gitignore",
  F = 1048576,
  le = 4 * DEFAULT_MAX_SYNC_FILES,
  NOTHING_WITHHELD = () => null;
function platformIgnoresCase(e) {
  return isOnCaseInsensitiveFs(e);
}
function ignoreMatcherFrom(e, { ignoreCase: t }) {
...
function rootIgnoreRefusalClause(e) {
  switch (e.reason) {
    case "unreadable":
    ...
    try {
      ...
      return Me(
        s
          ...
          .replace(/^\uFEFF/, "")
          .split(/\r?\n/),
        { foldsCase: platformIgnoresCase(e) },
      );
    } finally {
      await r.close();
    }
...
function Pe(e, t, n) {
  return (
    ...
    !(n ? isRefusedDirectoryPath(t) : isRefusedFilePath(t))
  );
}
...
function Be({ path: e, dirent: t }, n, r, o) {
  let s = segmentScopeSkip(t.name, n === "directory");
...
async function listFolderCandidates({
  ...
  withheldOf: n,
  signal: r,
  maxFiles: o = DEFAULT_MAX_SYNC_FILES,
  maxVisited: s = le,
}) {
  let i = [],
    l = [],
...
export { segmentScopeSkip, createNestedRepositoryCheck, NOTHING_WITHHELD, platformIgnoresCase, ignoreMatcherFrom, rootIgnoreRefusalClause, readRootIgnoreLines, listFolderCandidates };
