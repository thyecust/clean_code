...
function isNonOriginSource(e) {
  return e === "nonorigin_cf" || e === "nonorigin_other";
}
function describeNonOriginSource(e) {
  switch (e) {
    case "nonorigin_cf":
...
export { classifyResponseSource, isNonOriginSource, describeNonOriginSource, oauthHeaders, isCreateSessionFailure, createCodeSession, isCredentialsFailure, isCredentialsRejection, classifyElevatedAuthError, fetchRemoteCredentials, getCodeSession, updateCodeSession, archiveCodeSession, unarchiveCodeSession };
