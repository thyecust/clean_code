...
async function E(e, t, d, a, u) {
  ...
  let i = normalizeDurationMs(u.deadlineMs),
    o = {
...
function M(e) {
  try {
    if (isSenderBelowFloor(e)) return !1;
    return D(e) !== void 0;
  } catch {
    return !1;
  }
...
var SESSION_TRANSPORT_LIMITS = { maxRequestBytes: 4128768, defaultDeadlineMs: 58000 },
  x = 300000,
  q = 1e4;
function createSessionEventTransport(e) {
  let t = { stale: !1 },
    d = e.limits ?? SESSION_TRANSPORT_LIMITS;
  return {
    kind: "session",
    limits: d,
...
async function N(e, t, d, a, u, i, o) {
  ...
  let k = normalizeDurationMs(o.deadlineMs),
    y = r(),
    b = s.epoch(),
  ...
  try {
    _ = e.sender.sendServedCallRequest({
      ...
      accepts: (h) => {
        ...
        if (m && isSenderBelowFloor(h)) return ((g = h), !1);
        return !0;
      },
      signal: o.signal,
    });
...
function U(e) {
  ...
  return [e.structuredContent, e._meta]
    .filter(p)
    .map((d) => d[REMOTE_TOOL_EXECUTION_META_KEY])
    .find(p)?.call_id;
}
function T(e, t) {
  if (isSenderBelowFloor(e)) {
    let { [SENDER_BELOW_FLOOR_FLAG]: i, ...o } = e,
      r = T(o, t),
      s =
  ...
  return {
    ...
    envelope: u,
    elapsedMs: t,
    responseBytes: jsonByteLength(d),
    dirSync: getDirSyncPayload(d),
  };
}
async function W(e, t, d) {
  ...
  if (o.kind === "answered") {
    ...
    return (t.heard(a(), p(r) ? parseHostEpoch(r.epoch) : void 0), "answered");
  }
  switch (o.kind) {
    case "cancelled":
      return "cancelled";
...
function G(e) {
  ...
  return p(t) && parseHostEpoch(t.epoch) !== void 0;
}
function p(e) {
  return typeof e === "object" && e !== null && !Array.isArray(e);
}
export { getDirSyncPayload, SESSION_TRANSPORT_LIMITS, createSessionEventTransport };
