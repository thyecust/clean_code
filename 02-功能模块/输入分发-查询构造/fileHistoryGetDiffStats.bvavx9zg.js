...
export {
  Pgt as RewindNoFilesRestoredError,
  Ogt as copyFileHistoryForResume,
  xVe as fileHistoryCanRestore,
  iw as fileHistoryEnabled,
  QDe as fileHistoryGetDiffStats,
  AX as fileHistoryMakeSnapshot,
  HVe as fileHistoryRestoreStateFromLog,
  kVe as fileHistoryRewind,
  kTe as fileHistoryTrackEdit,
  EV as reduceFileHistoryState,
};
