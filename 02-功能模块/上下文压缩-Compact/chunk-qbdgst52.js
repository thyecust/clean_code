...
function _5t(t, e = process.argv) {
  return Ckn(t, e).at(-1);
}
function Ckn(t, e = process.argv) {
  let n = [];
...
function px(t, e = process.argv) {
  return y5t((n) => n === t, e) !== -1;
}
function Air(t = process.argv.slice(2)) {
  let e = px("-p", t) || px("--print", t),
    n = px("--init-only", t),
    o = y5t((s) => s.startsWith("--sdk-url"), t) !== -1;
  return e || n || o || !process.stdout.isTTY;
}
function y5t(t, e = process.argv) {
...
function Dvt(t = process.argv.slice(2)) {
...
function vir(t = process.argv.slice(2)) {
  return t.some(
    (e) =>
      !e.startsWith("-") || e === "--" || e === "--help" || /^-[^-]*h/.test(e),
  );
}
export { _5t, Ckn, px, Air, y5t, Dvt, Cir, vir };
