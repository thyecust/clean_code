...
import { getClaudeAiOrigin } from "../../01-核心基础设施/核心工具-未归类/self-hosted-runner-api.js";
...
Any extra args are passed to the underlying Claude Code session.`);
  ...
  if ((initializeFirstPartyEventLogging(n), isHoverRestEnabled() && n !== void 0)) {
    (initDefaultDebugLog({ storageV5: n }), watchGlobalConfigThroughStorage(n));
    let [
