...
function Aon(e) {
  return e ? { message: TNt, display: Ce } : { message: "", display: "" };
}
function uPe(e) {
...
function ENt(e, i, o = "live session", s = "delivery") {
  return ae(
    e,
...
function ANt(e, i = "live session", o = "delivery") {
  return ae(
    e,
  ...
  if (Mo()) {
    ...
    if (a === void 0) {
      if (
        ...
        r.then((d) => i7e(e, d, a7e(d.rows, i.sessions)));
      return { rows: [], unavailable: "timeout", truncated: !1 };
    }
    if (a.failed || (a.identityKey !== null && !rbt(a)))
      return (
        n(
