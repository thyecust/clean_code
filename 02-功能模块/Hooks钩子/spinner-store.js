...
var d = z;
function w(e, i) {
  return n_e(i, function (o) {
    return e[o];
  });
}
var C = w;
function B(e) {
  return e == null ? [] : C(e, yz(e));
}
var b = B;
function V(e) {
  return d(b(e));
...
function getSpinnerVerbs() {
  let i = getInitialSettings().spinnerVerbs;
  if (!i) return h;
...
function createSpinnerStore() {
  ...
  function i(n, g, { materialize: s = !0 } = {}) {
    e.setState((l) => {
      let c = n in l;
      if (!c && !s) return l;
      let S = l[n] ?? { ...m, defaultVerb: pickRandom(getSpinnerVerbs()) ?? "" },
        u = g(S);
      if (u === S && c) return l;
      return { ...l, [n]: u };
    });
  ...
  function o(n) {
    function g(t) {
      ...
      i(n, (a) =>
        a.mode === t
          ? a
          : { ...a, mode: t, thinkingStartedAt: t === "thinking" ? r : null },
      );
    }
    function s(t) {
    ...
    function c(t, r = null) {
      i(
        n,
        (a) =>
          a.turnEffort === t && a.turnModel === r
            ? a
            : { ...a, turnEffort: t, turnModel: r },
    ...
    function M() {
      let t = pickRandom(getSpinnerVerbs()) ?? "";
      i(n, (r) => ({
        ...r,
        overrideMessage: null,
        overrideColor: null,
...
var SpinnerStoreContext = Qt(null);
function useSpinnerStore() {
  let e = De(SpinnerStoreContext);
  if (!e)
...
function useSpinnerState(e) {
  let i = useSpinnerStore(),
    o = e ?? ze();
  return At(i.subscribe, () => i.getState()[o] ?? m);
}
function useSpinnerThinkingStartedAt(e) {
  let i = useSpinnerStore();
  return At(i.subscribe, () => (i.getState()[e] ?? m).thinkingStartedAt);
}
function useSpinnerRetryStatus(e) {
  let i = useSpinnerStore();
  return At(i.subscribe, () => (i.getState()[e] ?? m).retryStatus);
}
export { pickRandom, getSpinnerVerbs, createSpinnerStore, SpinnerStoreContext, useSpinnerStore, useSpinnerState, useSpinnerThinkingStartedAt, useSpinnerRetryStatus };
