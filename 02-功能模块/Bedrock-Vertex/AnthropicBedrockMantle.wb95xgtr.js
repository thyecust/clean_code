    ...
    import("../../01-核心基础设施/共享小工具-未细化/fromIni.7gtjb5bg.js")
      .then(({ fromNodeProviderChain: t }) =>
        t({
          ...
          clientConfig: {
            ...(e != null ? { logger: e } : {}),
            requestHandler: new j.FetchHttpHandler({
              requestInit: (r) => ({ ...r }),
            }),
          },
        }),
  ...
  M = (e, t) =>
    t.eventStreamMarshaller.deserialize(e, async (r) => {
      ...
      if (r.internalServerException != null)
        return {
          internalServerException: await ye(r.internalServerException, t),
        };
      if (r.modelStreamErrorException != null)
        return {
          modelStreamErrorException: await we(r.modelStreamErrorException, t),
        };
...
var L = (e) => new TextDecoder("utf-8").decode(e),
  ...
  Re = () => {
    let e = new jtt({ utf8Encoder: L, utf8Decoder: _ });
    return {
      ...
      streamCollector: z.streamCollector,
    };
  };
function G(e) {
  let t = e.body;
    ...
    for await (let a of n) {
      if (a.chunk && a.chunk.bytes) {
        let u = L(a.chunk.bytes),
          c = x(u);
        if (c === void 0)
          throw new gn(`Could not parse a Bedrock chunk into JSON: ${u}`);
...
`);
      ...
      if (i) {
        let u = JSON.stringify({
          type: "error",
          error: { type: "api_error", message: i.name },
        });
        yield _(`event: error
data: ${u}
...
`);
  ...
  (o.set("content-type", "text/event-stream; charset=utf-8"),
    o.delete("content-length"));
  let s = new Response(U(r()), {
    status: e.status,
...
var J = Symbol.for("brand.privateNullableHeaders");
function* xe(e) {
  if (!e) return;
  if (J in e) {
  ...
  ke = (e, t) => {
    let r = e
      ? e
          ...
          .filter(Boolean)
      : [];
    for (let o of t.split(",").map((s) => s.trim()))
      if (o && !r.includes(o)) r.push(o);
    return r.join(", ");
  },
  g = (e) => {
    let t = new Headers(),
    ...
    return { [J]: !0, values: t, nulls: r };
  };
function q(e) {
  return e.replace(/[^A-Za-z0-9\-._~!$&'()*+,;=:@]+/g, encodeURIComponent);
}
var V = Object.freeze(Object.create(null)),
  Oe = (e = q) =>
    function (r, ...o) {
              ...
              (typeof h === "object" &&
                h.toString ===
                  Object.getPrototypeOf(
                    Object.getPrototypeOf(h.hasOwnProperty ?? V) ?? V,
                  )?.toString))
          )
            ((y = h + ""),
              n.push({
...
${p}`);
  ...
  B = Oe(q);
var Y = { off: 0, error: 200, warn: 300, info: 400, debug: 500 };
function b() {}
function C(e, t, r) {
  if (!t || Y[e] > Y[r]) return b;
...
class te extends Eh {
  ...
  backendMiddleware() {
    return [
      async (e, t, r) => {
        let o = await t(await Q(this, T, "m", X).call(this, e, r.options));
        return Q(this, T, "m", ee).call(this, o);
      },
    ];
  }
}
((T = new WeakSet()),
  (X = async function (t, r) {
    let o = new URL(t.url),
    ...
    if (n) {
      ...
      if (i != null && !n.anthropic_beta)
        n.anthropic_beta = i.split(",").map((u) => u.trim());
    }
    if (r && Pe.has(r.path) && r.method === "post") {
      ...
      if (o.pathname.endsWith(i)) {
        if (!n)
          throw Error(
            `Expected request body to be a JSON object for post ${i}`,
          );
        let u = n.model;
        delete n.model;
        let c = n.stream;
        ...
        ((o.pathname =
          d +
          (c
            ? B`/model/${u}/invoke-with-response-stream`
            : B`/model/${u}/invoke`)),
    ...
    import("../../01-核心基础设施/共享小工具-未细化/fromIni.7gtjb5bg.js")
      .then(({ fromNodeProviderChain: r }) =>
        r({
          ...
          clientConfig: {
            ...(t != null ? { logger: t } : {}),
            requestHandler: new re.FetchHttpHandler({
              requestInit: (o) => ({ ...o }),
            }),
          },
        }),
...
class ie extends Eh {
  ...
  validateHeaders() {}
  backendMiddleware() {
    return [async (e, t) => t(await je(this, H, "m", ae).call(this, e))];
  }
}
((H = new WeakSet()),
  (ae = async function (t) {
