...
function isProbeWrittenTierDefault(t) {
  let r =
      t === "sonnet"
...
function d(t) {
  switch (t) {
    case "ANTHROPIC_DEFAULT_SONNET_MODEL":
      return a.ANTHROPIC_DEFAULT_SONNET_MODEL !== void 0 && !isProbeWrittenTierDefault("sonnet");
    case "ANTHROPIC_DEFAULT_OPUS_MODEL":
      return a.ANTHROPIC_DEFAULT_OPUS_MODEL !== void 0 && !isProbeWrittenTierDefault("opus");
...
function captureAdmin3PSteeringSnapshot() {
  gDn({
    sonnet: a.ANTHROPIC_DEFAULT_SONNET_MODEL !== void 0 && !isProbeWrittenTierDefault("sonnet"),
    opus: a.ANTHROPIC_DEFAULT_OPUS_MODEL !== void 0 && !isProbeWrittenTierDefault("opus"),
  });
}
...
export { isProbeWrittenTierDefault, TIER_LABELS, withProbeDeadline, captureAdmin3PSteeringSnapshot, apply3PDefaultFallbacks };
