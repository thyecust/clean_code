...
var Z = /^[a-z][a-z0-9_]{0,47}$/,
  J = 32;
var hIe = /^[A-Za-z0-9][A-Za-z0-9._-]{0,63}$/,
...
var yee = "__remote_tool_call",
  Pnn = "2.1",
  sM = "anthropic/remoteToolExecution",
  n2n = "claudecode/remoteToolCall",
  r2n = "claudecode/toolUseId",
  Me = 8192,
  we = 6,
  Wle = 8192,
  ue = 32,
...
var Ie = createLazyValue(() =>
  c({
    ...
    progress_misses: R(),
    reconcile_ms: R(),
    max_queue_ms: R(wlt.max_queue_ms.min),
    queue_depth: R(wlt.queue_depth.min),
    max_ask_ms: R(),
  }).transform(N),
);
function N(e) {
...
var Ge = createLazyValue(() =>
  Ko("outcome", [
    ...
    c({
      ...
      input: fe(s(), se()),
      message: s().max(Wle),
      decision_reason: s().max(Wle).optional(),
...
function a2n(e) {
  return { v: pE, op: "outcome_of", call_id: e };
}
var Ze = 1;
function Elt(e) {
  if (e === void 0) return { kind: "compatible", version: Ze };
  let o = e.filter((t) => Slt.includes(t));
  return o.length > 0
...
function l2n(e) {
  let o =
    "approval" in e && e.approval !== void 0
      ...
      : { ...e };
  return Alt(o, we) && e2(o) <= Me ? o : void 0;
}
var mSe = "withdrawn";
function Je(e) {
  let o = { [sM]: { ask_id: e.ask_id } };
  return e.decision === "deny" && e.feedback === mSe
...
function Alt(e, o) {
  ...
  return o >= 1 && t.every((r) => Alt(r, o - 1));
}
function en(e) {
  ...
  return {
    ...
    value:
      t?.feedback === void 0
        ? o.data
        : { ...o.data, approval: { ...t, feedback: fE(t.feedback) } },
  };
}
function nn(e) {
  let o = on(e);
...
function mn(e) {
  return {
    ...
    ...(e.description !== void 0 && { description: fE(e.description, ke) }),
...
function _n(e) {
  return {
    ...
    ...(e.description !== void 0 && { description: fE(e.description, xe) }),
...
function m2n(e) {
  ...
  return o.success && t !== ""
    ? { ...o.data, host: fE(o.data.host, g), name: t }
    : void 0;
}
function g2n({
  instanceId: e,
...
function h2n({ envelope: e, content: o }) {
  let t =
      e.outcome === "refused" ||
      e.outcome === "failed" ||
...
function Te(e) {
  let o = Pe(e.target),
    t = "notes" in e &&
      e.notes !== void 0 && { notes: e.notes.slice(0, ue).map((r) => fE(r)) };
  switch (e.outcome) {
    case "completed":
      return { ...e, target: o, ...t };
    case "refused":
    case "failed":
      return { ...e, target: o, message: fE(e.message), ...t };
    case "needs_approval": {
      let { auto_mode: r, ...i } = e;
      return {
        ...i,
        target: o,
        tool: fE(e.tool, K),
        message: fE(e.message),
        ...(e.decision_reason !== void 0 && {
          decision_reason: fE(e.decision_reason),
        }),
        ...(e.suggestions !== void 0 && {
          suggestions: e.suggestions.slice(0, me).map((d) => fE(d, _e)),
        }),
        ...nn(r),
        ...(e.elicitation !== void 0 && {
          elicitation: l({
            ...e.elicitation,
            message: fE(e.elicitation.message),
          }),
        }),
        ...(e.notes !== void 0 && {
          notes: e.notes.slice(0, ce).map((d) => fE(d, Ce)),
        }),
      };
    }
    case "acknowledged":
...
function kn(e) {
  ...
  return e.map((o) => {
    ...
    return {
      type: "text",
      text: `[${typeof i === "string" ? fE(l(i), g) : i === void 0 ? "unknown" : typeof i} content omitted]`,
    };
  });
}
function xn(e) {
