...
function Qje(n) {
  if (n.length > rJt || !Wc(n) || n.normalize("NFC") !== n) return null;
  let e = n.split("/");
  ...
  return t === oJt ? "rule" : t === sJt ? "output_style" : null;
}
function Eot(n) {
  return Qje(n) !== null;
}
...
export { Tot, zHt, Yje, RNn, rJt, oJt, sJt, Jje, iJt, Qje, Eot, VHt, aJt, kNn };
