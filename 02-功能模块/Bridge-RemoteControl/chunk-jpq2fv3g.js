...
function dsn(e, r) {
  if (r) return;
  return cdt(e) ? { kind: "human" } : void 0;
}
var N = new Set([
    "scheduled_trigger",
    "force_run_trigger",
...
function R(e, r) {
  return (r === void 0 && e !== void 0 && h.has(e)) || vce(e, r);
}
function udt(e, r, t) {
...
function r6n(e, r, t, a) {
  ...
  if (!r) return !0;
  return R(t, a) || dsn(t, a) !== void 0;
}
function ddt(e, r, t = !1) {
  let a;
  try {
    a = eqe(e);
  } catch {
  ...
  if (o !== void 0) return r === "bridge" ? vce(d, o) : VNt(o, t);
  return R(d, void 0) || (r === "remote-worker" && cdt(d));
}
function VNt(e, r = !1) {
...
function QGe(e, r, t, a, d, o) {
  ...
  if (!l && vce(r, t)) return { kind: "human" };
...
function s6n(e, r, t, a, d, o = !1, f = !1) {
  ...
  if (cdt(r)) return { kind: "human" };
  if (r?.startsWith("claude_code")) return;
  return QGe(e, r, t, a, void 0, d);
}
function Rce(e) {
...
function eqe(e) {
  ...
  let a = "uuid" in e && typeof e.uuid === "string" ? e.uuid : void 0,
    ...
    l = fsn(e),
    k,
    _ = Array.isArray(t) ? gsn(msn(q(t))) : KNt(t ?? "");
...
function vPe(e) {
  ...
  return e.match(new RegExp(`^<${mz} from="([^"]+)"`))?.[1];
}
function tqe(e) {
