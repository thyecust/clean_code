      ...
      (_, b) =>
        invokeMcpToolRaw(
          _,
          {
            name: r,
            arguments: { ...o, [yee]: s },
            _meta: { [r2n]: d.toolUseId, ...(m !== void 0 && { [n2n]: m }) },
          },
    ...
    hosts: [
      {
        ...
        protocol:
          N !== void 0
            ...
            : Elt(
                L?.protocol_versions ?? se ?? (s.length === 0 ? [pE] : void 0),
              ),
        transport: z(t, r),
      },
    ],
...
function QBn(t) {
  let e = t.toolState.get(E);
  if (e.synced && !e.lastListingFailed && Hnn(t) !== void 0) return "unlisted";
...
async function t2n(
  ...
  e,
  {
    deadlineMs: r = jDt.defaultDeadlineMs,
    sliceMs: o = M,
    routableOtherwise: s,
  } = {},
) {
...
function ze(t) {
  ...
  if (!UR(t.config.url)) return "not_ccr_proxy_url";
  if (!VZe(t.config.url)) return "not_devices_upstream";
...
export { JBn, gIe, QBn, ZBn, e2n, Hnn, t2n };
