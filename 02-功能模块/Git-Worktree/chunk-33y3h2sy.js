...
async function pt(e) {
  let {
    ...
    S = Ct(n),
    m = n.getAuthToken ? S : hrn(S, n.token),
    g = _rn(t, n);
  if (!g)
...
var Klt = "SHR_GIT_PROXY_TOKEN",
  mrn = ["-c", "lfs.locksverify=false"];
function grn(e) {
  ...
  try {
    ...
    let H =
        I.stderr !== void 0 && I.stderr.length > 0
          ...
          : Ne(Xlt(I.stdout || I.message || "", e.authURL, S)).slice(0, 2000),
