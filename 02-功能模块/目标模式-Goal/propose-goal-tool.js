...
// Version: 2.1.263
var PROPOSE_GOAL_TOOL_NAME = "ProposeGoal",
  PROPOSE_GOAL_MAX_CONDITION_CHARS = 500,
  PROPOSE_GOAL_TOOL_DESCRIPTION =
  ...
  PROPOSE_GOAL_TOOL_PROMPT = `Propose a completion condition for this session's work \u2014 a goal that keeps you working until a separate evaluator confirms it is met. Non-blocking: the proposal renders alongside your work, so keep working while it is handled.
...
export { PROPOSE_GOAL_TOOL_NAME, PROPOSE_GOAL_MAX_CONDITION_CHARS, PROPOSE_GOAL_TOOL_DESCRIPTION, PROPOSE_GOAL_TOOL_PROMPT };
