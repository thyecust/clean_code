...
function NIe(e, n, t) {
  return n === "project-approval" ? SLt(e) : (t ?? yLt(e));
}
function Hrn(e, n, t) {
  return n === "project-approval"
    ? new mi(SLt(e), "MCP server not approved for this project")
    : new mi(t ?? yLt(e), "MCP server blocked by enterprise managed policy");
}
function Hv(e) {
