...
function parseWorkflowScript(e, { validateBody: t = !0, maxBytes: n = MAX_WORKFLOW_SCRIPT_BYTES } = {}) {
  ...
  try {
    ...
    return {
      error: `meta must be a pure literal: ${s instanceof Error ? s.message : String(s)}`,
    };
  }
  let u = E(w);
...
function isValidWorkflowScript(e) {
  return !("error" in parseWorkflowScript(e));
}
var d = 80;
function R(e, t) {
...
function E(e) {
  ...
  let r = typeof e.title === "string" && e.title.length > 0 ? e.title : void 0,
    ...
    o = L(e.phases);
  return {
    meta: { name: t, description: n, title: r, whenToUse: i, phases: o },
  };
}
function L(e) {
...
export { parseWorkflowScript, isValidWorkflowScript };
