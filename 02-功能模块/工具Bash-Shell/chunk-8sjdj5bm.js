...
var V = Object.assign(Object.create(null), {
    ...
    "write-output": {
      ...
      additionalCommandIsDangerousCallback: gk,
    },
    "write-host": {
      safeFlags: [
        "-Object",
    ...
    "out-host": { allowAllFlags: !0, additionalCommandIsDangerousCallback: gk },
    "get-netadapter": {
      safeFlags: [
        "-Name",
...
function H$t(e) {
  let t = new Set(I$t(e).map((n) => n.stem));
...
function P$t(e, t) {
  ...
  for (let c of o) {
    ...
    for (let l = 1; l < c.commands.length; l++) {
      ...
      if (OOe(u.name) && u.args.length === 0) continue;
      if (!bwe(u, e)) return !1;
    }
...
function LOe(e, t, n = "full") {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    let g = Fv(RF(f)).toLowerCase().trim();
...
function bwe(e, t) {
      ...
      if (e.elementTypes[l] === "Parameter") {
        ...
        if (f !== null) {
          ...
          ((i ??= e.args.slice(0, l - 1)),
            i.push(u.slice(0, f.colonIdx), tw(Fv(f.postResolved))));
          continue;
        }
      }
      i?.push(u);
  ...
  if (r && DOe(e.args, e.elementTypes)) return !1;
  if (r && LOe(e.args, e.elementTypes)) return !1;
