...
import { ye, bb } from "../../01-核心基础设施/核心工具-路径与平台/核心工具-路径与平台.bt5mxc9p.js";
import { ly } from "./chunk-e4pfvp7x.js";
...
function rqe(e) {
  if (e !== null)
    ((ds().inbound.shuttingDown = !1),
      x(),
      (ds().inbound.modeAtUnwire = void 0));
  else {
    let o = ds().inbound.getCurrentMode;
    if (o !== null)
      try {
        ds().inbound.modeAtUnwire = o();
      } catch {
        ds().inbound.modeAtUnwire = void 0;
      }
  }
  if (((ds().inbound.getCurrentMode = e), e !== null)) qee("mode-changed");
}
function oqe(e) {
  ds().inbound.onPeerHeld = e;
}
function Csn(e) {
  ds().inbound.sendPeerReceipt = e;
}
function a6n(e, o) {
...
function sqe(e) {
  ...
  if (
    ...
    (xPe(), (o.unsubscribeAvailabilityRefresh = Ff(xPe)));
}
function xPe() {
  ds().inbound.publishAvailability?.(PPe() === void 0);
}
function vsn(e) {
  ds().inbound.recordCorrespondent = e;
}
var F = 750;
function x() {
  if (ds().inbound.shutdownSettleHandle === null)
    ds().inbound.shutdownSettleHandle = Et(iqe);
}
async function iqe() {
  let e = ds().inbound;
  if (
...
function aqe(e) {
  ds().inbound.onPeerHoldDropped = e;
}
function lqe(e) {
  ds().inbound.onPeerHoldReleased = e;
}
function cbe() {
  return I().value;
}
...
function A(e) {
  ...
  if (!o.admitted)
    return (
      ds().inbound.sendPeerReceipt?.(e, "dropped", {
        dropReason: o.reason,
        droppedMsgIds: [],
      }),
      !1
    );
  return (ds().inbound.recordCorrespondent?.(e), !0);
}
function R(e, o) {
  let s = ds().inbound;
  switch ((xPe(), o.policy)) {
...
function dqe({ ingressOrigin: e, inboundOrigin: o, envelopePeer: s = !1 }) {
...
function IPe(e) {
  switch (uqe(e)) {
    ...
    case "coordinator":
    case "host-injected":
      return cbe() === "refuse" ? "opt-out" : void 0;
    case "ungated":
      return;
  }
}
...
function DPe() {
  return ds().inbound.held.length;
}
function c6n() {
  return ds().inbound.shuttingDown;
}
function f(e) {
  let o =
