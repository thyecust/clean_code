...
function v(e) {
  return typeof e === "object" && e !== null && "subtype" in e
    ? e.subtype
    : void 0;
}
function routeCloudControlRequest(e, t) {
  ...
  return s === null
    ? {
        route: { kind: "reject", error: `${C(v(e))} ${f}` },
...
function w(e, t) {
  ...
  switch (e.subtype) {
    ...
    case "set_permission_mode":
      return t.strict && e.mode === "bypassPermissions"
        ? { kind: "reject", error: k }
        : n;
    case "set_model":
    ...
    case "stage_file":
      return {
        kind: "reject",
        error:
          "stage_file is sent to a cloud agent by the service, not by a host",
      };
...
function validateCloudInitializeOptions(e, t, s = O) {
  let n = hasNonEmptyArrayValues(e.hooks),
    ...
    p = x.filter(
      (i) => e[i] !== void 0 && !s.has(i) && !c.includes(i) && !M(i, e[i]),
    );
