    ...
    b =
      v !== void 0 && v.includes("@")
        ...
        : a.source.includes("@")
          ? a.source
          : (v ?? a.source);
  return b.includes("@") ? k.includes(b) : k.some((w) => ft(w, "@") === b);
}
F();
function Ol({
  inputValue: a,
  ...
  let { storageV5: K, credentials: se } = _e(),
    ...
    tt = async () => {
      ...
      try {
        ...
        let Mt = [];
        try {
          Mt = (await JB((await Ph(K, se)).errors, K)).installed;
        } catch (Lt) {
        ...
        let ae = ge(Je);
        if (
          (n(`marketplace add failed: ${l(ae)}`, { level: "error" }),
          R(ae.message),
          we(""),
          ze(!1),
          q)
      ...
      children: [
        r(o, {
          ...
          children: [
            e(o, {
              marginBottom: 1,
              children: e(t, { bold: !0, children: "Add Marketplace" }),
            }),
            r(o, {
              flexDirection: "column",
              children: [
                    ...
                    children: [
                      r(t, {
                        children: [
                          "claude.ai lists",
                          " ",
                          e(t, { bold: !0, children: wr(B.name) }),
                          " ",
                          "for your account:",
                        ],
                      }),
                      r(t, { children: [" ", wr(B.source)] }),
                      e(t, {
                        dimColor: !0,
...
function yh(lh) {
  return (
    n(`Failed to save plugin options: ${l(lh)}`, { level: "error" }),
...
function Ea(a, k) {
  n(`Failed to read saved plugin options (${a}): ${l(k)}`, { level: "error" });
}
function es(OC) {
  let LC = _(3),
...
function Lr(CP) {
  ...
  if (jn[0] !== cp)
    ((as = e(o, {
      marginBottom: 1,
      children: e(t, { bold: !0, children: cp }),
    })),
      (jn[0] = cp),
      (jn[1] = as));
  else as = jn[1];
  ...
  let us;
  if (jn[4] !== ls)
    ((us = e(t, { bold: !0, children: ls })), (jn[4] = ls), (jn[5] = us));
  else us = jn[5];
  let ds;
  if (jn[6] !== Nt.marketplaceName || jn[7] !== dp)
    ((ds =
      dp &&
      r(t, { dimColor: !0, children: ["from ", wr(Nt.marketplaceName)] })),
  ...
  if (jn[9] !== Nt.entry.version)
    ((ps =
      Nt.entry.version &&
      r(t, { dimColor: !0, children: ["Version: ", wr(Nt.entry.version)] })),
  ...
  let Wi;
  if (jn[40] !== vs)
    ((Wi = e(o, { flexDirection: "column", children: vs })),
      (jn[40] = vs),
      (jn[41] = Wi));
  else Wi = jn[41];
  let Mh;
  ...
  let Cs;
  if (jn[43] !== gp)
    ((Cs = e(o, { marginTop: 1, paddingLeft: gp, children: Mh })),
      (jn[43] = gp),
      (jn[44] = Cs));
  else Cs = jn[44];
  let $h;
...
function Gs(MP) {
  ...
  let _h;
  if (Nh[2] !== Es)
    ((_h = r(t, { dimColor: !0, children: ["Last updated: ", Es] })),
      (Nh[2] = Es),
      (Nh[3] = _h));
  else _h = Nh[3];
  return _h;
...
function Js(_P) {
  ...
  if (fi[5] !== zo.destination)
    ((_s = r(t, { children: ["  ", zo.destination] })),
      (fi[5] = zo.destination),
      (fi[6] = _s));
  else _s = fi[6];
  let Fs;
  if (fi[7] !== zo.hiddenCharactersWarning)
    ((Fs =
      ...
      r(t, { color: "error", children: ["  ", zo.hiddenCharactersWarning] })),
...
function Xs(FP) {
  ...
  if (Gi[1] !== Ro.source.command)
    ((Vs = e(o, {
      paddingLeft: 2,
      children: e(t, { children: Ro.source.command }),
    })),
  ...
  if (Gi[8] !== Ro.source.mode)
    ((Ks =
      Ro.source.mode === "link" &&
      P() === "windows" &&
      e(t, { color: "warning", children: y1e })),
      (Gi[8] = Ro.source.mode),
      (Gi[9] = Ks));
  else Ks = Gi[9];
  let Jh;
...
async function Kp({
  ...
  if (X === 0) {
    ...
    w(`\u2713 Installed ${q} ${x(q, "plugin")}.${we}${ze}`);
      ...
      async function kt() {
        try {
          ...
          if (b && !bt.some((me) => me.name === b)) {
            ...
            I(
              me
                ? `Couldn't load marketplace "${j0(b)}": ${me.error}`
                : `Marketplace "${j0(b)}" not found`,
            );
          } else if (w) {
            let me = null;
      ...
      async function $t(Dt) {
        ...
        try {
          ...
          try {
            ...
            if (ie) return;
            (n(`Failed to fetch install counts: ${l(bt)}`),
              Ot.sort((te, Ee) => te.entry.name.localeCompare(Ee.entry.name)));
          }
    ...
    if (K.length === 0)
      return r(o, {
        ...
        children: [
          e(o, {
            marginBottom: 1,
            children: e(t, { bold: !0, children: "Select marketplace" }),
          }),
    ...
    children: [
      ...
      yt.scrollPosition.canScrollDown &&
        e(o, {
          children: r(t, {
            dimColor: !0,
            children: [" ", L.arrowDown, " more below"],
          }),
        }),
      Q &&
        e(o, {
...
function Jp(lI) {
  ...
  if (yi[4] !== Eo.isEstimate)
    ((oc = Eo.isEstimate && e(t, { dimColor: !0, children: " (estimated)" })),
      (yi[4] = Eo.isEstimate),
      (yi[5] = oc));
  else oc = yi[5];
  let ic;
  if (yi[6] !== oc)
    ((ic = r(t, { bold: !0, children: ["Context cost", oc, ":"] })),
      (yi[6] = oc),
      (yi[7] = ic));
  else ic = yi[7];
  ...
  E(() => {
    ...
    async function ne() {
      try {
        ...
        let kt = ie.filter((te) => !te.isInstalled && !bd(te.pluginId));
        try {
          let te = await c0e(A);
          if (Ve) return;
          if ((tt(te), te))
          ...
          (n(`Failed to fetch install counts: ${l(te)}`),
        ...
        try {
          ...
          for (let me of kt) {
            ...
            if (me.marketplaceName !== ig) {
              ...
              if (!st || !yXe(me.marketplaceName, st)) continue;
            }
            let Ge = _0t(me.entry.name, me.entry.relevance);
            if (!Ge) continue;
            if (PBn(me.pluginId) > 0 && !w?.has(me.pluginId)) continue;
            let wt = await y0t(Ge, te);
            if (wt) $t.set(me.pluginId, wt);
          }
        } catch (te) {
          n(`Failed to compute plugin suggestions: ${l(te)}`);
        }
        if (Ve) return;
        xt($t);
        let Dt =
        ...
        if (R) {
          ...
          if (te)
            if (_Me(te.pluginId)) {
              let st = await cIe(te.pluginId, A),
  ...
  if (K.length === 0)
    return r(o, {
      ...
      children: [
        e(o, {
          marginBottom: 1,
          children: e(t, { bold: !0, children: "Discover plugins" }),
        }),
        yn &&
          e(o, {
            marginBottom: 1,
              ...
              r(o, {
                children: [
                  r(t, {
                    ...
                    children: [ke && !nt ? L.pointer : " ", " "],
                  }),
                  r(t, {
                    children: [
                      ie ? L.ellipsis : Oe ? L.radioOn : L.radioOff,
                      " ",
                      sd(Ve.entry),
                      r(t, {
                        dimColor: !0,
...
async function gc(a, k, v) {
  ...
  for (let X of I) {
    ...
    try {
      ...
      (n(`plugin eval: trigger test for ${X.file} threw: ${l(B)}`, {
        level: "error",
      }),
        q.push({
          query: X,
...
${L.tick} Evaluation passed`;
          ...
          let Uk = yc;
          ((process.exitCode = 2),
            n(`Plugin eval failed for ${jr}: ${l(Uk)}`, { level: "error" }),
            Vr(`${L.cross} ${l(Uk)}`));
        }
      };
      return (nm(), () => Fk.abort());
...
function wc({
    ...
    yt = async (ne) => {
      ...
      try {
        ...
        for (let Tt of Ce) {
          ...
          if (Tt.pendingUpdate) {
            try {
              ...
              ($t.push(Tt.name),
                n(`Marketplace ${Tt.name} could not be refreshed: ${l(nn)}`, {
                  level: "warn",
                }));
              continue;
            }
        ...
        if (Dt.size > 0) {
          ...
          if (Po.length > 0 || Tt.length > 0) lIt(Tt, Po, [], { announce: !1 });
          me = Po.flatMap((En) =>
        ...
        if (Ge.length > 0) {
          ...
          wo.push(
            `${Tt} command-sourced ${x(Tt, "plugin")} not updated here \u2014 ${rA("plugin update", Oo, { tail: Co, fallback: Po })}`,
          );
        }
        if (ie > 0) wo.push(`Removed ${ie} ${x(ie, "marketplace")}`);
        if (wo.length > 0) {
          let nn = `${iyt({ failedCount: $t.length + Ee, updatedCount: Oe + ie, policyRefusedCount: kt.length }) ?? L.warning} ${wo.join(", ")}`;
          if (ke) Mt(nn);
          else {
            if (!Wt.current) return;
            (b(nn),
  ...
  if (ze) return e(t, { children: "Loading marketplaces\u2026" });
  if (
    q.length === 0 &&
      ...
      children: [
        r(t, {
          ...
          children: [
            "Remove marketplace",
            " ",
            e(t, { italic: !0, children: wr(Be.name) }),
            "?",
          ],
        }),
        r(o, {
  ...
  if (nt === "details" && Be) {
    ...
    return r(o, {
      flexDirection: "column",
      children: [
        e(t, { bold: !0, children: wr(Be.name) }),
        e(t, { dimColor: !0, children: wr(Be.source) }),
        Be.note !== void 0 && e(t, { color: "warning", children: wr(Be.note) }),
        e(o, {
          marginTop: 1,
          children: r(t, {
            children: [
        ...
        ne &&
          r(o, {
            ...
            children: [
              ...
              Lt && e(t, { dimColor: !0, children: wr(Lt) }),
            ],
          }),
        !ne &&
          Re &&
                ...
                children: [
                  r(t, {
                    ...
                    children: [
                      r(t, {
                        "aria-hidden": !0,
                        children: [ke ? L.pointer : " ", " "],
                      }),
                      ne.pendingRemove ? L.cross : L.bullet,
                    ],
                  }),
                  r(o, {
                    flexDirection: "column",
                    ...
                    children: [
                      ...
                      e(t, { dimColor: !0, children: wr(ne.source) }),
                      ne.note !== void 0 &&
                        e(t, { color: "warning", children: wr(ne.note) }),
                      r(t, {
                        dimColor: !0,
                        children: [
              ...
              jm,
              {
                ...
                children: [
                  ...
                  r(o, {
                    ...
                    flexGrow: 1,
                    children: [
                      e(t, { bold: !0, children: wr(ne.name) }),
                      r(t, {
                        dimColor: !0,
                        children: [
                          wr(Gte(ne.source)),
    ...
    .map(({ name: A, config: Q, data: I }) => {
      ...
      if (Q.source.source === "claudeai") {
        ...
        X =
          ...
          (B > 0
            ? `${B} plugin ${x(B, "update")} available \xB7 update the marketplace to apply`
            : void 0);
      }
      return {
        name: A,
  ...
  if (Qo[23] !== hi || Qo[24] !== pn.moreAbove)
    ((Rc =
      ...
      e(o, {
        ...
        children: r(t, {
          dimColor: !0,
          children: [sv, " ", pn.moreAbove, " more above"],
        }),
      })),
      (Qo[23] = hi),
      (Qo[24] = pn.moreAbove),
  ...
  if (Qo[26] !== hi || Qo[27] !== pn.moreBelow)
    ((Ec =
      ...
      e(o, {
        ...
        children: r(t, {
          dimColor: !0,
          children: [Lw, " ", pn.moreBelow, " more below"],
        }),
      })),
      (Qo[26] = hi),
      (Qo[27] = pn.moreBelow),
...
function zr(LE) {
  ...
  let ob;
  if (Mc[7] !== $c)
    ((ob = r(o, { children: [nb, e(t, { color: "text", children: $c })] })),
      (Mc[7] = $c),
      (Mc[8] = ob));
  else ob = Mc[8];
  return ob;
...
function ub(a, k, v) {
  ...
  if (a.type === "pending")
    return r(t, {
      children: [
        e(t, { dimColor: !0, children: L.radioOff }),
        " connecting\u2026",
      ],
    });
...
function sye(bo) {
  ...
  let ab;
  if (Si[5] !== Tm) ((ab = Wf(Tm)), (Si[5] = Tm), (Si[6] = ab));
  else ab = Si[6];
  ...
  if (Si[7] === p)
    ((lb = e(ue, {
      ...
      (sb = e(t, { dimColor: !0, children: "Checking credentials\u2026" })),
      (Si[7] = lb),
      (Si[8] = sb));
  ...
  if (Si[13] !== Pm || Si[14] !== Dc)
    ((Bc = e(o, { flexDirection: "column", paddingX: Pm, children: Dc })),
      (Si[13] = Pm),
      (Si[14] = Dc),
      (Si[15] = Bc));
  else Bc = Si[15];
...
function Rm({
  ...
  let Xn = Wf(String(a.name)),
    ...
    Cn = re(() => {
      ...
      if (te) return (fe(NIe(a.name, te)), !0);
      return (fe(null), !1);
    ...
    ke = async () => {
      ...
      if (a.config) {
        ...
        if (!(xh(te) && ir() !== Ee)) await Oc().clearServerCache(a.name, te);
        (ze((me) => {
  ...
  if (B) {
    ...
    return r(o, {
      ...
      children: [
        ...
        r(o, { children: [e(yo, {}), e(t, { children: te })] }),
        xe &&
          r(o, {
            flexDirection: "column",
            children: [
    ...
    return r(o, {
      ...
      children: [
        ...
        r(o, {
          children: [
            e(yo, {}),
            e(t, { children: " Establishing connection to MCP server" }),
          ],
        }),
            ...
            ts(a.client) &&
              ...
              r(o, {
                children: [
                  ...
                  r(t, { dimColor: !0, children: [k, " ", x(k, "tool")] }),
                ],
              }),
            a.client.type === "connected" &&
  ...
  if (
    ...
    return r(de, {
      ...
      children: [
        r(t, {
          color: "text",
          children: ["Reconnecting to ", e(t, { bold: !0, children: a.name })],
        }),
        r(o, {
          children: [
            e(yo, {}),
            e(t, { children: " Restarting MCP server process" }),
          ],
        }),
        e(t, { dimColor: !0, children: "This may take a few moments." }),
      ],
...
function sWe(v$) {
  ...
  let Nc;
  if (Kn[13] !== Dm)
    ((Nc = Dm && e(t, { color: "success", children: " [read-only]" })),
      (Kn[13] = Dm),
      (Kn[14] = Nc));
  else Nc = Kn[14];
  let Lc;
  if (Kn[15] !== Bm)
    ((Lc = Bm && e(t, { color: "error", children: " [destructive]" })),
      (Kn[15] = Bm),
      (Kn[16] = Lc));
  else Lc = Kn[16];
  let _c;
  if (Kn[17] !== Am)
    ((_c = Am && e(t, { dimColor: !0, children: " [open-world]" })),
      (Kn[17] = Am),
      (Kn[18] = _c));
  else _c = Kn[18];
  let xb;
  ...
  let Fc;
  if (Kn[26] !== Qa)
    ((Fc = r(o, { children: [vb, e(t, { dimColor: !0, children: Qa })] })),
      (Kn[26] = Qa),
      (Kn[27] = Fc));
  else Fc = Kn[27];
  let wb;
  ...
  let Uc;
  if (Kn[29] !== Ft.name)
    ((Uc = r(o, { children: [wb, e(t, { dimColor: !0, children: Ft.name })] })),
      (Kn[29] = Ft.name),
      (Kn[30] = Uc));
  else Uc = Kn[30];
  let Vc;
    ...
    ((Vc =
      ...
      r(o, {
        ...
        children: [
          ...
          e(t, { wrap: "wrap", children: cd(Ga, Fm) }),
          Ga.length > TI &&
            r(t, {
              dimColor: !0,
              children: [
                  ...
                  lu,
                  {
                    children: [
                      ...
                      typeof vi === "object" &&
                        ...
                        r(t, {
                          dimColor: !0,
                          children: [" - ", cd(String(vi.description), Um)],
                        }),
                    ],
                  },
                  _m,
  ...
  if (Kn[35] !== Fc || Kn[36] !== Uc || Kn[37] !== Vc || Kn[38] !== jc)
    ((Xr = r(o, { flexDirection: "column", children: [Fc, Uc, Vc, jc] })),
      (Kn[35] = Fc),
      (Kn[36] = Uc),
      (Kn[37] = Vc),
      (Kn[38] = jc),
...
function iWe(q$) {
  ...
  if (wi[9] !== Ya || wi[10] !== Hc || wi[11] !== po.length)
    ((Ja =
      Ya > 0
        ? `${Hc} ${x(Hc, "tool")} \xB7 ${Ya} disabled by your organization`
        : `${po.length} ${x(po.length, "tool")}`),
      (wi[9] = Ya),
      (wi[10] = Hc),
      (wi[11] = po.length),
      (wi[12] = Ja));
...
async function Lb(a) {
  ...
  try {
    ...
    if (!k.ok) return (n(`Skill health fetch skipped: ${k.reason}`), null);
    if (k.status >= 400)
      return (n(`Skill health fetch skipped: status ${k.status}`), null);
    let v = k.data?.skills;
    ...
    return (n(`Skill health fetch skipped: ${k}`), null);
  }
}
function Gm() {
...
function Hb(a) {
  switch (a.type) {
    ...
    case "plugin-not-installed": {
      let v = Aa("plugin install", a.source, "--scope project");
      return v
  ...
  return r(
    o,
    {
      ...
      children: [
        e(o, {
          width: 32,
          children: r(t, { dimColor: !0, children: ["/", tg.name] }),
        }),
        r(t, { dimColor: !0, children: ["~", tg.approxTokens, " tok/turn"] }),
      ],
    },
    tg.name,
  );
  ...
  return r(
    o,
    {
      ...
      children: [
        e(o, {
          width: 32,
          children: r(t, { dimColor: !0, children: ["/", na.name] }),
        }),
        r(t, {
          dimColor: !0,
          children: [
...
function Qc(jD) {
  ...
  if (tr[7] !== Mo.manifest.name)
    ((nr = r(t, { bold: !0, children: [Mo.manifest.name, " \xB7 Usage"] })),
  ...
  if (tr[16] !== nr || tr[17] !== qc || tr[18] !== zc)
    ((Wb = r(o, { flexDirection: "column", gap: 1, children: [nr, qc, zc] })),
      (tr[16] = nr),
      (tr[17] = qc),
      (tr[18] = zc),
      (tr[19] = Wb));
...
function Jc(lB) {
  ...
  if (be.type === "plugin") {
    ...
    let jt;
    if ($e[23] !== vn)
      ((jt = r(t, { dimColor: vn, children: [" ", wn] })),
        ($e[23] = vn),
        ($e[24] = jt));
    else jt = $e[24];
    let rn;
    if ($e[25] !== be.marketplace)
      ((rn = r(t, { dimColor: !0, children: [" \xB7 ", be.marketplace] })),
        ($e[25] = be.marketplace),
        ($e[26] = rn));
    else rn = $e[26];
    const Ht = !lt;
    let Xt;
    if ($e[27] !== $o || $e[28] !== Ht)
      ((Xt = r(t, { dimColor: Ht, children: [" \xB7 ", $o, " "] })),
        ($e[27] = $o),
        ($e[28] = Ht),
        ($e[29] = Xt));
    else Xt = $e[29];
    ...
    let Zt;
    if ($e[30] !== Do || $e[31] !== Kt)
      ((Zt = e(t, { dimColor: Kt, children: Do })),
        ($e[30] = Do),
        ($e[31] = Kt),
        ($e[32] = Zt));
    else Zt = $e[32];
        ...
        be.activity && be.activity.skillCount > 0
          ? r(t, {
              ...
              children: [
                ...
                " ",
                x(be.activity.skillCount, "skill"),
                " \xB7",
                " ",
                be.activity.totalCount,
                " ",
                x(be.activity.totalCount, "use"),
              ],
            })
          : null),
        ($e[33] = be.activity),
    ...
    if (
      ...
      ((So = r(t, { children: [on, gn, jt, rn, Xt, Zt, In, Gn] })),
        ($e[37] = Xt),
        ($e[38] = Zt),
        ($e[39] = In),
        ($e[40] = Gn),
  ...
  if (be.type === "flagged-plugin") {
    ...
    if ($e[51] !== be.name || $e[52] !== mn)
      ((on = e(t, { color: mn, children: be.name })),
        ($e[51] = be.name),
        ($e[52] = mn),
        ($e[53] = on));
    else on = $e[53];
    ...
    let wn;
    if ($e[55] !== gn)
      ((wn = r(t, { dimColor: gn, children: [" ", vn] })),
        ($e[55] = gn),
        ($e[56] = wn));
    else wn = $e[56];
    let jt;
    if ($e[57] !== be.marketplace)
      ((jt = r(t, { dimColor: !0, children: [" \xB7 ", be.marketplace] })),
        ($e[57] = be.marketplace),
        ($e[58] = jt));
    else jt = $e[58];
    const rn = !lt;
    let Ht;
    if ($e[59] !== lg || $e[60] !== rn)
      ((Ht = r(t, { dimColor: rn, children: [" \xB7 ", lg, " "] })),
        ($e[59] = lg),
        ($e[60] = rn),
        ($e[61] = Ht));
    else Ht = $e[61];
    ...
    let Kt;
    if ($e[62] !== Xt)
      ((Kt = e(t, { dimColor: Xt, children: "removed" })),
        ($e[62] = Xt),
        ($e[63] = Kt));
    else Kt = $e[63];
    let Zt;
    if (
      ...
      ((Zt = r(t, { children: [on, wn, jt, Ht, Kt] })),
        ($e[64] = Kt),
        ($e[65] = on),
        ($e[66] = wn),
        ($e[67] = jt),
  ...
  if (be.type === "failed-plugin") {
    ...
    if ($e[77] !== be.name || $e[78] !== gn)
      ((vn = e(t, { color: gn, children: be.name })),
        ($e[77] = be.name),
        ($e[78] = gn),
        ($e[79] = vn));
    else vn = $e[79];
    ...
    let rn;
    if ($e[81] !== wn)
      ((rn = r(t, { dimColor: wn, children: [" ", jt] })),
        ($e[81] = wn),
        ($e[82] = rn));
    else rn = $e[82];
    let Ht;
    if ($e[83] !== be.marketplace)
      ((Ht = r(t, { dimColor: !0, children: [" \xB7 ", be.marketplace] })),
        ($e[83] = be.marketplace),
        ($e[84] = Ht));
    else Ht = $e[84];
    const Xt = !lt;
    let Kt;
    if ($e[85] !== sg || $e[86] !== Xt)
      ((Kt = r(t, { dimColor: Xt, children: [" \xB7 ", sg, " "] })),
        ($e[85] = sg),
        ($e[86] = Xt),
        ($e[87] = Kt));
    else Kt = $e[87];
    ...
    let In;
    if ($e[88] !== cg || $e[89] !== Zt)
      ((In = e(t, { dimColor: Zt, children: cg })),
        ($e[88] = cg),
        ($e[89] = Zt),
        ($e[90] = In));
    else In = $e[90];
    ...
    if (
      ...
      ((Gn = r(t, { children: [vn, rn, Ht, Kt, In] })),
        ($e[91] = Kt),
        ($e[92] = In),
        ($e[93] = vn),
        ($e[94] = rn),
  ...
  if (be.type === "skill") {
    ...
    let jt;
    if ($e[110] !== be.source)
      ((jt = r(t, { dimColor: !0, children: [" \xB7 ", be.source] })),
        ($e[110] = be.source),
        ($e[111] = jt));
    else jt = $e[111];
    const rn = !lt;
    ...
    if ($e[112] !== ug || $e[113] !== rn || $e[114] !== Ht)
      ((Xt = r(t, { dimColor: rn, children: [" ", "\xB7 ", Ht, ug, " "] })),
        ($e[112] = ug),
        ($e[113] = rn),
        ($e[114] = Ht),
        ($e[115] = Xt));
    ...
    if ($e[116] !== Bo.label || $e[117] !== Kt)
      ((Zt = e(t, { dimColor: Kt, children: Bo.label })),
        ($e[116] = Bo.label),
        ($e[117] = Kt),
        ($e[118] = Zt));
    else Zt = $e[118];
    ...
    if (
      ...
      ((So = r(t, { children: [on, wn, jt, Xt, Zt, In, Gn] })),
        ($e[123] = Xt),
        ($e[124] = Zt),
        ($e[125] = In),
        ($e[126] = Gn),
  ...
  if (be.indented) {
    ...
    if ($e[158] !== be.name || $e[159] !== on)
      ((gn = e(t, { color: on, children: be.name })),
        ($e[158] = be.name),
        ($e[159] = on),
        ($e[160] = gn));
    else gn = $e[160];
    ...
    if ($e[164] !== _n || $e[165] !== rn)
      ((Ht = r(t, { dimColor: rn, children: [" \xB7 ", _n, " "] })),
        ($e[164] = _n),
        ($e[165] = rn),
        ($e[166] = Ht));
    else Ht = $e[166];
    ...
    if ($e[167] !== Fn || $e[168] !== Xt)
      ((Kt = e(t, { dimColor: Xt, children: Fn })),
        ($e[167] = Fn),
        ($e[168] = Xt),
        ($e[169] = Kt));
    else Kt = $e[169];
    ...
    if ($e[170] !== oa || $e[171] !== lt)
      ((Zt = oa && e(t, { dimColor: !lt, children: " \xB7 managed" })),
        ($e[170] = oa),
        ($e[171] = lt),
        ($e[172] = Zt));
    else Zt = $e[172];
    ...
    if (
      ...
      ((In = r(t, { children: [mn, gn, jt, Ht, Kt, Zt] })),
        ($e[173] = Kt),
        ($e[174] = Zt),
        ($e[175] = mn),
        ($e[176] = gn),
  ...
  if ($e[183] !== be.name || $e[184] !== Ln)
    ((mn = e(t, { color: Ln, children: be.name })),
      ($e[183] = be.name),
      ($e[184] = Ln),
      ($e[185] = mn));
  else mn = $e[185];
  ...
  let vn;
  if ($e[187] !== on)
    ((vn = r(t, { dimColor: on, children: [" ", gn] })),
      ($e[187] = on),
      ($e[188] = vn));
  else vn = $e[188];
  const wn = !lt;
  ...
  if ($e[189] !== _n || $e[190] !== wn)
    ((jt = r(t, { dimColor: wn, children: [" \xB7 ", _n, " "] })),
      ($e[189] = _n),
      ($e[190] = wn),
      ($e[191] = jt));
  else jt = $e[191];
  ...
  if ($e[192] !== Fn || $e[193] !== rn)
    ((Ht = e(t, { dimColor: rn, children: Fn })),
      ($e[192] = Fn),
      ($e[193] = rn),
      ($e[194] = Ht));
  else Ht = $e[194];
  ...
  if ($e[195] !== oa || $e[196] !== lt)
    ((Xt = oa && e(t, { dimColor: !lt, children: " \xB7 managed" })),
      ($e[195] = oa),
      ($e[196] = lt),
      ($e[197] = Xt));
  else Xt = $e[197];
  ...
  if (
    ...
    ((Kt = r(t, { children: [mn, vn, jt, Ht, Xt] })),
      ($e[198] = Xt),
      ($e[199] = mn),
      ($e[200] = vn),
      ($e[201] = jt),
  ...
  if ((E(ax, lx), ru)) {
    ...
    if (ol[5] !== ru)
      ((ia = r(o, {
        flexDirection: "column",
        marginBottom: 1,
        children: [il, r(t, { dimColor: !0, children: ["Error: ", ru] })],
      })),
        (ol[5] = ru),
        (ol[6] = ia));
    else ia = ol[6];
...
function uu(QA) {
  ...
  if (rl[0] !== Xo.length || rl[1] !== wg)
    ((au = x(Xo.length, wg)), (rl[0] = Xo.length), (rl[1] = wg), (rl[2] = au));
  else au = rl[2];
  let su;
  if (rl[3] !== Ti || rl[4] !== Xo.length || rl[5] !== au)
    ((su = r(t, { bold: !0, color: Ti, children: [YA, " ", au, ":"] })),
      (rl[3] = Ti),
      (rl[4] = Xo.length),
      (rl[5] = au),
      (rl[6] = su));
      ...
      ((al = (Cg, JA) =>
        r(
          o,
          {
            ...
            marginLeft: 2,
            children: [
              e(t, { color: Ti, children: Cg.message }),
              Cg.guidance &&
                r(t, {
                  dimColor: !0,
                  italic: !0,
                  children: [L.arrowRight, " ", Cg.guidance],
                }),
            ],
          },
          JA,
  ...
  if (rl[12] !== su || rl[13] !== cu)
    ((al = r(o, { flexDirection: "column", children: [su, cu] })),
      (rl[12] = su),
      (rl[13] = cu),
      (rl[14] = al));
  else al = rl[14];
...
function pu({
    ...
    E(() => {
      ...
      if (w && T && !yn) {
        let { name: Z, marketplace: oe } =
            R !== void 0 ? { name: w, marketplace: void 0 } : Bn(fD(w)),
          le = R ?? oe,
          ce = le === void 0 ? void 0 : Yyn(le),
          He = ce ? Ut.filter((Qe) => Qe.name === ce) : Ut;
        for (let Qe of He) {
          let Ae = Qe.installedPlugins.find(
            (Ye) => $y(Ye.name, Z) || $y(Bn(Ye.source).name, Z),
          );
          if (Ae) {
  ...
  let xa = async (T) => {
      ...
      try {
        ...
        let gt =
          ...
          Ae = `${L.tick} ${gt} ${sd(pe.plugin)}${Qe}. Run /reload-plugins to apply.`;
        ...
        (ie(`Failed to ${T}: ${ce}`),
          n(`Failed to ${T} plugin: ${ce}`, { level: "error" }));
      }
    },
    ny = vr(xa);
  E(() => {
  ...
  let oy = re(async () => {
      ...
      if (Z.type === "plugin") {
        ...
        Ge(Z.client.name).catch((le) => {
          ie(YZ(le, Z.client.name, oe, { persistsOffBox: !1 }));
        });
    ...
    if (
      ...
      if (
        (ce.push({
          ...
          action: async () => {
            try {
              let Qe = await gx(Bn(T).name, pe.marketplace, I);
              if (Qe) {
                ie(Qe);
                return;
              }
        ...
        (async () => {
          try {
            ...
            (fu(I, j),
              En("disable", Z),
              Ot(
                `${L.tick} Disabled ${sd(pe.plugin)} in .claude/settings.local.json. Run /reload-plugins to apply.`,
              ));
          } catch (oe) {
            (ke(!1), ie(l(oe)));
          }
      ...
      (T.preventDefault(),
        ...
        (async () => {
          try {
            ...
            (fu(I, j),
              En("uninstall", Z),
              Ot(`${L.tick} ${ce}. Run /reload-plugins to apply.`));
          } catch (oe) {
            (ke(!1), ie(l(oe)));
          }
        })());
  ...
  if (yn) return e(t, { children: "Loading installed plugins\u2026" });
  if (Bt.length === 0)
    return r(o, {
      flexDirection: "column",
      children: [
        e(o, {
          marginBottom: 1,
          children: e(t, { bold: !0, children: "Manage plugins" }),
        }),
        kt &&
          e(o, {
            marginBottom: 1,
      ...
      children: [
        ...
        r(o, {
          ...
          children: [
            ...
            e(t, { color: "error", children: "Removed" }),
          ],
        }),
        r(o, {
          marginBottom: 1,
    ...
    return r(mr, {
      ...
      children: [
        ...
        r(o, {
          ...
          flexDirection: "column",
          children: [
            e(t, { children: "Delete it along with the plugin?" }),
  ...
  if (ae === "plugin-details" && pe) {
    ...
    return r(o, {
      ...
      children: [
        ...
        r(o, {
          children: [
            e(t, { dimColor: !0, children: "Scope: " }),
            e(t, { children: pe.scope || "user" }),
          ],
        }),
        Qe.version &&
          r(o, {
            children: [
              ...
              e(t, { children: Qe.version }),
            ],
          }),
        Qe.description &&
          e(o, {
            marginBottom: 1,
            children: e(t, { children: Qe.description }),
          }),
        Qe.author &&
          r(o, {
            children: [
              e(t, { dimColor: !0, children: "Author: " }),
              e(t, { children: Qe.author.name }),
            ],
          }),
        r(o, {
          marginBottom: 1,
          ...
          children: Sa.map((Ae, Ye) => {
            ...
            return r(
              jm,
              {
                active: ot,
                children: [
                  ot && r(t, { "aria-hidden": !0, children: [L.pointer, " "] }),
                  !ot && e(t, { "aria-hidden": !0, children: "  " }),
                  e(t, {
                    bold: ot,
  ...
  if (typeof ae === "object" && ae.type === "failed-plugin-details") {
    ...
    return r(o, {
      ...
      children: [
        r(t, {
          children: [
            e(t, { bold: !0, children: wr(T.name) }),
            r(t, { dimColor: !0, children: [" ", "@ ", wr(T.marketplace)] }),
            r(t, { dimColor: !0, children: [" (", T.scope, ")"] }),
          ],
        }),
        e(t, { color: "error", children: oe }),
        T.scope === "managed"
          ? e(o, {
              marginTop: 1,
              children: e(t, {
        ...
        Ul(T.marketplace) &&
          e(o, {
            marginTop: 1,
            children: e(t, { dimColor: !0, children: hx(T.marketplace) }),
          }),
        e(o, {
          marginTop: 1,
          children: e(t, {
  ...
  if (typeof ae === "object" && ae.type === "skill-detail") {
    ...
    return r(o, {
      ...
      gap: 1,
      children: [
        e(t, { bold: !0, children: T.name }),
        T.description && e(t, { dimColor: !0, children: T.description }),
        T.whenToUse &&
          r(t, { dimColor: !0, children: ["When to use: ", T.whenToUse] }),
        r(t, {
          dimColor: !0,
          children: [
            "Source: ",
        ...
        T.skillRoot &&
          r(t, { dimColor: !0, children: ["Path: ", T.skillRoot] }),
                      ...
                      return e(
                        iye.Item,
                        {
                          children: r(t, {
                            dimColor: ce,
                            children: [
                              le === T.override ? L.radioOn : L.radioOff,
                              " ",
                              le,
                              ce ? " (locked)" : "",
                            ],
        ...
        switch (T.kind) {
          ...
          case "scope-header":
            return e(
              ...
              {
                paddingLeft: 4,
                children: e(t, { dimColor: !0, children: mx(T.scope) }),
              },
              `scope:${oe}`,
            );
              ...
              jm,
              {
                ...
                children: r(t, {
                  ...
                  children: [
                    e(t, {
                      "aria-hidden": !0,
                      children: le ? `${L.pointer} ` : "  ",
                    }),
                    nn ? L.arrowDown : L.arrowRight,
                    " Show",
                    T.disabledCount > 0 &&
                      r(N, {
                        children: [
...
function kl(h0) {
  ...
  if (ra[4] !== Eg)
    ((wx = r(o, {
      ...
      children: [
        vx,
        e(o, { marginTop: 1, children: e(t, { dimColor: !0, children: Eg }) }),
      ],
    })),
      (ra[4] = Eg),
      (ra[5] = wx));
...
function Du(x0) {
  ...
  if (rr[17] !== hu || rr[18] !== ku || rr[19] !== bu || rr[20] !== xu)
    ((Px = r(o, { flexDirection: "column", children: [sl, hu, ku, bu, xu] })),
      (rr[17] = hu),
      (rr[18] = ku),
      (rr[19] = bu),
      (rr[20] = xu),
...
function Bu(v0) {
  ...
  let ul;
  if (Su[1] !== cl) {
    let { cells: C0, widths: Zo } = s3e(cl);
    const P0 = fF("skill", Zo.name);
    const T0 = fF("source", Zo.source);
    const I0 = xv("context", Zo.context);
    const R0 = xv("7d tokens", Zo.week);
    const Lg = Zo.uses + 1;
    let Tx;
    if (Su[3] !== Lg) ((Tx = xv("uses", Lg)), (Su[3] = Lg), (Su[4] = Tx));
    else Tx = Su[4];
    const _g = `  ${P0}  ${T0}  ${I0}  ${R0}  ${Tx}  last used`;
    let Ix;
    if (Su[5] !== _g)
      ((Ix = e(t, { dimColor: !0, children: _g })), (Su[5] = _g), (Su[6] = Ix));
    else Ix = Su[6];
    ul = r(o, {
      flexDirection: "column",
      children: [
        ...
        cl.map((dl, Rx) => {
          ...
          return r(
            t,
            {
              ...
              children: [
                `  ${fF(dl.name, Zo.name)}  `,
                e(t, { dimColor: !0, children: fF(dl.source, Zo.source) }),
                `  ${xv(Fg.context, Zo.context)}  ${xv(Fg.week, Zo.week)}  ${xv(String(dl.usageCount), Zo.uses)}\xD7  ${Fg.lastUsed}`,
              ],
            },
            `${Rx}:${dl.name}`,
          );
  ...
  if (
    ...
    if (sr[14] !== ar.length)
      ((fl =
        ...
        e(t, {
          color: "warning",
          wrap: "wrap",
          children: `${ar.length} ${x(ar.length, "skill")} loaded but never invoked. Each one adds to the system prompt every turn. Disable in /skills, or remove from .claude/skills.`,
        })),
        (sr[14] = ar.length),
        (sr[15] = fl));
    else fl = sr[15];
    if (sr[16] !== Ri.length)
      ((yl =
        ...
        e(t, {
          color: "warning",
          wrap: "wrap",
          children: `${Ri.length} ${x(Ri.length, "skill")} synced from claude.ai loaded but never invoked. Each one adds to the system prompt every turn. Disable in /skills, or turn ${Ri.length === 1 ? "it" : "them"} off on claude.ai \u2014 a deleted synced copy is re-downloaded on the next sync.`,
        })),
        (sr[16] = Ri.length),
        (sr[17] = yl));
    else yl = sr[17];
    Iu =
      ...
      e(t, {
        color: "warning",
        wrap: "wrap",
        children: `${aa.length} plugin ${x(aa.length, "skill")} loaded but never invoked, from ${Ex.join(", ")}. Each one adds to the system prompt every turn. Plugin skills can't be turned off individually \u2014 disable ${Ex.length === 1 ? "the plugin" : "those plugins"} in the Installed tab.`,
      });
    ((sr[0] = aa),
      (sr[1] = lr),
      (sr[2] = ar.length),
  ...
  if (sr[18] !== Cu || sr[19] !== ml || sr[20] !== pl.length)
    ((cr =
      ...
      e(t, {
        color: "warning",
        wrap: "wrap",
        children: `${pl.length} MCP ${x(pl.length, "skill")} loaded but never invoked${Cu}. Each one adds to the system prompt every turn. MCP skills live on the server, not on disk \u2014 turning ${ml ? "that server" : "those servers"} off in /mcp also removes ${ml ? "its" : "their"} tools.`,
      })),
      (sr[18] = Cu),
      (sr[19] = ml),
      (sr[20] = pl.length),
...
function Ou(D0) {
  ...
  let $u;
  if (hl[3] !== Mu)
    (($u = e(o, { flexDirection: "column", marginTop: 1, children: Mu })),
      (hl[3] = Mu),
      (hl[4] = $u));
  else $u = hl[4];
  let Dx;
      ...
      async function jg() {
        if (dr !== void 0) {
          Ei(
            dr === "--help" || dr === "-h"
              ? bl
              : `${L.cross} Unexpected argument "${dr}".
...
`),
        ...
        if (Uu) {
          (mo.push(
            `${L.tick} Dry run \u2014 would create tag ${qn.tag} at HEAD in ${qn.gitRoot}`,
...
`),
        ...
        (mo.push(`${L.tick} Created tag ${qn.tag}`),
          mo.push(
            Hg.pushed ? `${L.tick} Pushed to origin` : `  Push with: ${Ux}`,
          ),
          mo.push(
            "",
...
`;
            ...
            if (go.errors.length > 0)
              ((Et =
                Et +
                `${L.cross} Found ${go.errors.length} ${x(go.errors.length, "error")}:
...
`),
            ...
            if (go.warnings.length > 0)
              ((Et =
                Et +
                `${L.warning} Found ${go.warnings.length} ${x(go.warnings.length, "warning")}:
...
`),
          ...
          let Yx = ju;
          ((process.exitCode = 2),
            n(`Plugin validation failed unexpectedly for ${sa}: ${l(Yx)}`, {
              level: "error",
            }),
            la(
              `${L.cross} Unexpected error during validation: ${ek(l(Yx), 200)}`,
            ));
        }
      };
      qg();
...
function wd() {
  ...
  let bS;
  if (Gu[5] !== Yu)
    ((bS = r(o, { marginTop: 1, flexDirection: "column", children: [Yu, kS] })),
      (Gu[5] = Yu),
      (Gu[6] = bS));
  else bS = Gu[6];
  return bS;
...
function Qf(a, k, v) {
  let b = jI(a.source),
    ...
    R = k ?? (b || Lu(a.source) !== void 0 ? Y3(a.source).name : void 0),
    A = b ?? w ?? Lu(a.source);
  return {
...
function Td(CN) {
      ...
      bb54: switch (fo.kind) {
        ...
        case "remove-extra-marketplace": {
          ...
          (Jf(fo.name, fo.sources, ai),
            ...
            nf(`${L.tick} Removed "${fo.name}" from ${NN} settings`),
            SS());
          break bb54;
        }
          ...
          (async () => {
            try {
              (await TEe(fo.name, void 0, ai, Zg),
                ...
                nf(`${L.tick} Removed marketplace "${fo.name}"`),
                SS());
            } catch (_N) {
              let of = _N;
              nf(
  ...
  if (to[12] !== ma)
    ((LS = (Di, _S) => {
      ...
      let HN = Il ? L.pointer : Di.isAdvisory ? L.triangleUpOutline : L.cross;
      return r(
        jm,
        {
          active: Il,
          ...
          children: [
            r(t, {
              children: [
                ...
                e(t, { bold: Il, children: wr(Di.label) }),
                Di.scope &&
                  r(t, { dimColor: !0, children: [" (", Di.scope, ")"] }),
              ],
            }),
            e(o, {
              marginLeft: 3,
  ...
  if (to[14] !== Xu)
    ((td =
      ...
      e(o, {
        marginLeft: 1,
        children: e(t, { color: "claude", children: wr(Xu) }),
      })),
      (to[14] = Xu),
      (to[15] = td));
  else td = to[15];
