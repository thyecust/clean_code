...
import { GITHUB_HOST, normalizeHostname, isGitHubHost, hasBackslashInUrlAuthority, isSuspiciousUrl } from "../../01-核心基础设施/核心工具-路径与平台/git-host-utils.js";
import { getSettingsForSource, getPolicySettingsOrigin } from "../../01-核心基础设施/核心工具-路径与平台/核心工具-路径与平台.bt5mxc9p.js";
import { parseScpRemoteUrl } from "../../01-核心基础设施/核心工具-路径与平台/git-remote-url.js";
...
function headersHelperPolicyRefusal(e, t) {
  if (!areCommandPluginSourcesDisabledByPolicy()) return null;
  if (e === void 0) return "lockdown";
  if (!policyTierCommandsMayRun()) return "remote_policy_unconsented";
...
function isHeadersHelperDisabledByPolicy(e, t) {
...
function isMarketplaceRestrictionPolicyActive() {
  let e = d();
  return (
    getStrictKnownMarketplaces() !== null || (e !== null && e.some((t) => t.source !== "skills-dir"))
  );
}
function isSourceDisallowedOrUnverifiable(e) {
  return e === void 0 ? isMarketplaceRestrictionPolicyActive() : !isSourceAllowedByPolicy(e);
}
...
function h(e, t) {
  ...
  switch (e.source) {
    case "url":
      return canonicalFetchSourceUrl(e.url) === canonicalFetchSourceUrl(t.url);
    case "github":
      return (
        e.repo === t.repo &&
...
function m(e) {
  return hasBackslashInUrlAuthority(e);
}
...
function A(e) {
  if (e.source === "git" && !e.url.includes("://")) {
    let t = parseScpRemoteUrl(e.url);
    return t ? l(t.host) : null;
  }
  return extractHostFromSource(e);
}
function b(e, t, r) {
  let o = r?.blocklistDirection ? extractHostFromSource(e) : A(e);
  if (!o) return !1;
  let i = r?.blocklistDirection && o === y ? [o, GITHUB_HOST] : [o];
  try {
...
function B(e) {
  return isGitHubHost(e) || normalizeHostname(e) === y;
}
function g(e) {
  let t, r;
  if (e.includes("://")) {
...
function M(e) {
  let t = l(e);
  return t === y ? GITHUB_HOST : t;
}
var U = new Set(["http:", "https:", "git:", "git+http:", "git+https:"]);
function k(e) {
  if (isSuspiciousUrl(e)) return e;
  if (e.includes("://"))
    try {
      let o = new URL(e);
      if (((o.hostname = l(o.hostname)), U.has(o.protocol) || isGitHubHost(o.hostname)))
        ((o.username = ""), (o.password = ""));
      return o.toString();
    } catch {
      return e;
    }
  let t = parseScpRemoteUrl(e);
  if (!t) return e;
  let r = t.host.toLowerCase().replace(/\.+$/, "");
  return isGitHubHost(r) ? `${GITHUB_HOST}:${t.path}` : `${t.user}@${r}:${t.path}`;
}
function canonicalFetchSourceUrl(e) {
  try {
    let t = new URL(e);
...
function l(e) {
  let t = normalizeHostname(e);
  return isGitHubHost(t) ? GITHUB_HOST : t;
}
var C = /^[A-Za-z0-9._-]+$/;
function f(e) {
...
function H(e, t) {
  if (e.source === "git" && isSuspiciousUrl(e.url)) return !1;
...
export {
  ...
  isMarketplaceSourceDeclaredByPolicy,
