...
import { getConversationMessages, isResponseStreaming } from "../../03-入口与运行时/核心应用-Agent循环/核心应用-Agent循环.wmzgeczq.js";
...
async function a(t, e) {
  ...
  return (
    await handlePromptInputExit(getConversationMessages(e), { responseStreaming: isResponseStreaming(e) }, e.storageV5),
    { type: "skip" }
  );
}
export { a as call };
