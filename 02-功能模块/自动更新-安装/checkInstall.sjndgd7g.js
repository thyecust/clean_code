...
export {
  ...
  Bce as checkInstall,
  van as cleanupNpmInstallations,
  oFt as cleanupOldVersions,
  Can as cleanupShellAliases,
  Ipt as getBinaryName,
  G4 as getPlatform,
  jce as installLatest,
  q4 as lockCurrentVersion,
  nOe as removeInstalledSymlink,
};
