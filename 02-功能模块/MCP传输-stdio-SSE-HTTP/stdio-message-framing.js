...
// Version: 2.1.263
import { JSONRPCMessageSchema as GR } from "../MCP客户端/chunk-tv3jbp8f.js";
class ReadBuffer {
  append(e) {
...
`);
    ...
    return ((this._buffer = this._buffer.subarray(e + 1)), deserializeMessage(r));
  }
  clear() {
    this._buffer = void 0;
  }
