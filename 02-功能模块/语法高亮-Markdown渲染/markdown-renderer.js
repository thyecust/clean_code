...
import {
  ...
  promptModeMarkdownEngine,
  MAX_LIST_INDENT_WIDTH,
  endsWithBlankLine,
  renderMarkdownToken,
  getOrderedListRange,
  formatListItemMarker,
  padTableCell,
...
function G(s, i, l) {
  if (i <= 0) return [s];
  let u = s.trimEnd(),
    f = wrapAnsi(u, i, { hard: l?.hard ?? !1, trim: !1, wordWrap: !0 })
      .split(
        `
`,
      )
...
var we = Yl(function (Kt) {
  ...
  if (O.kind === "ansi") {
    let ue;
    if (Oe[7] !== O.text)
      ((ue = e(Ansi, { children: O.text })), (Oe[7] = O.text), (Oe[8] = ue));
    else ue = Oe[8];
    return ue;
  }
  let ue;
...
function Ye(s, i, l, u, a, f) {
  ...
  function y(c) {
    ...
    let g = normalizeRenderedHyperlinks(
      c
        ?.map((T) =>
          renderMarkdownToken(T, l, {
            listDepth: 0,
  ...
  if (f) {
    let c = formatTableForScreenReader(
...
${me(m)}`;
  ...
  function A(c) {
    ...
    return Math.max(...g.map((T) => getStringWidth(T)), le);
  }
  function L(c) {
    return Math.max(getStringWidth(W(c)), le);
  }
  ...
  function K(c, p) {
    ...
    for (let E = 0; E < T; E++) {
      ...
      for (let X = 0; X < c.length; X++) {
        ...
        Q += " " + padTableCell(Ee, getStringWidth(Ee), kt, bt) + " \u2502";
      }
      j.push(Q);
    }
    return j;
  ...
  let M = 0;
  for (let c of H) {
    let p = getStringWidth(stripAnsi(c));
    if (p > M) M = p;
  }
  if (M > i - ae) return U();
  if (m > 0) H.push(me(m));
    ...
    He.forEach((nn) => {
      ...
      if (
        (nn.forEach((rn, on) => {
          ...
          let sn = pe ? ne - getStringWidth(pe) - 3 : ne - 1;
          let ln = ne - 2 - 1;
...
`);
  let Rt;
  if (je[7] !== se)
    ((Rt = e(Ansi, { children: se })), (je[7] = se), (je[8] = Rt));
  else Rt = je[8];
  return Rt;
}
var Ke = 10,
...
function Ae({ token: s, indent: i, listDepth: l, ...u }) {
  let a = getOrderedListRange(s);
  return s.items.map((f, m) =>
    e(
      It,
      {
        item: f,
        marker: formatListItemMarker(l, s.ordered ? { number: a.first + m, ...a } : null),
        indent: i,
        listDepth: l,
...
function Ze(s) {
  ...
  return i?.type === "html" && endsWithBlankLine(i.raw);
}
function It({
  item: s,
  marker: i,
  ...
  let P = getStringWidth(i) + 1,
    B = Math.min(l + P, MAX_LIST_INDENT_WIDTH),
    N = [],
    R = a,
    D = L.length - 1;
  return (
        ...
        (N.push(
          r(
            Box,
            {
              ...
              children: [
                e(Box, { flexShrink: 1, width: l }),
                e(Box, {
                  flexShrink: 1,
                  width: P,
                  minWidth: Ie,
                  children:
                    b === 0 && e(Text, { dimColor: k, italic: S, children: i }),
                }),
                e(Box, {
                  flexDirection: "column",
                  flexShrink: 1000,
...
function Ne(s, i) {
  try {
    ...
    if (l instanceof RangeError)
      logForDebugging(`marked.lexer overflow on ${i.length} chars`, { level: "error" });
    else logError(l);
    return ut(i);
  }
}
function vt(s, i, l) {
  ...
  let f = l ? promptModeMarkdownEngine : markdownParser;
...
function lt({
  ...
  let A = useHyperlinkSupport(),
    L = useIsScreenReaderEnabled(),
    P = At(subscribeMouseObserved, hasMouseObserved),
    { markdownTokens: B } = useRenderCaches(),
    N = V(() => {
      ...
      function Z(M, c, p) {
        (d.push(e(Box, { marginTop: c, children: M }, d.length)),
          (w = p),
          (I = !1));
      }
      function U(M, c = !1) {
...
`),
        ...
        let v = w === "none" ? 0 : w === "list" && !p ? 0 : 1,
          j = e(Ansi, { dimColor: l, italic: u, wrap: M, children: T }),
          E = c && z ? r(Text, { dimColor: !0, children: [" ", z] }) : null;
        if (E !== null) Y = !0;
        (Z(
          i || E ? r(Text, { color: i, wrap: M, children: [j, E] }) : j,
          v,
          "prose",
        ),
          (I = g));
      ...
      if (
        ...
        ((b = R), U(k, !0));
      if (z && !Y) Z(e(Text, { dimColor: !0, children: z }), 0, "prose");
      return d;
    }, [s, i, l, u, a, m, y, W, A, L, k, S, B, f, P]);
  return e(Box, { flexDirection: "column", children: N });
}
function mt(jn) {
  let st = _(14),
    {
  ...
  if (st[11] !== ot || st[12] !== it)
    ((be = e(Box, {
      ...
      borderDimColor: !0,
      paddingLeft: 1,
      children: e(Ansi, { dimColor: ot, children: it }),
    })),
      (st[11] = ot),
      (st[12] = it),
      (st[13] = be));
    ...
    (s.chunks = [
      ...
      e(
        Box,
        {
          ...
          children: e(Markdown, { skipTokenCache: !0, children: f }),
        },
        s.chunks.length,
      ),
    ]),
...
function StreamingMarkdown({ children: s, hideTrailingLine: i = !1 }) {
  ensureMarkdownExtensionsRegistered();
...
`),
  ...
  if (a.chunks.length === 0)
    return r(Box, {
      flexDirection: "column",
      gap: 1,
      children: [S && e(Markdown, { skipTokenCache: !0, children: m }), A],
    });
  ...
  return r(Box, {
    ...
    children: [
      ...
      S &&
        e(Box, {
          marginTop: L,
          children: e(Markdown, { skipTokenCache: !0, children: m }),
        }),
      A && e(Box, { marginTop: S ? 1 : L, children: A }),
    ],
  });
}
export { Markdown, StreamingMarkdown };
