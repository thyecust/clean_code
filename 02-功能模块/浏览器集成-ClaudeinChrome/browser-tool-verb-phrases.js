...
import { CFC_TOOL_PREFIX } from "./claude-in-chrome-host.js";
...
function getBrowserToolVerbPhrase(o, e) {
  let r = o.startsWith(CFC_TOOL_PREFIX) ? o.slice(CFC_TOOL_PREFIX.length) : o;
  if (r === "computer") {
...
export { getBrowserToolVerbPhrase };
