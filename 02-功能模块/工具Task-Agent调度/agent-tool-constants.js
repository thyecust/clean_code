...
var AGENT_TOOL_NAME = "Agent",
  ...
  TASK_TOOL_NAME = "Task",
  AGENT_TOOL_MAX_RESULT_SIZE_CHARS = 1e5,
  NON_CONTINUABLE_AGENT_TYPES = new Set(["Explore", "Plan"]),
...
export { AGENT_TOOL_NAME, AGENT_TOOL_DESCRIPTION, AGENT_PROMPT_PARAM_DESCRIPTION, AGENT_DESCRIPTION_PARAM_DESCRIPTION, FORK_AGENT_TYPE, FORK_BUILTIN_AGENT_ID, TASK_TOOL_NAME, AGENT_TOOL_MAX_RESULT_SIZE_CHARS, NON_CONTINUABLE_AGENT_TYPES, AGENT_STOPPED_NOTE_PREFIX, SUBAGENT_TYPE_REQUIRED_MESSAGE };
