...
function getWorkflowAuthoringReference() {
...
function getWorkflowToolPromptText(e) {
  return e
    ? `${t}
...
${getWorkflowAuthoringReference()}`;
}
export { getWorkflowAuthoringReference, getWorkflowToolPromptText };
