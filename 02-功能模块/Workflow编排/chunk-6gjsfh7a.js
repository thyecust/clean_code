...
function ii(s, a) {
  ...
  try {
    let c = [];
    return (li(c, z(l), 0, void 0, !1, a), c);
  } catch {
    return null;
  }
}
...
`)
  ...
  if ((W === void 0 ? 0 : te(W.text) + jn.length) + te(k) + C.length <= v) {
    s.push([
      { text: h },
      ...Nn(W, v),
      { text: k, color: S },
...
function DHe(Vu) {
  ...
  if (st[20] !== ki || st[21] !== wi)
    ((Kn = r(t, { dimColor: !0, children: [ki, " scope \xB7 ", wi] })),
      (st[20] = ki),
      (st[21] = wi),
      (st[22] = Kn));
  else Kn = st[22];
  ...
  if (st[42] !== se)
    ((Yn =
      ...
      e(o, {
        marginTop: 1,
        children: e(t, { dimColor: !0, children: "Saving\u2026" }),
      })),
      (st[42] = se),
      (st[43] = Yn));
  else Yn = st[43];
  ...
  if (st[44] !== Vn || st[45] !== zn || st[46] !== Bn || st[47] !== Yn)
    ((Qn = r(o, { flexDirection: "column", children: [vl, Vn, zn, Bn, Yn] })),
      (st[44] = Vn),
      (st[45] = zn),
      (st[46] = Bn),
      (st[47] = Yn),
...
function Ds(s, a, l, c) {
  ...
  let { model: m, stats: w, time: h } = Hc(s, c),
    ...
    T = m,
    j = w;
  if (te(T) + I(T, j) + te(j) > S) {
    if (((j = W(j, S - te(T) - I(T, j))), te(T) + I(T, j) + te(j) > S))
      T = W(T, S - te(j) - I(T, j));
  }
  let q = T && j ? " \xB7 " : "",
    P = Math.max(0, a - te(T) - te(q) - te(j) - te(k));
  return [
...
function bn(s, a) {
  let l = Math.min(
    ...
    c = s.reduce((m, w) => Math.max(m, te(w.label)), 0);
...
function rt(Dm) {
  ...
  let Il;
  if (er[5] !== or)
    ((Il = r(t, { wrap: "truncate-end", children: [Nl, or, jl] })),
      (er[5] = or),
      (er[6] = Il));
  else Il = er[6];
  return Il;
...
function Ws(Wm) {
  ...
  let _l;
  if (Ll[3] !== Wi)
    ((_l = e(t, { dimColor: !0, wrap: "truncate-end", children: Wi })),
      (Ll[3] = Wi),
      (Ll[4] = _l));
  else _l = Ll[4];
  return _l;
...
function Ns(Nm) {
  ...
  if (
    ...
    if (Bt.length > Po) {
      ...
      if (lt[42] !== mt || lt[43] !== At)
        ((Do = r(t, { wrap: "truncate-end", children: [mt, At, Pe] })),
          (lt[42] = mt),
          (lt[43] = At),
          (lt[44] = Do));
      else Do = lt[44];
  ...
  if (lt[49] !== Ro || lt[50] !== kt || lt[51] !== et)
    ((mt = r(o, { flexDirection: "column", children: [et, kt, Ro] })),
      (lt[49] = Ro),
      (lt[50] = kt),
      (lt[51] = et),
      (lt[52] = mt));
...
function bo(qm) {
  ...
  let Vl;
  if (eo[9] !== cr || eo[10] !== ur)
    ((Vl = r(t, { wrap: "truncate-end", children: [Kl, cr, Gl, ur, Hl] })),
      (eo[9] = cr),
      (eo[10] = ur),
      (eo[11] = Vl));
  else Vl = eo[11];
...
function Vt(Jm) {
  ...
  let hr;
  if (oo[6] !== Yi)
    ((hr = e(t, { color: "text", children: Yi })), (oo[6] = Yi), (oo[7] = hr));
  else hr = oo[7];
  const Ui = Gm + 2;
  let xr;
  ...
  if (
    ...
    ((zl = r(t, { wrap: "truncate-end", children: [dr, gr, hr, xr, br] })),
      (oo[14] = dr),
      (oo[15] = gr),
      (oo[16] = hr),
      (oo[17] = xr),
...
`)) {
    ...
    for (let m of cxt(c, Math.max(1, a))) l.push(m);
  }
  return l;
}
function La({
...
function Ea({
  ...
  let h = [],
    ...
    S = [];
  if (s.model != null) S.push(uye(s.model, s.fallbackModel));
...
function Es(Xm) {
  ...
  if (
    ...
    if (je.length > lo) {
      ...
      if (gt[32] !== Xr || gt[33] !== Zr)
        ((rc = r(t, { wrap: "truncate-end", children: [Zr, Xr, nc] })),
          (gt[32] = Xr),
          (gt[33] = Zr),
          (gt[34] = rc));
      else rc = gt[34];
  ...
  if (gt[39] !== Ho || gt[40] !== Ie || gt[41] !== ge)
    ((Le = r(o, { flexDirection: "column", children: [ge, Ie, Ho] })),
      (gt[39] = Ho),
      (gt[40] = Ie),
      (gt[41] = ge),
      (gt[42] = Le));
...
function eye({
  ...
  let { availableRows: k, width: S, rows: I } = qIt(W),
    T = Math.max(12, S - 6),
    j = zIt(s),
    q = V(() => aZt(s), [s.workflowProgress, s.phases]),
    P = V(() => cZt(q, s.agentCount), [q, s.agentCount]),
  ...
  let O = Y !== "phases" && ut ? ut.agents[Ve] : void 0,
    ...
    So = S - 9,
    Ba = ut ? Math.max(14, ...ut.agents.map((M) => 4 + te(M.label))) : 14,
        ...
        children: [
          !Ao
            ...
            : Y === "agent" && O && ut
              ? r(N, {
                  children: [
                    e(dye, { name: kn, subtext: Cn, stats: Sn, width: S }),
                    !Ft && e(o, { height: 1 }),
                    Mn
                      ? e(Ls, {
                          phase: ut,
