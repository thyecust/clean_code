...
function zn(Yo, Bo) {
  return e(t, { dimColor: !0, children: Yo }, Bo);
}
function GIt(n) {
  let i = new Map(),
    a = [],
...
function ne(Eo) {
  ...
  if (S[20] !== w)
    ((z =
      w.length > 0 &&
      r(t, { dimColor: !0, children: ["  ", w.join(" \xB7 ")] })),
      (S[20] = w),
      (S[21] = z));
  else z = S[21];
  let Pe;
  if (S[22] !== m.error || S[23] !== m.state)
    ((Pe =
      m.state === "error" &&
      m.error &&
      r(t, { color: "error", children: [" ", "\u2014", " ", m.error] })),
      (S[22] = m.error),
      (S[23] = m.state),
      (S[24] = Pe));
  else Pe = S[24];
...
function Fe(Go) {
  ...
  if (A[10] !== ie || A[11] !== b.agents)
    ((Rn =
      ie && b.agents.every((_o) => _o.model === ie) ? uye(ie, void 0) : void 0),
      (A[10] = ie),
      (A[11] = b.agents),
      (A[12] = Rn));
  else Rn = A[12];
  ...
  let Ce;
  if (A[13] !== b.title)
    ((Ce = e(t, { bold: !0, children: b.title })),
      (A[13] = b.title),
      (A[14] = Ce));
  else Ce = A[14];
  let Te;
  if (A[15] !== Dt || A[16] !== $t)
    ((Te = e(t, { color: Dt, children: $t })),
      (A[15] = Dt),
      (A[16] = $t),
      (A[17] = Te));
  else Te = A[17];
  ...
  if (A[18] !== E)
    ((we =
      E > 0 &&
      r(t, { color: "error", children: [" ", "\xB7", " ", E, " failed"] })),
      (A[18] = E),
      (A[19] = we));
  else we = A[19];
  let Ae;
  if (A[20] !== M || A[21] !== vt || A[22] !== we || A[23] !== B)
    ((Ae = r(t, { dimColor: !0, children: [M, "/", B, vt, we] })),
      (A[20] = M),
      (A[21] = vt),
      (A[22] = we),
      (A[23] = B),
  ...
  if (A[25] !== Ce || A[26] !== Te || A[27] !== Ae)
    ((Re = e(o, {
      paddingX: 1,
      children: r(t, { children: [Ce, "  ", Te, " ", Ae] }),
    })),
      (A[25] = Ce),
      (A[26] = Te),
      (A[27] = Ae),
...
function Ue(Uo) {
  ...
  if (W[22] !== ve || W[23] !== Le || W[24] !== X)
    ((vn = r(o, { flexDirection: "column", children: [ve, Le, X] })),
      (W[22] = ve),
      (W[23] = Le),
      (W[24] = X),
      (W[25] = vn));
...
function Ct(yr) {
  ...
  let Ve;
  if (de[5] !== Ut || de[6] !== me)
    ((Ve = me > 0 && e(t, { color: "success", children: Ut })),
      (de[5] = Ut),
      (de[6] = me),
      (de[7] = Ve));
  else Ve = de[7];
...
function VIt(Rr) {
  ...
  let Ye = so,
    $r = `${ge} ${he} ${Ye}`,
    Qt = Math.max(0, be - te($r)),
    Yt = Bn > 0 ? `${Mr}/${Bn}` : "";
  const Bt = K ? "permission" : void 0;
  let Be;
  if (O[3] !== ge || O[4] !== Bt)
    ((Be = e(t, { color: Bt, children: ge })),
      (O[3] = ge),
      (O[4] = Bt),
      (O[5] = Be));
  else Be = O[5];
  ...
  if (O[9] !== Ye || O[10] !== en || O[11] !== tn)
    ((nt = e(t, { color: en, dimColor: tn, children: Ye })),
      (O[9] = Ye),
      (O[10] = en),
      (O[11] = tn),
      (O[12] = nt));
...
function KIt(Dr) {
  ...
  if (re[4] !== at || re[5] !== j)
    ((dt = at
      ? r(t, { color: j ? "claude" : void 0, bold: j, children: [at, " "] })
      : null),
      (re[4] = at),
      (re[5] = j),
      (re[6] = dt));
  ...
  if (
    ...
    ((pt = r(t, { dimColor: cn, bold: j, children: [un, dn, mn, an] })),
      (re[11] = an),
      (re[12] = j),
      (re[13] = cn),
      (re[14] = un),
  ...
  if (re[18] !== pt || re[19] !== ut || re[20] !== dt || re[21] !== mt)
    ((mo = r(t, { wrap: "truncate-end", children: [ut, " ", dt, mt, pt] })),
      (re[18] = pt),
      (re[19] = ut),
      (re[20] = dt),
      (re[21] = mt),
...
function dye(Lr) {
  ...
  let ht;
  if (V[2] !== gt)
    ((ht = e(t, { color: "text", wrap: "truncate-end", children: gt })),
      (V[2] = gt),
      (V[3] = ht));
  else ht = V[3];
  let bt;
  ...
  if (V[8] !== ft)
    ((yt = ft
      ? e(o, {
          flexShrink: 0,
          children: r(t, { dimColor: !0, children: [ft, " "] }),
        })
      : null),
      (V[8] = ft),
      (V[9] = yt));
  ...
  if (V[10] !== xt || V[11] !== yt || V[12] !== se)
    ((kt = r(o, { width: se, overflow: "hidden", children: [xt, yt] })),
      (V[10] = xt),
      (V[11] = yt),
      (V[12] = se),
      (V[13] = kt));
