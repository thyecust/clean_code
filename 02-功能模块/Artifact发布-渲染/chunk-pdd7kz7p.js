...
function publishesRemainingLine(e, t) {
  let a = `${e === 0 ? "No" : e} artifact ${pluralize(e, "publish", "publishes")} left today on your plan`,
    s = formatResetTime(t);
