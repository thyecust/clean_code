...
var MAX_SESSION_RECORD_BYTES = 262144;
function parsePidFromFileName(n) {
...
function toSaneEpochMs(n) {
  return isSaneEpochMs(n) ? n : void 0;
}
function normalizeSessionRecord(n) {
  let e = typeof n === "object" && n !== null ? n : {};
  return {
    cwd: typeof e.cwd === "string" ? e.cwd : "?",
    startedAt: toSaneEpochMs(e.startedAt) ?? 0,
...
export { MAX_SESSION_RECORD_BYTES, parsePidFromFileName, isSaneEpochMs, toSaneEpochMs, normalizeSessionRecord, isProcessRunning, getPidDomain };
