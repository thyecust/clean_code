...
function No() {
  ...
  if (ze[6] === MEMO_CACHE_SENTINEL)
    ((yn = e(Text, { children: "Paste your Bedrock API key." })),
      (Cn = e(Text, {
        dimColor: !0,
        children:
  ...
  let xo;
  if (ze[12] !== Io)
    ((xo = Io && e(Box, { marginTop: 1, children: e(ErrorMessage, { error: Io }) })),
      (ze[12] = Io),
      (ze[13] = xo));
  else xo = ze[13];
  let Sn;
  if (ze[14] !== Wo || ze[15] !== xo)
    ((Sn = e(WizardStepFrame, {
      ...
      footerText: gn,
      children: r(Box, { flexDirection: "column", children: [yn, Cn, Wo, xo] }),
    })),
      (ze[14] = Wo),
      (ze[15] = xo),
      (ze[16] = Sn));
...
function Rn(Jr) {
  ...
  return r(
    Text,
    {
      children: [
        "  ",
        e(Text, { color: "suggestion", children: at }),
        " =",
        " ",
        dt.has(at) ? e(Text, { dimColor: !0, children: "(hidden)" }) : pa,
      ],
    },
    at,
  );
...
function Fo(Jr) {
  ...
  if (ce[0] === MEMO_CACHE_SENTINEL)
    ((An = formatPathWithTilde(getSettingsFilePathForSource("userSettings") ?? "~/.claude/settings.json")), (ce[0] = An));
  else An = ce[0];
  let _n = An,
    bn;
  ...
  let Mo;
  if (ce[17] !== nt)
    ((Mo = e(Box, { flexDirection: "column", children: nt.map(Rn) })),
      (ce[17] = nt),
      (ce[18] = Mo));
  else Mo = ce[18];
  let Ko;
...
function ko(n) {
  let s = getInferenceProfilePrefixForRegion(n),
    l = (c) => {
      let f = MODEL_CONFIGS_BY_KEY[c].bedrock;
      if (f === null)
        throw Error(
          "A DEFAULT_3P_*_KEY points at a model config with bedrock: null \u2014 Bedrock setup has no fallback id for that tier",
        );
      return { needle: MODEL_CONFIGS_BY_KEY[c].firstParty, fallback: applyInferenceProfilePrefix(f, s) };
    };
...
function gr() {
  ...
  let jo;
  if (S[62] !== Yo)
    ((jo = r(Box, { flexDirection: "column", children: [Ao, Yo] })),
      (S[62] = Yo),
      (S[63] = jo));
  else jo = S[63];
  let Xo;
...
function pr(hc) {
  ...
  if (Rt === "pending") {
    ...
    let Z;
    if (ke[1] !== le)
      ((Z = le && r(Text, { dimColor: !0, children: [" ", le] })),
        (ke[1] = le),
        (ke[2] = Z));
    else Z = ke[2];
    let ye;
    if (ke[3] !== he || ke[4] !== Z)
      ((ye = r(Text, { children: [xe, he, Z] })),
        (ke[3] = he),
        (ke[4] = Z),
        (ke[5] = ye));
    else ye = ke[5];
  ...
  let ur;
  if (ke[13] !== ye)
    ((ur = r(Text, { color: "error", children: ["(", ye, ")"] })),
      (ke[13] = ye),
      (ke[14] = ur));
  else ur = ke[14];
  let Si;
  if (ke[15] !== he || ke[16] !== Z || ke[17] !== ur)
    ((Si = r(Text, { dimColor: !0, children: [xe, he, Z, " ", ur] })),
      (ke[15] = he),
      (ke[16] = Z),
      (ke[17] = ur),
      (ke[18] = Si));
...
function mr(kc) {
  ...
  if (It === "pending") {
    ...
    if (re[4] !== Se || re[5] !== H)
      ((Ae = r(Box, {
        children: [Me, te, r(Text, { children: [" ", H, "\u2192 ", Se] })],
      })),
        (re[4] = Se),
        (re[5] = H),
        (re[6] = Ae));
  ...
  if (It.ok) {
    ...
    let H;
    if (re[10] !== Se)
      ((H = e(Text, { color: "success", children: Se })),
        (re[10] = Se),
        (re[11] = H));
    else H = re[11];
    let Ae;
    if (re[12] !== te || re[13] !== H)
      ((Ae = r(Text, { children: ["  ", Me, te, "\u2192 ", H] })),
        (re[12] = te),
        (re[13] = H),
        (re[14] = Ae));
    else Ae = re[14];
  ...
  let H;
  if (re[18] !== Se)
    ((H = e(Text, { dimColor: !0, children: Se })), (re[18] = Se), (re[19] = H));
  else H = re[19];
  const Ae = To[It.reason];
  let fr;
  if (re[20] !== Ae)
    ((fr = r(Text, { color: "error", children: ["(", Ae, ")"] })),
      (re[20] = Ae),
      (re[21] = fr));
  else fr = re[21];
  let Ai;
  if (re[22] !== te || re[23] !== H || re[24] !== fr)
    ((Ai = r(Text, { children: ["  ", Me, te, "\u2192 ", H, " ", fr] })),
      (re[22] = te),
      (re[23] = H),
      (re[24] = fr),
      (re[25] = Ai));
...
function Ar(Fc) {
  ...
  if (!yr) {
    ...
    if (I[29] !== Te || I[30] !== Ve)
      ((Oo = e(WizardStepFrame, {
        subtitle: "AWS profile",
        children: r(Box, { flexDirection: "column", gap: 1, children: [Ve, Te] }),
      })),
        (I[29] = Te),
        (I[30] = Ve),
        (I[31] = Oo));
  ...
  let Te;
  if (I[46] !== Cr)
    ((Te = Cr && e(Box, { marginTop: 1, children: e(ErrorMessage, { error: Cr }) })),
      (I[46] = Cr),
      (I[47] = Te));
  else Te = I[47];
  let Oo;
...
function Tr() {
  ...
  if (Ye[6] === MEMO_CACHE_SENTINEL)
    ((Xi = e(Text, { children: "Where your Bedrock models are enabled." })),
      (Qi = e(Text, {
        dimColor: !0,
        children:
  ...
  let Dr;
  if (Ye[12] !== _r)
    ((Dr = _r && e(Box, { marginTop: 1, children: e(ErrorMessage, { error: _r }) })),
      (Ye[12] = _r),
      (Ye[13] = Dr));
  else Dr = Ye[13];
  let Ji;
  if (Ye[14] !== br || Ye[15] !== Dr)
    ((Ji = e(WizardStepFrame, {
      subtitle: "AWS region",
      footerText: ji,
      children: r(Box, { flexDirection: "column", children: [Xi, Qi, br, Dr] }),
    })),
      (Ye[14] = br),
      (Ye[15] = Dr),
      (Ye[16] = Ji));
...
function Br() {
  ...
  switch (N.status) {
    case "ok": {
      ...
      if (K[8] !== N.identity)
        ((ne = r(Text, {
          children: [
            Oe,
            "Authenticated as ",
            e(Text, { bold: !0, children: N.identity }),
          ],
        })),
          (K[8] = N.identity),
          (K[9] = ne));
      ...
      let Be;
      if (K[13] !== Pe)
        ((Be = e(Text, { dimColor: !0, children: Pe })),
          (K[13] = Pe),
          (K[14] = Be));
      else Be = K[14];
      let Ge;
    ...
    case "error": {
      ...
      let Be;
      if (K[30] !== ne || K[31] !== Pe)
        ((Be = r(Box, { flexDirection: "column", children: [ne, Pe] })),
          (K[30] = ne),
          (K[31] = Pe),
          (K[32] = Be));
      else Be = K[32];
...
function BedrockSetupWizard(Fd) {
  let Qt = _(6),
