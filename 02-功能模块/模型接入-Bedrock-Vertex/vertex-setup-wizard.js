...
import { buildVertexBaseUrl } from "../../01-核心基础设施/设置-配置/chunk-5ndhfaq9.js";
...
import { strip1mSuffix, MODEL_CONFIGS_BY_KEY } from "../../01-核心基础设施/模型目录-ModelCatalog/模型目录-ModelCatalog.3msq3jt8.js";
...
function zr(Ao) {
  ...
  return r(
    Text,
    {
      children: ["  ", e(Text, { color: "suggestion", children: Mr }), " = ", ea],
    },
    Mr,
  );
}
...
function At(Ao) {
  ...
  if (ne[0] === MEMO_CACHE_SENTINEL)
    ((Pr = formatPathWithTilde(getSettingsFilePathForSource("userSettings") ?? "~/.claude/settings.json")), (ne[0] = Pr));
  else Pr = ne[0];
  let Ir = Pr,
    Rr;
  ...
  let Ct;
  if (ne[16] !== To)
    ((Ct = e(Box, { flexDirection: "column", children: To.map(zr) })),
      (ne[16] = To),
      (ne[17] = Ct));
  else Ct = ne[17];
  let yt;
...
function nt() {
  return {
    sonnet: MODEL_CONFIGS_BY_KEY[DEFAULT_3P_SONNET_KEY].vertex,
    opus: MODEL_CONFIGS_BY_KEY[DEFAULT_VERTEX_OPUS_KEY].vertex,
    haiku: MODEL_CONFIGS_BY_KEY[DEFAULT_3P_HAIKU_KEY].vertex,
    fable: MODEL_CONFIGS_BY_KEY[DEFAULT_3P_FABLE_KEY].vertex,
  };
}
function _t(n) {
  let s = new Set();
  for (let c of Object.values(MODEL_CONFIGS_BY_KEY))
...
function Bt() {
  ...
  let Rt;
  if (A[53] !== Pt)
    ((Rt = r(Box, { flexDirection: "column", children: [at, Pt] })),
      (A[53] = Pt),
      (A[54] = Rt));
  else Rt = A[54];
  let St;
...
function Gt(Ja) {
  ...
  if (Yo === "pending") {
    ...
    let X;
    if (le[1] !== ie)
      ((X = ie && r(Text, { dimColor: !0, children: [" ", ie] })),
        (le[1] = ie),
        (le[2] = X));
    else X = le[2];
    let pe;
    if (le[3] !== de || le[4] !== X)
      ((pe = r(Text, { children: [Ee, de, X] })),
        (le[3] = de),
        (le[4] = X),
        (le[5] = pe));
    else pe = le[5];
  ...
  let Ft;
  if (le[13] !== pe)
    ((Ft = r(Text, { color: "error", children: ["(", pe, ")"] })),
      (le[13] = pe),
      (le[14] = Ft));
  else Ft = le[14];
  let Rn;
  if (le[15] !== de || le[16] !== X || le[17] !== Ft)
    ((Rn = r(Text, { dimColor: !0, children: [Ee, de, X, " ", Ft] })),
      (le[15] = de),
      (le[16] = X),
      (le[17] = Ft),
      (le[18] = Rn));
...
function Ht(Xa) {
  ...
  if (Jo === "pending") {
    ...
    if (Z[4] !== fe || Z[5] !== B)
      ((ge = r(Box, {
        children: [Te, ee, r(Text, { children: [" ", B, "\u2192 ", fe] })],
      })),
        (Z[4] = fe),
        (Z[5] = B),
        (Z[6] = ge));
  ...
  if (Jo.ok) {
    ...
    let B;
    if (Z[10] !== fe)
      ((B = e(Text, { color: "success", children: fe })),
        (Z[10] = fe),
        (Z[11] = B));
    else B = Z[11];
    let ge;
    if (Z[12] !== ee || Z[13] !== B)
      ((ge = r(Text, { children: ["  ", Te, ee, "\u2192 ", B] })),
        (Z[12] = ee),
        (Z[13] = B),
        (Z[14] = ge));
    else ge = Z[14];
  ...
  let B;
  if (Z[18] !== fe)
    ((B = e(Text, { dimColor: !0, children: fe })), (Z[18] = fe), (Z[19] = B));
  else B = Z[19];
  const ge = ut[Jo.reason];
  let Wt;
  if (Z[20] !== ge)
    ((Wt = r(Text, { color: "error", children: ["(", ge, ")"] })),
      (Z[20] = ge),
      (Z[21] = Wt));
  else Wt = Z[21];
  let Sn;
  if (Z[22] !== ee || Z[23] !== B || Z[24] !== Wt)
    ((Sn = r(Text, { children: ["  ", Te, ee, "\u2192 ", B, " ", Wt] })),
      (Z[22] = ee),
      (Z[23] = B),
      (Z[24] = Wt),
      (Z[25] = Sn));
...
function eo(vs) {
  ...
  if (!Yt) {
    ...
    if (S[26] !== ye || S[27] !== Le)
      ((mt = e(WizardStepFrame, {
        subtitle: "GCP project",
        children: r(Box, { flexDirection: "column", gap: 1, children: [Le, ye] }),
      })),
        (S[26] = ye),
        (S[27] = Le),
        (S[28] = mt));
  ...
  if (S[33] === MEMO_CACHE_SENTINEL)
    ((Le = e(Text, { children: "The project where Vertex AI is enabled." })),
      (S[33] = Le));
  else Le = S[33];
  let he;
  ...
  let ye;
  if (S[42] !== Qt)
    ((ye = Qt && e(Box, { marginTop: 1, children: e(ErrorMessage, { error: Qt }) })),
      (S[42] = Qt),
      (S[43] = ye));
  else ye = S[43];
  let mt;
...
function ao() {
  ...
  if (ze[6] === MEMO_CACHE_SENTINEL)
    ((ai = e(Text, { children: "Where Claude models are served from." })),
      (si = e(Text, {
        dimColor: !0,
        children:
  ...
  let io;
  if (ze[12] !== ro)
    ((io = ro && e(Box, { marginTop: 1, children: e(ErrorMessage, { error: ro }) })),
      (ze[12] = ro),
      (ze[13] = io));
  else io = ze[13];
  let ci;
  if (ze[14] !== no || ze[15] !== io)
    ((ci = e(WizardStepFrame, {
      ...
      footerText: ii,
      children: r(Box, { flexDirection: "column", children: [ai, si, no, io] }),
    })),
      (ze[14] = no),
      (ze[15] = io),
      (ze[16] = ci));
...
function uo() {
  ...
  if (Fe[6] === MEMO_CACHE_SENTINEL)
    ((mi = e(Text, { children: "Path to the service account JSON key file." })),
      (fi = e(Text, {
        dimColor: !0,
        children:
  ...
  let lo;
  if (Fe[12] !== so)
    ((lo = so && e(Box, { marginTop: 1, children: e(ErrorMessage, { error: so }) })),
      (Fe[12] = so),
      (Fe[13] = lo));
  else lo = Fe[13];
  let gi;
  if (Fe[14] !== co || Fe[15] !== lo)
    ((gi = e(WizardStepFrame, {
      ...
      footerText: pi,
      children: r(Box, { flexDirection: "column", children: [mi, fi, co, lo] }),
    })),
      (Fe[14] = co),
      (Fe[15] = lo),
      (Fe[16] = gi));
...
function mo() {
  ...
  switch (G.status) {
    case "ok": {
      ...
      if (M[7] !== G.identity)
        ((xe = r(Text, {
          children: [
            be,
            "Authenticated as ",
            e(Text, { bold: !0, children: G.identity }),
          ],
        })),
          (M[7] = G.identity),
          (M[8] = xe));
      ...
      let De;
      if (M[9] !== G.note)
        ((De = G.note && e(Text, { dimColor: !0, children: G.note })),
          (M[9] = G.note),
          (M[10] = De));
      else De = M[10];
      let We;
    ...
    case "error": {
      ...
      let We;
      if (M[26] !== xe || M[27] !== De)
        ((We = r(Box, { flexDirection: "column", children: [xe, De] })),
          (M[26] = xe),
          (M[27] = De),
          (M[28] = We));
      else We = M[28];
