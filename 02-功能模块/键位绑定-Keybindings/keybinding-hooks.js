...
import { E, dn, d, F } from "../../00-第三方库/react/React运行时-JSX.j03jpdbn.js";
F();
function useKeybinding(t, o, r = {}) {
  let { context: n = "Global", isActive: i = !0 } = r,
    e = useKeybindingContext(),
    [s] = d(() => ({ handler: o }));
  (dn(() => {
    s.handler = o;
  }),
...
function useKeybindings(t, o = {}) {
  let { context: r = "Global", isActive: n = !0 } = o,
    i = useKeybindingContext(),
    [e] = d(() => ({ handlers: t })),
...
function useKeybindingPreDispatch(t, { isActive: o = !0 } = {}) {
...
export { useKeybinding, useKeybindings, useKeybindingPreDispatch };
